...
# Unit tests for SwaggerClient::PEPsAndSanctionsBusinessSearchResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PEPsAndSanctionsBusinessSearchResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::PEPsAndSanctionsBusinessSearchResponse.new
  end
  ...
  describe 'test an instance of PEPsAndSanctionsBusinessSearchResponse' do
    it 'should create an instance of PEPsAndSanctionsBusinessSearchResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::PEPsAndSanctionsBusinessSearchResponse)
    end
  end
