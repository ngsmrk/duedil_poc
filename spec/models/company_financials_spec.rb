...
# Unit tests for SwaggerClient::CompanyFinancials
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyFinancials' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyFinancials.new
  end
  ...
  describe 'test an instance of CompanyFinancials' do
    it 'should create an instance of CompanyFinancials' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyFinancials)
    end
  end
