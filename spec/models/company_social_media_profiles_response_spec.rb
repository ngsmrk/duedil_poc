...
# Unit tests for SwaggerClient::CompanySocialMediaProfilesResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanySocialMediaProfilesResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanySocialMediaProfilesResponse.new
  end
  ...
  describe 'test an instance of CompanySocialMediaProfilesResponse' do
    it 'should create an instance of CompanySocialMediaProfilesResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanySocialMediaProfilesResponse)
    end
  end
