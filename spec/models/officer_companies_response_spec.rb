...
# Unit tests for SwaggerClient::OfficerCompaniesResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OfficerCompaniesResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::OfficerCompaniesResponse.new
  end
  ...
  describe 'test an instance of OfficerCompaniesResponse' do
    it 'should create an instance of OfficerCompaniesResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::OfficerCompaniesResponse)
    end
  end
