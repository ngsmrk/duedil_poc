...
# Unit tests for SwaggerClient::PEPsAndSanctionsDueDilCompanyCriteria
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PEPsAndSanctionsDueDilCompanyCriteria' do
  before do
    # run before each test
    @instance = SwaggerClient::PEPsAndSanctionsDueDilCompanyCriteria.new
  end
  ...
  describe 'test an instance of PEPsAndSanctionsDueDilCompanyCriteria' do
    it 'should create an instance of PEPsAndSanctionsDueDilCompanyCriteria' do
      expect(@instance).to be_instance_of(SwaggerClient::PEPsAndSanctionsDueDilCompanyCriteria)
    end
  end
  describe 'test attribute "duedil_company"' do
    it 'should work' do
