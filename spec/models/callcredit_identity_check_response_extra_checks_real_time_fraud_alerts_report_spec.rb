...
# Unit tests for SwaggerClient::CallcreditIdentityCheckResponseExtraChecksRealTimeFraudAlertsReport
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CallcreditIdentityCheckResponseExtraChecksRealTimeFraudAlertsReport' do
  before do
    # run before each test
    @instance = SwaggerClient::CallcreditIdentityCheckResponseExtraChecksRealTimeFraudAlertsReport.new
  end
  ...
  describe 'test an instance of CallcreditIdentityCheckResponseExtraChecksRealTimeFraudAlertsReport' do
    it 'should create an instance of CallcreditIdentityCheckResponseExtraChecksRealTimeFraudAlertsReport' do
      expect(@instance).to be_instance_of(SwaggerClient::CallcreditIdentityCheckResponseExtraChecksRealTimeFraudAlertsReport)
    end
  end
  ...
  describe 'test attribute "velocity_data"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "inconsistency_data"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
