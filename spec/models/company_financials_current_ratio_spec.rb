...
# Unit tests for SwaggerClient::CompanyFinancialsCurrentRatio
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyFinancialsCurrentRatio' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyFinancialsCurrentRatio.new
  end
  ...
  describe 'test an instance of CompanyFinancialsCurrentRatio' do
    it 'should create an instance of CompanyFinancialsCurrentRatio' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyFinancialsCurrentRatio)
    end
  end
