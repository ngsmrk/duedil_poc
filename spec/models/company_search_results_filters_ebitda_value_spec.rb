...
# Unit tests for SwaggerClient::CompanySearchResultsFiltersEbitdaValue
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanySearchResultsFiltersEbitdaValue' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanySearchResultsFiltersEbitdaValue.new
  end
  ...
  describe 'test an instance of CompanySearchResultsFiltersEbitdaValue' do
    it 'should create an instance of CompanySearchResultsFiltersEbitdaValue' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanySearchResultsFiltersEbitdaValue)
    end
  end
