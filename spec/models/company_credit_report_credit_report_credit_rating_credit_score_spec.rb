...
# Unit tests for SwaggerClient::CompanyCreditReportCreditReportCreditRatingCreditScore
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyCreditReportCreditReportCreditRatingCreditScore' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyCreditReportCreditReportCreditRatingCreditScore.new
  end
  ...
  describe 'test an instance of CompanyCreditReportCreditReportCreditRatingCreditScore' do
    it 'should create an instance of CompanyCreditReportCreditReportCreditRatingCreditScore' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyCreditReportCreditReportCreditRatingCreditScore)
    end
  end
  ...
  describe 'test attribute "range_min"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "range_max"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "value_last_change"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
