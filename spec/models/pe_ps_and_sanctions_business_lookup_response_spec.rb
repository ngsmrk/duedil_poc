...
# Unit tests for SwaggerClient::PEPsAndSanctionsBusinessLookupResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PEPsAndSanctionsBusinessLookupResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::PEPsAndSanctionsBusinessLookupResponse.new
  end
  ...
  describe 'test an instance of PEPsAndSanctionsBusinessLookupResponse' do
    it 'should create an instance of PEPsAndSanctionsBusinessLookupResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::PEPsAndSanctionsBusinessLookupResponse)
    end
  end
  ...
  describe 'test attribute "related_names"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
