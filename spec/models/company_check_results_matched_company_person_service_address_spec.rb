...
# Unit tests for SwaggerClient::CompanyCheckResultsMatchedCompanyPersonServiceAddress
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyCheckResultsMatchedCompanyPersonServiceAddress' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyCheckResultsMatchedCompanyPersonServiceAddress.new
  end
  ...
  describe 'test an instance of CompanyCheckResultsMatchedCompanyPersonServiceAddress' do
    it 'should create an instance of CompanyCheckResultsMatchedCompanyPersonServiceAddress' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyCheckResultsMatchedCompanyPersonServiceAddress)
    end
  end
