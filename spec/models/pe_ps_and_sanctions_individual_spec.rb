...
# Unit tests for SwaggerClient::PEPsAndSanctionsIndividual
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PEPsAndSanctionsIndividual' do
  before do
    # run before each test
    @instance = SwaggerClient::PEPsAndSanctionsIndividual.new
  end
  ...
  describe 'test an instance of PEPsAndSanctionsIndividual' do
    it 'should create an instance of PEPsAndSanctionsIndividual' do
      expect(@instance).to be_instance_of(SwaggerClient::PEPsAndSanctionsIndividual)
    end
  end
