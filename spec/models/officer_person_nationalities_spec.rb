...
# Unit tests for SwaggerClient::OfficerPersonNationalities
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OfficerPersonNationalities' do
  before do
    # run before each test
    @instance = SwaggerClient::OfficerPersonNationalities.new
  end
  ...
  describe 'test an instance of OfficerPersonNationalities' do
    it 'should create an instance of OfficerPersonNationalities' do
      expect(@instance).to be_instance_of(SwaggerClient::OfficerPersonNationalities)
    end
  end
