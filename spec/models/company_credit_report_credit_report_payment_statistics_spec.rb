...
# Unit tests for SwaggerClient::CompanyCreditReportCreditReportPaymentStatistics
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyCreditReportCreditReportPaymentStatistics' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyCreditReportCreditReportPaymentStatistics.new
  end
  ...
  describe 'test an instance of CompanyCreditReportCreditReportPaymentStatistics' do
    it 'should create an instance of CompanyCreditReportCreditReportPaymentStatistics' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyCreditReportCreditReportPaymentStatistics)
    end
  end
  describe 'test attribute "total_invoices_sampled"' do
    it 'should work' do
  ...
  describe 'test attribute "invoices_outstanding"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "payment_trend"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
       #validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["Improving", "Worsening", "Stable"])
       #validator.allowable_values.each do |value|
       #  expect { @instance.payment_trend = value }.not_to raise_error
       #end
    end
  end
