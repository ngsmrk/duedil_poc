...
# Unit tests for SwaggerClient::SharedPersonMatchNationalities
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SharedPersonMatchNationalities' do
  before do
    # run before each test
    @instance = SwaggerClient::SharedPersonMatchNationalities.new
  end
  ...
  describe 'test an instance of SharedPersonMatchNationalities' do
    it 'should create an instance of SharedPersonMatchNationalities' do
      expect(@instance).to be_instance_of(SwaggerClient::SharedPersonMatchNationalities)
    end
  end
