...
# Unit tests for SwaggerClient::PaginationPagination
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PaginationPagination' do
  before do
    # run before each test
    @instance = SwaggerClient::PaginationPagination.new
  end
  ...
  describe 'test an instance of PaginationPagination' do
    it 'should create an instance of PaginationPagination' do
      expect(@instance).to be_instance_of(SwaggerClient::PaginationPagination)
    end
  end
