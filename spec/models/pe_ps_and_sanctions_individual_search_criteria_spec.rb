...
# Unit tests for SwaggerClient::PEPsAndSanctionsIndividualSearchCriteria
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PEPsAndSanctionsIndividualSearchCriteria' do
  before do
    # run before each test
    @instance = SwaggerClient::PEPsAndSanctionsIndividualSearchCriteria.new
  end
  ...
  describe 'test an instance of PEPsAndSanctionsIndividualSearchCriteria' do
    it 'should create an instance of PEPsAndSanctionsIndividualSearchCriteria' do
      expect(@instance).to be_instance_of(SwaggerClient::PEPsAndSanctionsIndividualSearchCriteria)
    end
  end
end
