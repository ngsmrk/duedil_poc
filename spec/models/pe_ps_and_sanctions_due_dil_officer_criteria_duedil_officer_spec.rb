...
# Unit tests for SwaggerClient::PEPsAndSanctionsDueDilOfficerCriteriaDuedilOfficer
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PEPsAndSanctionsDueDilOfficerCriteriaDuedilOfficer' do
  before do
    # run before each test
    @instance = SwaggerClient::PEPsAndSanctionsDueDilOfficerCriteriaDuedilOfficer.new
  end
  ...
  describe 'test an instance of PEPsAndSanctionsDueDilOfficerCriteriaDuedilOfficer' do
    it 'should create an instance of PEPsAndSanctionsDueDilOfficerCriteriaDuedilOfficer' do
      expect(@instance).to be_instance_of(SwaggerClient::PEPsAndSanctionsDueDilOfficerCriteriaDuedilOfficer)
    end
  end
