...
# Unit tests for SwaggerClient::CompanyPortfolioCompaniesPortfolioCompanies
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyPortfolioCompaniesPortfolioCompanies' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyPortfolioCompaniesPortfolioCompanies.new
  end
  ...
  describe 'test an instance of CompanyPortfolioCompaniesPortfolioCompanies' do
    it 'should create an instance of CompanyPortfolioCompaniesPortfolioCompanies' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyPortfolioCompaniesPortfolioCompanies)
    end
  end
  ...
  describe 'test attribute "share_of_net_assets"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "owned_share_types"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
