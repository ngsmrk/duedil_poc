...
# Unit tests for SwaggerClient::CompanyCheckResultsMatchedCompanyShareholdings
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyCheckResultsMatchedCompanyShareholdings' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyCheckResultsMatchedCompanyShareholdings.new
  end
  ...
  describe 'test an instance of CompanyCheckResultsMatchedCompanyShareholdings' do
    it 'should create an instance of CompanyCheckResultsMatchedCompanyShareholdings' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyCheckResultsMatchedCompanyShareholdings)
    end
  end
  ...
  describe 'test attribute "percentage_of_shares"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
