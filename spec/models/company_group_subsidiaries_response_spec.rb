...
# Unit tests for SwaggerClient::CompanyGroupSubsidiariesResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyGroupSubsidiariesResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyGroupSubsidiariesResponse.new
  end
  ...
  describe 'test an instance of CompanyGroupSubsidiariesResponse' do
    it 'should create an instance of CompanyGroupSubsidiariesResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyGroupSubsidiariesResponse)
    end
  end
  ...
  describe 'test attribute "group_subsidiaries"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
