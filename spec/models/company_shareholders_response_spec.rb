...
# Unit tests for SwaggerClient::CompanyShareholdersResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyShareholdersResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyShareholdersResponse.new
  end
  ...
  describe 'test an instance of CompanyShareholdersResponse' do
    it 'should create an instance of CompanyShareholdersResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyShareholdersResponse)
    end
  end
  ...
  describe 'test attribute "shareholders"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
