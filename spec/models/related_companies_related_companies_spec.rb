...
# Unit tests for SwaggerClient::RelatedCompaniesRelatedCompanies
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RelatedCompaniesRelatedCompanies' do
  before do
    # run before each test
    @instance = SwaggerClient::RelatedCompaniesRelatedCompanies.new
  end
  ...
  describe 'test an instance of RelatedCompaniesRelatedCompanies' do
    it 'should create an instance of RelatedCompaniesRelatedCompanies' do
      expect(@instance).to be_instance_of(SwaggerClient::RelatedCompaniesRelatedCompanies)
    end
  end
  ...
  describe 'test attribute "name_similarity_score"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "mutual_addresses"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "mutual_major_shareholders"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "mutual_officers"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "mutual_investments"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
