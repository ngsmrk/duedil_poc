...
# Unit tests for SwaggerClient::ExcludableMultiValueFilter
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ExcludableMultiValueFilter' do
  before do
    # run before each test
    @instance = SwaggerClient::ExcludableMultiValueFilter.new
  end
  ...
  describe 'test an instance of ExcludableMultiValueFilter' do
    it 'should create an instance of ExcludableMultiValueFilter' do
      expect(@instance).to be_instance_of(SwaggerClient::ExcludableMultiValueFilter)
    end
  end
