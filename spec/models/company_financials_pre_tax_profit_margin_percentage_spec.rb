...
# Unit tests for SwaggerClient::CompanyFinancialsPreTaxProfitMarginPercentage
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyFinancialsPreTaxProfitMarginPercentage' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyFinancialsPreTaxProfitMarginPercentage.new
  end
  ...
  describe 'test an instance of CompanyFinancialsPreTaxProfitMarginPercentage' do
    it 'should create an instance of CompanyFinancialsPreTaxProfitMarginPercentage' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyFinancialsPreTaxProfitMarginPercentage)
    end
  end
