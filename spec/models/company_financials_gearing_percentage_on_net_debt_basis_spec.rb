...
# Unit tests for SwaggerClient::CompanyFinancialsGearingPercentageOnNetDebtBasis
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyFinancialsGearingPercentageOnNetDebtBasis' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyFinancialsGearingPercentageOnNetDebtBasis.new
  end
  ...
  describe 'test an instance of CompanyFinancialsGearingPercentageOnNetDebtBasis' do
    it 'should create an instance of CompanyFinancialsGearingPercentageOnNetDebtBasis' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyFinancialsGearingPercentageOnNetDebtBasis)
    end
  end
