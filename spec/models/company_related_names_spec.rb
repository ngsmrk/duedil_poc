...
# Unit tests for SwaggerClient::CompanyRelatedNames
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyRelatedNames' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyRelatedNames.new
  end
  ...
  describe 'test an instance of CompanyRelatedNames' do
    it 'should create an instance of CompanyRelatedNames' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyRelatedNames)
    end
  end
