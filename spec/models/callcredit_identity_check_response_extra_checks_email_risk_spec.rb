...
# Unit tests for SwaggerClient::CallcreditIdentityCheckResponseExtraChecksEmailRisk
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CallcreditIdentityCheckResponseExtraChecksEmailRisk' do
  before do
    # run before each test
    @instance = SwaggerClient::CallcreditIdentityCheckResponseExtraChecksEmailRisk.new
  end
  ...
  describe 'test an instance of CallcreditIdentityCheckResponseExtraChecksEmailRisk' do
    it 'should create an instance of CallcreditIdentityCheckResponseExtraChecksEmailRisk' do
      expect(@instance).to be_instance_of(SwaggerClient::CallcreditIdentityCheckResponseExtraChecksEmailRisk)
    end
  end
