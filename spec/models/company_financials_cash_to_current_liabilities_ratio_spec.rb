...
# Unit tests for SwaggerClient::CompanyFinancialsCashToCurrentLiabilitiesRatio
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyFinancialsCashToCurrentLiabilitiesRatio' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyFinancialsCashToCurrentLiabilitiesRatio.new
  end
  ...
  describe 'test an instance of CompanyFinancialsCashToCurrentLiabilitiesRatio' do
    it 'should create an instance of CompanyFinancialsCashToCurrentLiabilitiesRatio' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyFinancialsCashToCurrentLiabilitiesRatio)
    end
  end
