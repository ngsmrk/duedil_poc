...
# Unit tests for SwaggerClient::GazetteNotices
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GazetteNotices' do
  before do
    # run before each test
    @instance = SwaggerClient::GazetteNotices.new
  end
  ...
  describe 'test an instance of GazetteNotices' do
    it 'should create an instance of GazetteNotices' do
      expect(@instance).to be_instance_of(SwaggerClient::GazetteNotices)
    end
  end
