...
# Unit tests for SwaggerClient::CompanyCreditReportCreditReport
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyCreditReportCreditReport' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyCreditReportCreditReport.new
  end
  ...
  describe 'test an instance of CompanyCreditReportCreditReport' do
    it 'should create an instance of CompanyCreditReportCreditReport' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyCreditReportCreditReport)
    end
  end
  ...
  describe 'test attribute "credit_score_history"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "credit_limit_history"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "commentary"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "payment_statistics"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
