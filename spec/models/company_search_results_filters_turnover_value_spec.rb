...
# Unit tests for SwaggerClient::CompanySearchResultsFiltersTurnoverValue
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanySearchResultsFiltersTurnoverValue' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanySearchResultsFiltersTurnoverValue.new
  end
  ...
  describe 'test an instance of CompanySearchResultsFiltersTurnoverValue' do
    it 'should create an instance of CompanySearchResultsFiltersTurnoverValue' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanySearchResultsFiltersTurnoverValue)
    end
  end
