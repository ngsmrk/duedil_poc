...
# Unit tests for SwaggerClient::PEPsAndSanctionsPoliticalPosition
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PEPsAndSanctionsPoliticalPosition' do
  before do
    # run before each test
    @instance = SwaggerClient::PEPsAndSanctionsPoliticalPosition.new
  end
  ...
  describe 'test an instance of PEPsAndSanctionsPoliticalPosition' do
    it 'should create an instance of PEPsAndSanctionsPoliticalPosition' do
      expect(@instance).to be_instance_of(SwaggerClient::PEPsAndSanctionsPoliticalPosition)
    end
  end
