...
# Unit tests for SwaggerClient::CompanyCheckResultsMatchedCompanyIndustries
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyCheckResultsMatchedCompanyIndustries' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyCheckResultsMatchedCompanyIndustries.new
  end
  ...
  describe 'test an instance of CompanyCheckResultsMatchedCompanyIndustries' do
    it 'should create an instance of CompanyCheckResultsMatchedCompanyIndustries' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyCheckResultsMatchedCompanyIndustries)
    end
  end
