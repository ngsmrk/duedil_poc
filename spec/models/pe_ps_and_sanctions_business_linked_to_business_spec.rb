...
# Unit tests for SwaggerClient::PEPsAndSanctionsBusinessLinkedToBusiness
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PEPsAndSanctionsBusinessLinkedToBusiness' do
  before do
    # run before each test
    @instance = SwaggerClient::PEPsAndSanctionsBusinessLinkedToBusiness.new
  end
  ...
  describe 'test an instance of PEPsAndSanctionsBusinessLinkedToBusiness' do
    it 'should create an instance of PEPsAndSanctionsBusinessLinkedToBusiness' do
      expect(@instance).to be_instance_of(SwaggerClient::PEPsAndSanctionsBusinessLinkedToBusiness)
    end
  end
