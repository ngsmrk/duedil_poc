...
# Unit tests for SwaggerClient::CompanyKeywordsResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyKeywordsResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyKeywordsResponse.new
  end
  ...
  describe 'test an instance of CompanyKeywordsResponse' do
    it 'should create an instance of CompanyKeywordsResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyKeywordsResponse)
    end
  end
