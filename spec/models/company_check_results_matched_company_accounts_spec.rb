...
# Unit tests for SwaggerClient::CompanyCheckResultsMatchedCompanyAccounts
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyCheckResultsMatchedCompanyAccounts' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyCheckResultsMatchedCompanyAccounts.new
  end
  ...
  describe 'test an instance of CompanyCheckResultsMatchedCompanyAccounts' do
    it 'should create an instance of CompanyCheckResultsMatchedCompanyAccounts' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyCheckResultsMatchedCompanyAccounts)
    end
  end
  describe 'test attribute "filing_type"' do
    it 'should work' do
  ...
  describe 'test attribute "latest_accounts_date"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "next_accounts_due_date"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "next_accounts_overdue"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
