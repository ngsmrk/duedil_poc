...
# Unit tests for SwaggerClient::KeyCompanyInformation
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'KeyCompanyInformation' do
  before do
    # run before each test
    @instance = SwaggerClient::KeyCompanyInformation.new
  end
  ...
  describe 'test an instance of KeyCompanyInformation' do
    it 'should create an instance of KeyCompanyInformation' do
      expect(@instance).to be_instance_of(SwaggerClient::KeyCompanyInformation)
    end
  end
  ...
  describe 'test attribute "charitable_identities_count"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
