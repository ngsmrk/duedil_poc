...
# Unit tests for SwaggerClient::CompanyFinancialsReturnOnEquity
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyFinancialsReturnOnEquity' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyFinancialsReturnOnEquity.new
  end
  ...
  describe 'test an instance of CompanyFinancialsReturnOnEquity' do
    it 'should create an instance of CompanyFinancialsReturnOnEquity' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyFinancialsReturnOnEquity)
    end
  end
