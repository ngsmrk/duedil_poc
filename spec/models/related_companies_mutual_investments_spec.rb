...
# Unit tests for SwaggerClient::RelatedCompaniesMutualInvestments
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RelatedCompaniesMutualInvestments' do
  before do
    # run before each test
    @instance = SwaggerClient::RelatedCompaniesMutualInvestments.new
  end
  ...
  describe 'test an instance of RelatedCompaniesMutualInvestments' do
    it 'should create an instance of RelatedCompaniesMutualInvestments' do
      expect(@instance).to be_instance_of(SwaggerClient::RelatedCompaniesMutualInvestments)
    end
  end
