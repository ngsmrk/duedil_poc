...
# Unit tests for SwaggerClient::RegionSearchResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RegionSearchResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::RegionSearchResponse.new
  end
  ...
  describe 'test an instance of RegionSearchResponse' do
    it 'should create an instance of RegionSearchResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::RegionSearchResponse)
    end
  end
