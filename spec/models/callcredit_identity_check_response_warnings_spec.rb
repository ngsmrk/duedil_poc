...
# Unit tests for SwaggerClient::CallcreditIdentityCheckResponseWarnings
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CallcreditIdentityCheckResponseWarnings' do
  before do
    # run before each test
    @instance = SwaggerClient::CallcreditIdentityCheckResponseWarnings.new
  end
  ...
  describe 'test an instance of CallcreditIdentityCheckResponseWarnings' do
    it 'should create an instance of CallcreditIdentityCheckResponseWarnings' do
      expect(@instance).to be_instance_of(SwaggerClient::CallcreditIdentityCheckResponseWarnings)
    end
  end
  describe 'test attribute "forward_address_links"' do
    it 'should work' do
  ...
  describe 'test attribute "gone_away"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "sanction"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "sdn"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "share_length_of_residency"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
