...
# Unit tests for SwaggerClient::PEPsAndSanctionsIndividualLinkedToIndividual
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PEPsAndSanctionsIndividualLinkedToIndividual' do
  before do
    # run before each test
    @instance = SwaggerClient::PEPsAndSanctionsIndividualLinkedToIndividual.new
  end
  ...
  describe 'test an instance of PEPsAndSanctionsIndividualLinkedToIndividual' do
    it 'should create an instance of PEPsAndSanctionsIndividualLinkedToIndividual' do
      expect(@instance).to be_instance_of(SwaggerClient::PEPsAndSanctionsIndividualLinkedToIndividual)
    end
  end
