...
# Unit tests for SwaggerClient::SharedPersonMatch
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SharedPersonMatch' do
  before do
    # run before each test
    @instance = SwaggerClient::SharedPersonMatch.new
  end
  ...
  describe 'test an instance of SharedPersonMatch' do
    it 'should create an instance of SharedPersonMatch' do
      expect(@instance).to be_instance_of(SwaggerClient::SharedPersonMatch)
    end
  end
