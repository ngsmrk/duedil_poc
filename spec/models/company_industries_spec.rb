...
# Unit tests for SwaggerClient::CompanyIndustries
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyIndustries' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyIndustries.new
  end
  ...
  describe 'test an instance of CompanyIndustries' do
    it 'should create an instance of CompanyIndustries' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyIndustries)
    end
  end
