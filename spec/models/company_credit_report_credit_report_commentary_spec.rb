...
# Unit tests for SwaggerClient::CompanyCreditReportCreditReportCommentary
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyCreditReportCreditReportCommentary' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyCreditReportCreditReportCommentary.new
  end
  ...
  describe 'test an instance of CompanyCreditReportCreditReportCommentary' do
    it 'should create an instance of CompanyCreditReportCreditReportCommentary' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyCreditReportCreditReportCommentary)
    end
  end
