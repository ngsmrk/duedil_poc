...
# Unit tests for SwaggerClient::CompanySearchResultsFiltersPostTaxProfitValue
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanySearchResultsFiltersPostTaxProfitValue' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanySearchResultsFiltersPostTaxProfitValue.new
  end
  ...
  describe 'test an instance of CompanySearchResultsFiltersPostTaxProfitValue' do
    it 'should create an instance of CompanySearchResultsFiltersPostTaxProfitValue' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanySearchResultsFiltersPostTaxProfitValue)
    end
  end
