...
# Unit tests for SwaggerClient::CompanySearchCriteria
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanySearchCriteria' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanySearchCriteria.new
  end
  ...
  describe 'test an instance of CompanySearchCriteria' do
    it 'should create an instance of CompanySearchCriteria' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanySearchCriteria)
    end
  end
