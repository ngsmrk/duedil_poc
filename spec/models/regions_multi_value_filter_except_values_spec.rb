...
# Unit tests for SwaggerClient::RegionsMultiValueFilterExceptValues
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RegionsMultiValueFilterExceptValues' do
  before do
    # run before each test
    @instance = SwaggerClient::RegionsMultiValueFilterExceptValues.new
  end
  ...
  describe 'test an instance of RegionsMultiValueFilterExceptValues' do
    it 'should create an instance of RegionsMultiValueFilterExceptValues' do
      expect(@instance).to be_instance_of(SwaggerClient::RegionsMultiValueFilterExceptValues)
    end
  end
  ...
  describe 'test attribute "address_types"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
       #validator = Petstore::EnumTest::EnumAttributeValidator.new('Array<String>', ["registered", "trading", "branch"])
