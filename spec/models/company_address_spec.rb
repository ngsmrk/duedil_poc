...
# Unit tests for SwaggerClient::CompanyAddress
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyAddress' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyAddress.new
  end
  ...
  describe 'test an instance of CompanyAddress' do
    it 'should create an instance of CompanyAddress' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyAddress)
    end
  end
