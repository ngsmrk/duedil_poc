...
# Unit tests for SwaggerClient::PoSCSPeople
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PoSCSPeople' do
  before do
    # run before each test
    @instance = SwaggerClient::PoSCSPeople.new
  end
  ...
  describe 'test an instance of PoSCSPeople' do
    it 'should create an instance of PoSCSPeople' do
      expect(@instance).to be_instance_of(SwaggerClient::PoSCSPeople)
    end
  end
