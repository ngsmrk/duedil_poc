...
# Unit tests for SwaggerClient::SocialMediaProfiles
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SocialMediaProfiles' do
  before do
    # run before each test
    @instance = SwaggerClient::SocialMediaProfiles.new
  end
  ...
  describe 'test an instance of SocialMediaProfiles' do
    it 'should create an instance of SocialMediaProfiles' do
      expect(@instance).to be_instance_of(SwaggerClient::SocialMediaProfiles)
    end
  end
