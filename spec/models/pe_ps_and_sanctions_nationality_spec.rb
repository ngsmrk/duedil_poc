...
# Unit tests for SwaggerClient::PEPsAndSanctionsNationality
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PEPsAndSanctionsNationality' do
  before do
    # run before each test
    @instance = SwaggerClient::PEPsAndSanctionsNationality.new
  end
  ...
  describe 'test an instance of PEPsAndSanctionsNationality' do
    it 'should create an instance of PEPsAndSanctionsNationality' do
      expect(@instance).to be_instance_of(SwaggerClient::PEPsAndSanctionsNationality)
    end
  end
