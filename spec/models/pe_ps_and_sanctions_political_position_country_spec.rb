...
# Unit tests for SwaggerClient::PEPsAndSanctionsPoliticalPositionCountry
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PEPsAndSanctionsPoliticalPositionCountry' do
  before do
    # run before each test
    @instance = SwaggerClient::PEPsAndSanctionsPoliticalPositionCountry.new
  end
  ...
  describe 'test an instance of PEPsAndSanctionsPoliticalPositionCountry' do
    it 'should create an instance of PEPsAndSanctionsPoliticalPositionCountry' do
      expect(@instance).to be_instance_of(SwaggerClient::PEPsAndSanctionsPoliticalPositionCountry)
    end
  end
