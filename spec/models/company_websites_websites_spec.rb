...
# Unit tests for SwaggerClient::CompanyWebsitesWebsites
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyWebsitesWebsites' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyWebsitesWebsites.new
  end
  ...
  describe 'test an instance of CompanyWebsitesWebsites' do
    it 'should create an instance of CompanyWebsitesWebsites' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyWebsitesWebsites)
    end
  end
