...
# Unit tests for SwaggerClient::GazetteNoticesGazetteNotices
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GazetteNoticesGazetteNotices' do
  before do
    # run before each test
    @instance = SwaggerClient::GazetteNoticesGazetteNotices.new
  end
  ...
  describe 'test an instance of GazetteNoticesGazetteNotices' do
    it 'should create an instance of GazetteNoticesGazetteNotices' do
      expect(@instance).to be_instance_of(SwaggerClient::GazetteNoticesGazetteNotices)
    end
  end
  ...
  describe 'test attribute "notice_id"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "notice_type"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
