...
# Unit tests for SwaggerClient::KeyCompanyInformationFinancialSummary
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'KeyCompanyInformationFinancialSummary' do
  before do
    # run before each test
    @instance = SwaggerClient::KeyCompanyInformationFinancialSummary.new
  end
  ...
  describe 'test an instance of KeyCompanyInformationFinancialSummary' do
    it 'should create an instance of KeyCompanyInformationFinancialSummary' do
      expect(@instance).to be_instance_of(SwaggerClient::KeyCompanyInformationFinancialSummary)
    end
  end
