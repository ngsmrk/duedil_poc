...
# Unit tests for SwaggerClient::CompanyIndustriesResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyIndustriesResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyIndustriesResponse.new
  end
  ...
  describe 'test an instance of CompanyIndustriesResponse' do
    it 'should create an instance of CompanyIndustriesResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyIndustriesResponse)
    end
  end
