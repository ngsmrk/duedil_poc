...
# Unit tests for SwaggerClient::CallcreditExtraChecksInputExtraChecks
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CallcreditExtraChecksInputExtraChecks' do
  before do
    # run before each test
    @instance = SwaggerClient::CallcreditExtraChecksInputExtraChecks.new
  end
  ...
  describe 'test an instance of CallcreditExtraChecksInputExtraChecks' do
    it 'should create an instance of CallcreditExtraChecksInputExtraChecks' do
      expect(@instance).to be_instance_of(SwaggerClient::CallcreditExtraChecksInputExtraChecks)
    end
  end
