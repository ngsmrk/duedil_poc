...
# Unit tests for SwaggerClient::CompanyAddresses
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyAddresses' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyAddresses.new
  end
  ...
  describe 'test an instance of CompanyAddresses' do
    it 'should create an instance of CompanyAddresses' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyAddresses)
    end
  end
