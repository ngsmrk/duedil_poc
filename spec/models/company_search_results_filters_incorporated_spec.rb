...
# Unit tests for SwaggerClient::CompanySearchResultsFiltersIncorporated
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanySearchResultsFiltersIncorporated' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanySearchResultsFiltersIncorporated.new
  end
  ...
  describe 'test an instance of CompanySearchResultsFiltersIncorporated' do
    it 'should create an instance of CompanySearchResultsFiltersIncorporated' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanySearchResultsFiltersIncorporated)
    end
  end
