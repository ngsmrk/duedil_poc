...
# Unit tests for SwaggerClient::CallcreditIndividualDetailsInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CallcreditIndividualDetailsInput' do
  before do
    # run before each test
    @instance = SwaggerClient::CallcreditIndividualDetailsInput.new
  end
  ...
  describe 'test an instance of CallcreditIndividualDetailsInput' do
    it 'should create an instance of CallcreditIndividualDetailsInput' do
      expect(@instance).to be_instance_of(SwaggerClient::CallcreditIndividualDetailsInput)
    end
  end
