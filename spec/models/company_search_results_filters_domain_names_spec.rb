...
# Unit tests for SwaggerClient::CompanySearchResultsFiltersDomainNames
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanySearchResultsFiltersDomainNames' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanySearchResultsFiltersDomainNames.new
  end
  ...
  describe 'test an instance of CompanySearchResultsFiltersDomainNames' do
    it 'should create an instance of CompanySearchResultsFiltersDomainNames' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanySearchResultsFiltersDomainNames)
    end
  end
