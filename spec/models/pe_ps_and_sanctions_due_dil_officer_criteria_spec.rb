...
# Unit tests for SwaggerClient::PEPsAndSanctionsDueDilOfficerCriteria
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PEPsAndSanctionsDueDilOfficerCriteria' do
  before do
    # run before each test
    @instance = SwaggerClient::PEPsAndSanctionsDueDilOfficerCriteria.new
  end
  ...
  describe 'test an instance of PEPsAndSanctionsDueDilOfficerCriteria' do
    it 'should create an instance of PEPsAndSanctionsDueDilOfficerCriteria' do
      expect(@instance).to be_instance_of(SwaggerClient::PEPsAndSanctionsDueDilOfficerCriteria)
    end
  end
  describe 'test attribute "duedil_officer"' do
    it 'should work' do
