...
# Unit tests for SwaggerClient::CompanySearchResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanySearchResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanySearchResponse.new
  end
  ...
  describe 'test an instance of CompanySearchResponse' do
    it 'should create an instance of CompanySearchResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanySearchResponse)
    end
  end
