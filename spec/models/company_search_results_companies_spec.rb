...
# Unit tests for SwaggerClient::CompanySearchResultsCompanies
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanySearchResultsCompanies' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanySearchResultsCompanies.new
  end
  ...
  describe 'test an instance of CompanySearchResultsCompanies' do
    it 'should create an instance of CompanySearchResultsCompanies' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanySearchResultsCompanies)
    end
  end
  ...
  describe 'test attribute "credit_risk"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
