...
# Unit tests for SwaggerClient::CompanyGazetteNoticesResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyGazetteNoticesResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyGazetteNoticesResponse.new
  end
  ...
  describe 'test an instance of CompanyGazetteNoticesResponse' do
    it 'should create an instance of CompanyGazetteNoticesResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyGazetteNoticesResponse)
    end
  end
  ...
  describe 'test attribute "gazette_notices"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
