...
# Unit tests for SwaggerClient::RegionSearchResults
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RegionSearchResults' do
  before do
    # run before each test
    @instance = SwaggerClient::RegionSearchResults.new
  end
  ...
  describe 'test an instance of RegionSearchResults' do
    it 'should create an instance of RegionSearchResults' do
      expect(@instance).to be_instance_of(SwaggerClient::RegionSearchResults)
    end
  end
