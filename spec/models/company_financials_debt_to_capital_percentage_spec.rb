...
# Unit tests for SwaggerClient::CompanyFinancialsDebtToCapitalPercentage
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyFinancialsDebtToCapitalPercentage' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyFinancialsDebtToCapitalPercentage.new
  end
  ...
  describe 'test an instance of CompanyFinancialsDebtToCapitalPercentage' do
    it 'should create an instance of CompanyFinancialsDebtToCapitalPercentage' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyFinancialsDebtToCapitalPercentage)
    end
  end
