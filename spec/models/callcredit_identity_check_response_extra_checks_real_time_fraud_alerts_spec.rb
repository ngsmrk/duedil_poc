...
# Unit tests for SwaggerClient::CallcreditIdentityCheckResponseExtraChecksRealTimeFraudAlerts
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CallcreditIdentityCheckResponseExtraChecksRealTimeFraudAlerts' do
  before do
    # run before each test
    @instance = SwaggerClient::CallcreditIdentityCheckResponseExtraChecksRealTimeFraudAlerts.new
  end
  ...
  describe 'test an instance of CallcreditIdentityCheckResponseExtraChecksRealTimeFraudAlerts' do
    it 'should create an instance of CallcreditIdentityCheckResponseExtraChecksRealTimeFraudAlerts' do
      expect(@instance).to be_instance_of(SwaggerClient::CallcreditIdentityCheckResponseExtraChecksRealTimeFraudAlerts)
    end
  end
