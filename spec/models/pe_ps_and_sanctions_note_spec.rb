...
# Unit tests for SwaggerClient::PEPsAndSanctionsNote
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PEPsAndSanctionsNote' do
  before do
    # run before each test
    @instance = SwaggerClient::PEPsAndSanctionsNote.new
  end
  ...
  describe 'test an instance of PEPsAndSanctionsNote' do
    it 'should create an instance of PEPsAndSanctionsNote' do
      expect(@instance).to be_instance_of(SwaggerClient::PEPsAndSanctionsNote)
    end
  end
