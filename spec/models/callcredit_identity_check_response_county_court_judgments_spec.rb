...
# Unit tests for SwaggerClient::CallcreditIdentityCheckResponseCountyCourtJudgments
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CallcreditIdentityCheckResponseCountyCourtJudgments' do
  before do
    # run before each test
    @instance = SwaggerClient::CallcreditIdentityCheckResponseCountyCourtJudgments.new
  end
  ...
  describe 'test an instance of CallcreditIdentityCheckResponseCountyCourtJudgments' do
    it 'should create an instance of CallcreditIdentityCheckResponseCountyCourtJudgments' do
      expect(@instance).to be_instance_of(SwaggerClient::CallcreditIdentityCheckResponseCountyCourtJudgments)
    end
  end
  describe 'test attribute "ccj_count"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "ccj_level_of_confidence"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
