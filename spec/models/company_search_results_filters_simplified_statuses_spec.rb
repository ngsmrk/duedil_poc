...
# Unit tests for SwaggerClient::CompanySearchResultsFiltersSimplifiedStatuses
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanySearchResultsFiltersSimplifiedStatuses' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanySearchResultsFiltersSimplifiedStatuses.new
  end
  ...
  describe 'test an instance of CompanySearchResultsFiltersSimplifiedStatuses' do
    it 'should create an instance of CompanySearchResultsFiltersSimplifiedStatuses' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanySearchResultsFiltersSimplifiedStatuses)
    end
  end
