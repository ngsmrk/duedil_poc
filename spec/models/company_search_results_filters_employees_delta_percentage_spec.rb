...
# Unit tests for SwaggerClient::CompanySearchResultsFiltersEmployeesDeltaPercentage
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanySearchResultsFiltersEmployeesDeltaPercentage' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanySearchResultsFiltersEmployeesDeltaPercentage.new
  end
  ...
  describe 'test an instance of CompanySearchResultsFiltersEmployeesDeltaPercentage' do
    it 'should create an instance of CompanySearchResultsFiltersEmployeesDeltaPercentage' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanySearchResultsFiltersEmployeesDeltaPercentage)
    end
  end
