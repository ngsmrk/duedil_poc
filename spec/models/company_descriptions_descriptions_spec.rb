...
# Unit tests for SwaggerClient::CompanyDescriptionsDescriptions
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyDescriptionsDescriptions' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyDescriptionsDescriptions.new
  end
  ...
  describe 'test an instance of CompanyDescriptionsDescriptions' do
    it 'should create an instance of CompanyDescriptionsDescriptions' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyDescriptionsDescriptions)
    end
  end
