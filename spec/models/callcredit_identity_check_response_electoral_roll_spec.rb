...
# Unit tests for SwaggerClient::CallcreditIdentityCheckResponseElectoralRoll
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CallcreditIdentityCheckResponseElectoralRoll' do
  before do
    # run before each test
    @instance = SwaggerClient::CallcreditIdentityCheckResponseElectoralRoll.new
  end
  ...
  describe 'test an instance of CallcreditIdentityCheckResponseElectoralRoll' do
    it 'should create an instance of CallcreditIdentityCheckResponseElectoralRoll' do
      expect(@instance).to be_instance_of(SwaggerClient::CallcreditIdentityCheckResponseElectoralRoll)
    end
  end
  describe 'test attribute "er_match"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "er_level_of_confidence"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
