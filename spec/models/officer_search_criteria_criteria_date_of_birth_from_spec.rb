...
# Unit tests for SwaggerClient::OfficerSearchCriteriaCriteriaDateOfBirthFrom
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OfficerSearchCriteriaCriteriaDateOfBirthFrom' do
  before do
    # run before each test
    @instance = SwaggerClient::OfficerSearchCriteriaCriteriaDateOfBirthFrom.new
  end
  ...
  describe 'test an instance of OfficerSearchCriteriaCriteriaDateOfBirthFrom' do
    it 'should create an instance of OfficerSearchCriteriaCriteriaDateOfBirthFrom' do
      expect(@instance).to be_instance_of(SwaggerClient::OfficerSearchCriteriaCriteriaDateOfBirthFrom)
    end
  end
