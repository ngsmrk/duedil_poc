...
# Unit tests for SwaggerClient::CompanyCheckResultsWarnings
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyCheckResultsWarnings' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyCheckResultsWarnings.new
  end
  ...
  describe 'test an instance of CompanyCheckResultsWarnings' do
    it 'should create an instance of CompanyCheckResultsWarnings' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyCheckResultsWarnings)
    end
  end
  ...
  describe 'test attribute "reasons"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
       #validator = Petstore::EnumTest::EnumAttributeValidator.new('Array<String>', ["Warning: No shareholder information was found", "Warning: No shareholder information was found for the ultimate parent", "Warning: Ultimate parent is a foreign company", "Warning: Annual return or confirmation statement is overdue", "Warning: Accounts are overdue", "Warning: A former officer is disqualified", "Warning: One or more Gazette notices were found", "Warning: Company status is Intermediate", "Warning: PEPs and sanctions check returned one or more businesses with a match score at or above 80"])
