...
# Unit tests for SwaggerClient::CallcreditIdentityCheckResponseDateOfBirth
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CallcreditIdentityCheckResponseDateOfBirth' do
  before do
    # run before each test
    @instance = SwaggerClient::CallcreditIdentityCheckResponseDateOfBirth.new
  end
  ...
  describe 'test an instance of CallcreditIdentityCheckResponseDateOfBirth' do
    it 'should create an instance of CallcreditIdentityCheckResponseDateOfBirth' do
      expect(@instance).to be_instance_of(SwaggerClient::CallcreditIdentityCheckResponseDateOfBirth)
    end
  end
  describe 'test attribute "dob_confirmed_records"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "dob_total_records"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "dob_level_of_confidence"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
