...
# Unit tests for SwaggerClient::CompanyCreditReportCreditReportCountyCourtJudgmentsAmount
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyCreditReportCreditReportCountyCourtJudgmentsAmount' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyCreditReportCreditReportCountyCourtJudgmentsAmount.new
  end
  ...
  describe 'test an instance of CompanyCreditReportCreditReportCountyCourtJudgmentsAmount' do
    it 'should create an instance of CompanyCreditReportCreditReportCountyCourtJudgmentsAmount' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyCreditReportCreditReportCountyCourtJudgmentsAmount)
    end
  end
