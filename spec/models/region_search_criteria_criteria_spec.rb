...
# Unit tests for SwaggerClient::RegionSearchCriteriaCriteria
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RegionSearchCriteriaCriteria' do
  before do
    # run before each test
    @instance = SwaggerClient::RegionSearchCriteriaCriteria.new
  end
  ...
  describe 'test an instance of RegionSearchCriteriaCriteria' do
    it 'should create an instance of RegionSearchCriteriaCriteria' do
      expect(@instance).to be_instance_of(SwaggerClient::RegionSearchCriteriaCriteria)
    end
  end
