...
# Unit tests for SwaggerClient::CompanyCreditReportCreditReportCreditRating
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyCreditReportCreditReportCreditRating' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyCreditReportCreditReportCreditRating.new
  end
  ...
  describe 'test an instance of CompanyCreditReportCreditReportCreditRating' do
    it 'should create an instance of CompanyCreditReportCreditReportCreditRating' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyCreditReportCreditReportCreditRating)
    end
  end
  ...
  describe 'test attribute "credit_band"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
