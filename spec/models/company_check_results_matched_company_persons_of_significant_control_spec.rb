...
# Unit tests for SwaggerClient::CompanyCheckResultsMatchedCompanyPersonsOfSignificantControl
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyCheckResultsMatchedCompanyPersonsOfSignificantControl' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyCheckResultsMatchedCompanyPersonsOfSignificantControl.new
  end
  ...
  describe 'test an instance of CompanyCheckResultsMatchedCompanyPersonsOfSignificantControl' do
    it 'should create an instance of CompanyCheckResultsMatchedCompanyPersonsOfSignificantControl' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyCheckResultsMatchedCompanyPersonsOfSignificantControl)
    end
  end
  ...
  describe 'test attribute "other_legal_entity"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "natures_of_control"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "is_shareholder"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
