...
# Unit tests for SwaggerClient::PEPsAndSanctionsAddress
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PEPsAndSanctionsAddress' do
  before do
    # run before each test
    @instance = SwaggerClient::PEPsAndSanctionsAddress.new
  end
  ...
  describe 'test an instance of PEPsAndSanctionsAddress' do
    it 'should create an instance of PEPsAndSanctionsAddress' do
      expect(@instance).to be_instance_of(SwaggerClient::PEPsAndSanctionsAddress)
    end
  end
