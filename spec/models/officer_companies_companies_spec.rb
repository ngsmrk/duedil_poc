...
# Unit tests for SwaggerClient::OfficerCompaniesCompanies
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OfficerCompaniesCompanies' do
  before do
    # run before each test
    @instance = SwaggerClient::OfficerCompaniesCompanies.new
  end
  ...
  describe 'test an instance of OfficerCompaniesCompanies' do
    it 'should create an instance of OfficerCompaniesCompanies' do
      expect(@instance).to be_instance_of(SwaggerClient::OfficerCompaniesCompanies)
    end
  end
