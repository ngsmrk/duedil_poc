...
# Unit tests for SwaggerClient::CallcreditIdentityCheckResponseExtraChecks
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CallcreditIdentityCheckResponseExtraChecks' do
  before do
    # run before each test
    @instance = SwaggerClient::CallcreditIdentityCheckResponseExtraChecks.new
  end
  ...
  describe 'test an instance of CallcreditIdentityCheckResponseExtraChecks' do
    it 'should create an instance of CallcreditIdentityCheckResponseExtraChecks' do
      expect(@instance).to be_instance_of(SwaggerClient::CallcreditIdentityCheckResponseExtraChecks)
    end
  end
  describe 'test attribute "email_risk"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "real_time_fraud_alerts"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
