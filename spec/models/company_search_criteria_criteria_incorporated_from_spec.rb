...
# Unit tests for SwaggerClient::CompanySearchCriteriaCriteriaIncorporatedFrom
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanySearchCriteriaCriteriaIncorporatedFrom' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanySearchCriteriaCriteriaIncorporatedFrom.new
  end
  ...
  describe 'test an instance of CompanySearchCriteriaCriteriaIncorporatedFrom' do
    it 'should create an instance of CompanySearchCriteriaCriteriaIncorporatedFrom' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanySearchCriteriaCriteriaIncorporatedFrom)
    end
  end
