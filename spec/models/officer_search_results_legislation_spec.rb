...
# Unit tests for SwaggerClient::OfficerSearchResultsLegislation
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OfficerSearchResultsLegislation' do
  before do
    # run before each test
    @instance = SwaggerClient::OfficerSearchResultsLegislation.new
  end
  ...
  describe 'test an instance of OfficerSearchResultsLegislation' do
    it 'should create an instance of OfficerSearchResultsLegislation' do
      expect(@instance).to be_instance_of(SwaggerClient::OfficerSearchResultsLegislation)
    end
  end
