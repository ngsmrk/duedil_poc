...
# Unit tests for SwaggerClient::CompanyCheckResultsMatchedCompanyAnnualReturns
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyCheckResultsMatchedCompanyAnnualReturns' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyCheckResultsMatchedCompanyAnnualReturns.new
  end
  ...
  describe 'test an instance of CompanyCheckResultsMatchedCompanyAnnualReturns' do
    it 'should create an instance of CompanyCheckResultsMatchedCompanyAnnualReturns' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyCheckResultsMatchedCompanyAnnualReturns)
    end
  end
  describe 'test attribute "latest_annual_return_date"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "next_annual_return_due_date"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "next_annual_return_overdue"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
