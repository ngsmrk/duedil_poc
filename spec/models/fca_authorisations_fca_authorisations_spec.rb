...
# Unit tests for SwaggerClient::FCAAuthorisationsFcaAuthorisations
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FCAAuthorisationsFcaAuthorisations' do
  before do
    # run before each test
    @instance = SwaggerClient::FCAAuthorisationsFcaAuthorisations.new
  end
  ...
  describe 'test an instance of FCAAuthorisationsFcaAuthorisations' do
    it 'should create an instance of FCAAuthorisationsFcaAuthorisations' do
      expect(@instance).to be_instance_of(SwaggerClient::FCAAuthorisationsFcaAuthorisations)
    end
  end
  ...
  describe 'test attribute "updated_from_source"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
