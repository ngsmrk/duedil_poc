...
# Unit tests for SwaggerClient::PEPsAndSanctionsAnyBusinessCriteria
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PEPsAndSanctionsAnyBusinessCriteria' do
  before do
    # run before each test
    @instance = SwaggerClient::PEPsAndSanctionsAnyBusinessCriteria.new
  end
  ...
  describe 'test an instance of PEPsAndSanctionsAnyBusinessCriteria' do
    it 'should create an instance of PEPsAndSanctionsAnyBusinessCriteria' do
      expect(@instance).to be_instance_of(SwaggerClient::PEPsAndSanctionsAnyBusinessCriteria)
    end
  end
end
