...
# Unit tests for SwaggerClient::CompanySearchResultsFiltersKeywords
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanySearchResultsFiltersKeywords' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanySearchResultsFiltersKeywords.new
  end
  ...
  describe 'test an instance of CompanySearchResultsFiltersKeywords' do
    it 'should create an instance of CompanySearchResultsFiltersKeywords' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanySearchResultsFiltersKeywords)
    end
  end
