...
# Unit tests for SwaggerClient::PEPsAndSanctionsIndividualAliases
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PEPsAndSanctionsIndividualAliases' do
  before do
    # run before each test
    @instance = SwaggerClient::PEPsAndSanctionsIndividualAliases.new
  end
  ...
  describe 'test an instance of PEPsAndSanctionsIndividualAliases' do
    it 'should create an instance of PEPsAndSanctionsIndividualAliases' do
      expect(@instance).to be_instance_of(SwaggerClient::PEPsAndSanctionsIndividualAliases)
    end
  end
