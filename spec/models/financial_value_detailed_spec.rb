...
# Unit tests for SwaggerClient::FinancialValueDetailed
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FinancialValueDetailed' do
  before do
    # run before each test
    @instance = SwaggerClient::FinancialValueDetailed.new
  end
  ...
  describe 'test an instance of FinancialValueDetailed' do
    it 'should create an instance of FinancialValueDetailed' do
      expect(@instance).to be_instance_of(SwaggerClient::FinancialValueDetailed)
    end
  end
  ...
  describe 'test attribute "delta_absolute"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "delta_percentage"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "three_year_cagr"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "five_year_cagr"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "ten_year_cagr"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
