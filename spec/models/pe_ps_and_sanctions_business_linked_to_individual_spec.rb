...
# Unit tests for SwaggerClient::PEPsAndSanctionsBusinessLinkedToIndividual
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PEPsAndSanctionsBusinessLinkedToIndividual' do
  before do
    # run before each test
    @instance = SwaggerClient::PEPsAndSanctionsBusinessLinkedToIndividual.new
  end
  ...
  describe 'test an instance of PEPsAndSanctionsBusinessLinkedToIndividual' do
    it 'should create an instance of PEPsAndSanctionsBusinessLinkedToIndividual' do
      expect(@instance).to be_instance_of(SwaggerClient::PEPsAndSanctionsBusinessLinkedToIndividual)
    end
  end
