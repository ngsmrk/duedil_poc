...
# Unit tests for SwaggerClient::CompanyFilingsResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyFilingsResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyFilingsResponse.new
  end
  ...
  describe 'test an instance of CompanyFilingsResponse' do
    it 'should create an instance of CompanyFilingsResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyFilingsResponse)
    end
  end
