...
# Unit tests for SwaggerClient::FCAAuthorisations
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FCAAuthorisations' do
  before do
    # run before each test
    @instance = SwaggerClient::FCAAuthorisations.new
  end
  ...
  describe 'test an instance of FCAAuthorisations' do
    it 'should create an instance of FCAAuthorisations' do
      expect(@instance).to be_instance_of(SwaggerClient::FCAAuthorisations)
    end
  end
