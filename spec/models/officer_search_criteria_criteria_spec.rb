...
# Unit tests for SwaggerClient::OfficerSearchCriteriaCriteria
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OfficerSearchCriteriaCriteria' do
  before do
    # run before each test
    @instance = SwaggerClient::OfficerSearchCriteriaCriteria.new
  end
  ...
  describe 'test an instance of OfficerSearchCriteriaCriteria' do
    it 'should create an instance of OfficerSearchCriteriaCriteria' do
      expect(@instance).to be_instance_of(SwaggerClient::OfficerSearchCriteriaCriteria)
    end
  end
  ...
  describe 'test attribute "is_disqualified"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
