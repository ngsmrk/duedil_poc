...
# Unit tests for SwaggerClient::CompanyFinancialsOperatingProfitMarginPercentage
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyFinancialsOperatingProfitMarginPercentage' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyFinancialsOperatingProfitMarginPercentage.new
  end
  ...
  describe 'test an instance of CompanyFinancialsOperatingProfitMarginPercentage' do
    it 'should create an instance of CompanyFinancialsOperatingProfitMarginPercentage' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyFinancialsOperatingProfitMarginPercentage)
    end
  end
