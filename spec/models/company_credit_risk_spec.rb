...
# Unit tests for SwaggerClient::CompanyCreditRisk
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyCreditRisk' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyCreditRisk.new
  end
  ...
  describe 'test an instance of CompanyCreditRisk' do
    it 'should create an instance of CompanyCreditRisk' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyCreditRisk)
    end
  end
end
