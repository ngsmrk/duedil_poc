...
# Unit tests for SwaggerClient::PEPsAndSanctionsAddressSourceAddress
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PEPsAndSanctionsAddressSourceAddress' do
  before do
    # run before each test
    @instance = SwaggerClient::PEPsAndSanctionsAddressSourceAddress.new
  end
  ...
  describe 'test an instance of PEPsAndSanctionsAddressSourceAddress' do
    it 'should create an instance of PEPsAndSanctionsAddressSourceAddress' do
      expect(@instance).to be_instance_of(SwaggerClient::PEPsAndSanctionsAddressSourceAddress)
    end
  end
