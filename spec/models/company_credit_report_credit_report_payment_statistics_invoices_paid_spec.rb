...
# Unit tests for SwaggerClient::CompanyCreditReportCreditReportPaymentStatisticsInvoicesPaid
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyCreditReportCreditReportPaymentStatisticsInvoicesPaid' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyCreditReportCreditReportPaymentStatisticsInvoicesPaid.new
  end
  ...
  describe 'test an instance of CompanyCreditReportCreditReportPaymentStatisticsInvoicesPaid' do
    it 'should create an instance of CompanyCreditReportCreditReportPaymentStatisticsInvoicesPaid' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyCreditReportCreditReportPaymentStatisticsInvoicesPaid)
    end
  end
  describe 'test attribute "before_threshold"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "after_threshold"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
