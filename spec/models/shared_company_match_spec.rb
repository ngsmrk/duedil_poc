...
# Unit tests for SwaggerClient::SharedCompanyMatch
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SharedCompanyMatch' do
  before do
    # run before each test
    @instance = SwaggerClient::SharedCompanyMatch.new
  end
  ...
  describe 'test an instance of SharedCompanyMatch' do
    it 'should create an instance of SharedCompanyMatch' do
      expect(@instance).to be_instance_of(SwaggerClient::SharedCompanyMatch)
    end
  end
