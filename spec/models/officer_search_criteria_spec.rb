...
# Unit tests for SwaggerClient::OfficerSearchCriteria
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OfficerSearchCriteria' do
  before do
    # run before each test
    @instance = SwaggerClient::OfficerSearchCriteria.new
  end
  ...
  describe 'test an instance of OfficerSearchCriteria' do
    it 'should create an instance of OfficerSearchCriteria' do
      expect(@instance).to be_instance_of(SwaggerClient::OfficerSearchCriteria)
    end
  end
