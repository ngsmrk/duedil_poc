...
# Unit tests for SwaggerClient::CompanyFinancialsInterestCoverageRatio
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyFinancialsInterestCoverageRatio' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyFinancialsInterestCoverageRatio.new
  end
  ...
  describe 'test an instance of CompanyFinancialsInterestCoverageRatio' do
    it 'should create an instance of CompanyFinancialsInterestCoverageRatio' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyFinancialsInterestCoverageRatio)
    end
  end
