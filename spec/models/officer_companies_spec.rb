...
# Unit tests for SwaggerClient::OfficerCompanies
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OfficerCompanies' do
  before do
    # run before each test
    @instance = SwaggerClient::OfficerCompanies.new
  end
  ...
  describe 'test an instance of OfficerCompanies' do
    it 'should create an instance of OfficerCompanies' do
      expect(@instance).to be_instance_of(SwaggerClient::OfficerCompanies)
    end
  end
