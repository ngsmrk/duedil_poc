...
# Unit tests for SwaggerClient::CompanyCheckResultsMatchedCompanyImmediateParents
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyCheckResultsMatchedCompanyImmediateParents' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyCheckResultsMatchedCompanyImmediateParents.new
  end
  ...
  describe 'test an instance of CompanyCheckResultsMatchedCompanyImmediateParents' do
    it 'should create an instance of CompanyCheckResultsMatchedCompanyImmediateParents' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyCheckResultsMatchedCompanyImmediateParents)
    end
  end
