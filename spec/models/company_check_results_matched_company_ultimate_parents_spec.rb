...
# Unit tests for SwaggerClient::CompanyCheckResultsMatchedCompanyUltimateParents
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyCheckResultsMatchedCompanyUltimateParents' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyCheckResultsMatchedCompanyUltimateParents.new
  end
  ...
  describe 'test an instance of CompanyCheckResultsMatchedCompanyUltimateParents' do
    it 'should create an instance of CompanyCheckResultsMatchedCompanyUltimateParents' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyCheckResultsMatchedCompanyUltimateParents)
    end
  end
