...
# Unit tests for SwaggerClient::CompanyKeywordsKeywords
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyKeywordsKeywords' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyKeywordsKeywords.new
  end
  ...
  describe 'test an instance of CompanyKeywordsKeywords' do
    it 'should create an instance of CompanyKeywordsKeywords' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyKeywordsKeywords)
    end
  end
