...
# Unit tests for SwaggerClient::CompanyCheckResultsMatchedCompanyNominalValue
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyCheckResultsMatchedCompanyNominalValue' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyCheckResultsMatchedCompanyNominalValue.new
  end
  ...
  describe 'test an instance of CompanyCheckResultsMatchedCompanyNominalValue' do
    it 'should create an instance of CompanyCheckResultsMatchedCompanyNominalValue' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyCheckResultsMatchedCompanyNominalValue)
    end
  end
