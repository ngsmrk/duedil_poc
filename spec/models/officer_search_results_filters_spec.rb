...
# Unit tests for SwaggerClient::OfficerSearchResultsFilters
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OfficerSearchResultsFilters' do
  before do
    # run before each test
    @instance = SwaggerClient::OfficerSearchResultsFilters.new
  end
  ...
  describe 'test an instance of OfficerSearchResultsFilters' do
    it 'should create an instance of OfficerSearchResultsFilters' do
      expect(@instance).to be_instance_of(SwaggerClient::OfficerSearchResultsFilters)
    end
  end
