...
# Unit tests for SwaggerClient::SharedExactMatchesInner
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SharedExactMatchesInner' do
  before do
    # run before each test
    @instance = SwaggerClient::SharedExactMatchesInner.new
  end
  ...
  describe 'test an instance of SharedExactMatchesInner' do
    it 'should create an instance of SharedExactMatchesInner' do
      expect(@instance).to be_instance_of(SwaggerClient::SharedExactMatchesInner)
    end
  end
