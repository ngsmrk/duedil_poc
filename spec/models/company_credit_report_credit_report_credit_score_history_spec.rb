...
# Unit tests for SwaggerClient::CompanyCreditReportCreditReportCreditScoreHistory
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyCreditReportCreditReportCreditScoreHistory' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyCreditReportCreditReportCreditScoreHistory.new
  end
  ...
  describe 'test an instance of CompanyCreditReportCreditReportCreditScoreHistory' do
    it 'should create an instance of CompanyCreditReportCreditReportCreditScoreHistory' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyCreditReportCreditReportCreditScoreHistory)
    end
  end
