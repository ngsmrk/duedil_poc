...
# Unit tests for SwaggerClient::CompanyFinancialsInventoryTurnoverRatio
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyFinancialsInventoryTurnoverRatio' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyFinancialsInventoryTurnoverRatio.new
  end
  ...
  describe 'test an instance of CompanyFinancialsInventoryTurnoverRatio' do
    it 'should create an instance of CompanyFinancialsInventoryTurnoverRatio' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyFinancialsInventoryTurnoverRatio)
    end
  end
