...
# Unit tests for SwaggerClient::CompanyWebsitesResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyWebsitesResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyWebsitesResponse.new
  end
  ...
  describe 'test an instance of CompanyWebsitesResponse' do
    it 'should create an instance of CompanyWebsitesResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyWebsitesResponse)
    end
  end
