...
# Unit tests for SwaggerClient::CompanyDescriptions
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyDescriptions' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyDescriptions.new
  end
  ...
  describe 'test an instance of CompanyDescriptions' do
    it 'should create an instance of CompanyDescriptions' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyDescriptions)
    end
  end
