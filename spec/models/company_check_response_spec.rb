...
# Unit tests for SwaggerClient::CompanyCheckResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyCheckResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyCheckResponse.new
  end
  ...
  describe 'test an instance of CompanyCheckResponse' do
    it 'should create an instance of CompanyCheckResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyCheckResponse)
    end
  end
  ...
  describe 'test attribute "kyb_result"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "matched_company"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "picklist_companies"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "report_charged"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
