...
# Unit tests for SwaggerClient::CompanySearchResultsFiltersEbitdaDeltaPercentage
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanySearchResultsFiltersEbitdaDeltaPercentage' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanySearchResultsFiltersEbitdaDeltaPercentage.new
  end
  ...
  describe 'test an instance of CompanySearchResultsFiltersEbitdaDeltaPercentage' do
    it 'should create an instance of CompanySearchResultsFiltersEbitdaDeltaPercentage' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanySearchResultsFiltersEbitdaDeltaPercentage)
    end
  end
