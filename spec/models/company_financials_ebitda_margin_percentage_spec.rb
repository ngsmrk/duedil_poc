...
# Unit tests for SwaggerClient::CompanyFinancialsEbitdaMarginPercentage
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyFinancialsEbitdaMarginPercentage' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyFinancialsEbitdaMarginPercentage.new
  end
  ...
  describe 'test an instance of CompanyFinancialsEbitdaMarginPercentage' do
    it 'should create an instance of CompanyFinancialsEbitdaMarginPercentage' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyFinancialsEbitdaMarginPercentage)
    end
  end
