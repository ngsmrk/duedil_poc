...
# Unit tests for SwaggerClient::CompanyTelephoneNumbers
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyTelephoneNumbers' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyTelephoneNumbers.new
  end
  ...
  describe 'test an instance of CompanyTelephoneNumbers' do
    it 'should create an instance of CompanyTelephoneNumbers' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyTelephoneNumbers)
    end
  end
