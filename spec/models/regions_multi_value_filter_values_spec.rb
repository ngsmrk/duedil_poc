...
# Unit tests for SwaggerClient::RegionsMultiValueFilterValues
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RegionsMultiValueFilterValues' do
  before do
    # run before each test
    @instance = SwaggerClient::RegionsMultiValueFilterValues.new
  end
  ...
  describe 'test an instance of RegionsMultiValueFilterValues' do
    it 'should create an instance of RegionsMultiValueFilterValues' do
      expect(@instance).to be_instance_of(SwaggerClient::RegionsMultiValueFilterValues)
    end
  end
