...
# Unit tests for SwaggerClient::StructuredAddress
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'StructuredAddress' do
  before do
    # run before each test
    @instance = SwaggerClient::StructuredAddress.new
  end
  ...
  describe 'test an instance of StructuredAddress' do
    it 'should create an instance of StructuredAddress' do
      expect(@instance).to be_instance_of(SwaggerClient::StructuredAddress)
    end
  end
  describe 'test attribute "premises"' do
    it 'should work' do
