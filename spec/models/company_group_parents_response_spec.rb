...
# Unit tests for SwaggerClient::CompanyGroupParentsResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyGroupParentsResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyGroupParentsResponse.new
  end
  ...
  describe 'test an instance of CompanyGroupParentsResponse' do
    it 'should create an instance of CompanyGroupParentsResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyGroupParentsResponse)
    end
  end
  ...
  describe 'test attribute "group_parents"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
