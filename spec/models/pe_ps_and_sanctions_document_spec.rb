...
# Unit tests for SwaggerClient::PEPsAndSanctionsDocument
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PEPsAndSanctionsDocument' do
  before do
    # run before each test
    @instance = SwaggerClient::PEPsAndSanctionsDocument.new
  end
  ...
  describe 'test an instance of PEPsAndSanctionsDocument' do
    it 'should create an instance of PEPsAndSanctionsDocument' do
      expect(@instance).to be_instance_of(SwaggerClient::PEPsAndSanctionsDocument)
    end
  end
