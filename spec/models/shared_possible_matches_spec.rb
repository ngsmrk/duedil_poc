...
# Unit tests for SwaggerClient::SharedPossibleMatches
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SharedPossibleMatches' do
  before do
    # run before each test
    @instance = SwaggerClient::SharedPossibleMatches.new
  end
  ...
  describe 'test an instance of SharedPossibleMatches' do
    it 'should create an instance of SharedPossibleMatches' do
      expect(@instance).to be_instance_of(SwaggerClient::SharedPossibleMatches)
    end
  end
end
