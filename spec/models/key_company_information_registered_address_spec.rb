...
# Unit tests for SwaggerClient::KeyCompanyInformationRegisteredAddress
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'KeyCompanyInformationRegisteredAddress' do
  before do
    # run before each test
    @instance = SwaggerClient::KeyCompanyInformationRegisteredAddress.new
  end
  ...
  describe 'test an instance of KeyCompanyInformationRegisteredAddress' do
    it 'should create an instance of KeyCompanyInformationRegisteredAddress' do
      expect(@instance).to be_instance_of(SwaggerClient::KeyCompanyInformationRegisteredAddress)
    end
  end
