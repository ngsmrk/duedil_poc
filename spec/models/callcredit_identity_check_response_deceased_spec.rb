...
# Unit tests for SwaggerClient::CallcreditIdentityCheckResponseDeceased
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CallcreditIdentityCheckResponseDeceased' do
  before do
    # run before each test
    @instance = SwaggerClient::CallcreditIdentityCheckResponseDeceased.new
  end
  ...
  describe 'test an instance of CallcreditIdentityCheckResponseDeceased' do
    it 'should create an instance of CallcreditIdentityCheckResponseDeceased' do
      expect(@instance).to be_instance_of(SwaggerClient::CallcreditIdentityCheckResponseDeceased)
    end
  end
  describe 'test attribute "gro_match"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "halo_match"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "halo_level_of_confidence"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
