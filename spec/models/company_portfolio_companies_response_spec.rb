...
# Unit tests for SwaggerClient::CompanyPortfolioCompaniesResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyPortfolioCompaniesResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyPortfolioCompaniesResponse.new
  end
  ...
  describe 'test an instance of CompanyPortfolioCompaniesResponse' do
    it 'should create an instance of CompanyPortfolioCompaniesResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyPortfolioCompaniesResponse)
    end
  end
  ...
  describe 'test attribute "portfolio_companies"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
