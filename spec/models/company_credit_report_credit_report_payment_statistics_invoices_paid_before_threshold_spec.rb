...
# Unit tests for SwaggerClient::CompanyCreditReportCreditReportPaymentStatisticsInvoicesPaidBeforeThreshold
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyCreditReportCreditReportPaymentStatisticsInvoicesPaidBeforeThreshold' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyCreditReportCreditReportPaymentStatisticsInvoicesPaidBeforeThreshold.new
  end
  ...
  describe 'test an instance of CompanyCreditReportCreditReportPaymentStatisticsInvoicesPaidBeforeThreshold' do
    it 'should create an instance of CompanyCreditReportCreditReportPaymentStatisticsInvoicesPaidBeforeThreshold' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyCreditReportCreditReportPaymentStatisticsInvoicesPaidBeforeThreshold)
    end
  end
  ...
  describe 'test attribute "percentage_of_total"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
