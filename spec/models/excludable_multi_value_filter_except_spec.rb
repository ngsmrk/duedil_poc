...
# Unit tests for SwaggerClient::ExcludableMultiValueFilterExcept
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ExcludableMultiValueFilterExcept' do
  before do
    # run before each test
    @instance = SwaggerClient::ExcludableMultiValueFilterExcept.new
  end
  ...
  describe 'test an instance of ExcludableMultiValueFilterExcept' do
    it 'should create an instance of ExcludableMultiValueFilterExcept' do
      expect(@instance).to be_instance_of(SwaggerClient::ExcludableMultiValueFilterExcept)
    end
  end
