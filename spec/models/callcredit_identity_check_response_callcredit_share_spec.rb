...
# Unit tests for SwaggerClient::CallcreditIdentityCheckResponseCallcreditSHARE
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CallcreditIdentityCheckResponseCallcreditSHARE' do
  before do
    # run before each test
    @instance = SwaggerClient::CallcreditIdentityCheckResponseCallcreditSHARE.new
  end
  ...
  describe 'test an instance of CallcreditIdentityCheckResponseCallcreditSHARE' do
    it 'should create an instance of CallcreditIdentityCheckResponseCallcreditSHARE' do
      expect(@instance).to be_instance_of(SwaggerClient::CallcreditIdentityCheckResponseCallcreditSHARE)
    end
  end
  describe 'test attribute "share_record_count"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "share_level_of_confidence"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
