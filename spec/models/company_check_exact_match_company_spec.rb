...
# Unit tests for SwaggerClient::CompanyCheckExactMatchCompany
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyCheckExactMatchCompany' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyCheckExactMatchCompany.new
  end
  ...
  describe 'test an instance of CompanyCheckExactMatchCompany' do
    it 'should create an instance of CompanyCheckExactMatchCompany' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyCheckExactMatchCompany)
    end
  end
