...
# Unit tests for SwaggerClient::PEPsAndSanctionsIndividualSearchResults
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PEPsAndSanctionsIndividualSearchResults' do
  before do
    # run before each test
    @instance = SwaggerClient::PEPsAndSanctionsIndividualSearchResults.new
  end
  ...
  describe 'test an instance of PEPsAndSanctionsIndividualSearchResults' do
    it 'should create an instance of PEPsAndSanctionsIndividualSearchResults' do
      expect(@instance).to be_instance_of(SwaggerClient::PEPsAndSanctionsIndividualSearchResults)
    end
  end
