...
# Unit tests for SwaggerClient::CompanyKeywords
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyKeywords' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyKeywords.new
  end
  ...
  describe 'test an instance of CompanyKeywords' do
    it 'should create an instance of CompanyKeywords' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyKeywords)
    end
  end
