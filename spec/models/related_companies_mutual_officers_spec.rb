...
# Unit tests for SwaggerClient::RelatedCompaniesMutualOfficers
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RelatedCompaniesMutualOfficers' do
  before do
    # run before each test
    @instance = SwaggerClient::RelatedCompaniesMutualOfficers.new
  end
  ...
  describe 'test an instance of RelatedCompaniesMutualOfficers' do
    it 'should create an instance of RelatedCompaniesMutualOfficers' do
      expect(@instance).to be_instance_of(SwaggerClient::RelatedCompaniesMutualOfficers)
    end
  end
