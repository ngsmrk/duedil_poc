...
# Unit tests for SwaggerClient::PEPsAndSanctionsAnyBusinessSearchCriteria
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PEPsAndSanctionsAnyBusinessSearchCriteria' do
  before do
    # run before each test
    @instance = SwaggerClient::PEPsAndSanctionsAnyBusinessSearchCriteria.new
  end
  ...
  describe 'test an instance of PEPsAndSanctionsAnyBusinessSearchCriteria' do
    it 'should create an instance of PEPsAndSanctionsAnyBusinessSearchCriteria' do
      expect(@instance).to be_instance_of(SwaggerClient::PEPsAndSanctionsAnyBusinessSearchCriteria)
    end
  end
