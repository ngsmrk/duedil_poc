...
# Unit tests for SwaggerClient::CompanyCheckResultsMatchedCompanyPepsSanctionsCheckFailure
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyCheckResultsMatchedCompanyPepsSanctionsCheckFailure' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyCheckResultsMatchedCompanyPepsSanctionsCheckFailure.new
  end
  ...
  describe 'test an instance of CompanyCheckResultsMatchedCompanyPepsSanctionsCheckFailure' do
    it 'should create an instance of CompanyCheckResultsMatchedCompanyPepsSanctionsCheckFailure' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyCheckResultsMatchedCompanyPepsSanctionsCheckFailure)
    end
  end
  ...
  describe 'test attribute "matches_triggering_failure"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
