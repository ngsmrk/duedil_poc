...
# Unit tests for SwaggerClient::CompanyCreditReportResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyCreditReportResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyCreditReportResponse.new
  end
  ...
  describe 'test an instance of CompanyCreditReportResponse' do
    it 'should create an instance of CompanyCreditReportResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyCreditReportResponse)
    end
  end
