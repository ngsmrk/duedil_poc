...
# Unit tests for SwaggerClient::CompanyFinancialsNetDebtToEBITDARatio
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyFinancialsNetDebtToEBITDARatio' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyFinancialsNetDebtToEBITDARatio.new
  end
  ...
  describe 'test an instance of CompanyFinancialsNetDebtToEBITDARatio' do
    it 'should create an instance of CompanyFinancialsNetDebtToEBITDARatio' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyFinancialsNetDebtToEBITDARatio)
    end
  end
