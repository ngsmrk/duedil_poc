...
# Unit tests for SwaggerClient::CompanySearchResults
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanySearchResults' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanySearchResults.new
  end
  ...
  describe 'test an instance of CompanySearchResults' do
    it 'should create an instance of CompanySearchResults' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanySearchResults)
    end
  end
