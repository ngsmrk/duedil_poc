...
# Unit tests for SwaggerClient::CallcreditIdentityCheckResponseExtraChecksEmailRiskReport
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CallcreditIdentityCheckResponseExtraChecksEmailRiskReport' do
  before do
    # run before each test
    @instance = SwaggerClient::CallcreditIdentityCheckResponseExtraChecksEmailRiskReport.new
  end
  ...
  describe 'test an instance of CallcreditIdentityCheckResponseExtraChecksEmailRiskReport' do
    it 'should create an instance of CallcreditIdentityCheckResponseExtraChecksEmailRiskReport' do
      expect(@instance).to be_instance_of(SwaggerClient::CallcreditIdentityCheckResponseExtraChecksEmailRiskReport)
    end
  end
  ...
  describe 'test attribute "risk_level"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
       #validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["very-high", "high", "medium-high", "neutral", "low", "very-low"])
  ...
  describe 'test attribute "first_verified_date"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "status"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
       #validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["active", "inactive", "expired", "unknown"])
       #validator.allowable_values.each do |value|
