...
# Unit tests for SwaggerClient::CompanyCheckResultsMatchedCompanyPersonNationalities
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyCheckResultsMatchedCompanyPersonNationalities' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyCheckResultsMatchedCompanyPersonNationalities.new
  end
  ...
  describe 'test an instance of CompanyCheckResultsMatchedCompanyPersonNationalities' do
    it 'should create an instance of CompanyCheckResultsMatchedCompanyPersonNationalities' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyCheckResultsMatchedCompanyPersonNationalities)
    end
  end
  describe 'test attribute "demonym"' do
    it 'should work' do
