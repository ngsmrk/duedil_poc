...
# Unit tests for SwaggerClient::CompanyRegisteredNamesRegisteredNames
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyRegisteredNamesRegisteredNames' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyRegisteredNamesRegisteredNames.new
  end
  ...
  describe 'test an instance of CompanyRegisteredNamesRegisteredNames' do
    it 'should create an instance of CompanyRegisteredNamesRegisteredNames' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyRegisteredNamesRegisteredNames)
    end
  end
