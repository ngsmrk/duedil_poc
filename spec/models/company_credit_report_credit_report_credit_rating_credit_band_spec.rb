...
# Unit tests for SwaggerClient::CompanyCreditReportCreditReportCreditRatingCreditBand
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyCreditReportCreditReportCreditRatingCreditBand' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyCreditReportCreditReportCreditRatingCreditBand.new
  end
  ...
  describe 'test an instance of CompanyCreditReportCreditReportCreditRatingCreditBand' do
    it 'should create an instance of CompanyCreditReportCreditReportCreditRatingCreditBand' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyCreditReportCreditReportCreditRatingCreditBand)
    end
  end
