...
# Unit tests for SwaggerClient::CompanyPortfolioCompanies
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyPortfolioCompanies' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyPortfolioCompanies.new
  end
  ...
  describe 'test an instance of CompanyPortfolioCompanies' do
    it 'should create an instance of CompanyPortfolioCompanies' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyPortfolioCompanies)
    end
  end
