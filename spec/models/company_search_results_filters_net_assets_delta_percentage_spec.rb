...
# Unit tests for SwaggerClient::CompanySearchResultsFiltersNetAssetsDeltaPercentage
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanySearchResultsFiltersNetAssetsDeltaPercentage' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanySearchResultsFiltersNetAssetsDeltaPercentage.new
  end
  ...
  describe 'test an instance of CompanySearchResultsFiltersNetAssetsDeltaPercentage' do
    it 'should create an instance of CompanySearchResultsFiltersNetAssetsDeltaPercentage' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanySearchResultsFiltersNetAssetsDeltaPercentage)
    end
  end
