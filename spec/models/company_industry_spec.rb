...
# Unit tests for SwaggerClient::CompanyIndustry
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyIndustry' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyIndustry.new
  end
  ...
  describe 'test an instance of CompanyIndustry' do
    it 'should create an instance of CompanyIndustry' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyIndustry)
    end
  end
