...
# Unit tests for SwaggerClient::KeywordSearchCriteria
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'KeywordSearchCriteria' do
  before do
    # run before each test
    @instance = SwaggerClient::KeywordSearchCriteria.new
  end
  ...
  describe 'test an instance of KeywordSearchCriteria' do
    it 'should create an instance of KeywordSearchCriteria' do
      expect(@instance).to be_instance_of(SwaggerClient::KeywordSearchCriteria)
    end
  end
