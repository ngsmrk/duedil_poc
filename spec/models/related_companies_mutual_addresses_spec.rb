...
# Unit tests for SwaggerClient::RelatedCompaniesMutualAddresses
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RelatedCompaniesMutualAddresses' do
  before do
    # run before each test
    @instance = SwaggerClient::RelatedCompaniesMutualAddresses.new
  end
  ...
  describe 'test an instance of RelatedCompaniesMutualAddresses' do
    it 'should create an instance of RelatedCompaniesMutualAddresses' do
      expect(@instance).to be_instance_of(SwaggerClient::RelatedCompaniesMutualAddresses)
    end
  end
