...
# Unit tests for SwaggerClient::CompanySearchResultsFiltersPostTaxProfitDeltaPercentage
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanySearchResultsFiltersPostTaxProfitDeltaPercentage' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanySearchResultsFiltersPostTaxProfitDeltaPercentage.new
  end
  ...
  describe 'test an instance of CompanySearchResultsFiltersPostTaxProfitDeltaPercentage' do
    it 'should create an instance of CompanySearchResultsFiltersPostTaxProfitDeltaPercentage' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanySearchResultsFiltersPostTaxProfitDeltaPercentage)
    end
  end
