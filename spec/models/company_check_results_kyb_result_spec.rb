...
# Unit tests for SwaggerClient::CompanyCheckResultsKybResult
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyCheckResultsKybResult' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyCheckResultsKybResult.new
  end
  ...
  describe 'test an instance of CompanyCheckResultsKybResult' do
    it 'should create an instance of CompanyCheckResultsKybResult' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyCheckResultsKybResult)
    end
  end
  describe 'test attribute "value"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
       #validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["PASS", "FAIL", "PICKLIST"])
  ...
  describe 'test attribute "reasons"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
       #validator = Petstore::EnumTest::EnumAttributeValidator.new('Array<String>', ["Failure: A current officer is disqualified", "Failure: Company matched has no data", "Failure: Company status is Closed", "Failure: Company status is Dissolved", "Failure: Company status is not Active", "Failure: No company was matched", "Failure: One or more Gazette notices were found", "Failure: PEPs and sanctions check returned one or more businesses with a match score of 100", "Failure: PEPs and sanctions check unavailable", "Picklist: Several companies match your criteria"])
       #validator.allowable_values.each do |value|
