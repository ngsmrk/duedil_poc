...
# Unit tests for SwaggerClient::CompanyFilingsFilings
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyFilingsFilings' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyFilingsFilings.new
  end
  ...
  describe 'test an instance of CompanyFilingsFilings' do
    it 'should create an instance of CompanyFilingsFilings' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyFilingsFilings)
    end
  end
