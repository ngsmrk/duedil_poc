...
# Unit tests for SwaggerClient::PEPsAndSanctionsSanctionType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PEPsAndSanctionsSanctionType' do
  before do
    # run before each test
    @instance = SwaggerClient::PEPsAndSanctionsSanctionType.new
  end
  ...
  describe 'test an instance of PEPsAndSanctionsSanctionType' do
    it 'should create an instance of PEPsAndSanctionsSanctionType' do
      expect(@instance).to be_instance_of(SwaggerClient::PEPsAndSanctionsSanctionType)
    end
  end
