...
# Unit tests for SwaggerClient::CompanyFinancialsCashToTurnoverRatio
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyFinancialsCashToTurnoverRatio' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyFinancialsCashToTurnoverRatio.new
  end
  ...
  describe 'test an instance of CompanyFinancialsCashToTurnoverRatio' do
    it 'should create an instance of CompanyFinancialsCashToTurnoverRatio' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyFinancialsCashToTurnoverRatio)
    end
  end
