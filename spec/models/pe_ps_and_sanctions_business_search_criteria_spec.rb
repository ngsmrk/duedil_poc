...
# Unit tests for SwaggerClient::PEPsAndSanctionsBusinessSearchCriteria
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PEPsAndSanctionsBusinessSearchCriteria' do
  before do
    # run before each test
    @instance = SwaggerClient::PEPsAndSanctionsBusinessSearchCriteria.new
  end
  ...
  describe 'test an instance of PEPsAndSanctionsBusinessSearchCriteria' do
    it 'should create an instance of PEPsAndSanctionsBusinessSearchCriteria' do
      expect(@instance).to be_instance_of(SwaggerClient::PEPsAndSanctionsBusinessSearchCriteria)
    end
  end
end
