...
# Unit tests for SwaggerClient::SharedExactMatches
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SharedExactMatches' do
  before do
    # run before each test
    @instance = SwaggerClient::SharedExactMatches.new
  end
  ...
  describe 'test an instance of SharedExactMatches' do
    it 'should create an instance of SharedExactMatches' do
      expect(@instance).to be_instance_of(SwaggerClient::SharedExactMatches)
    end
  end
end
