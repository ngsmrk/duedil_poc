...
# Unit tests for SwaggerClient::CallcreditIdentityCheckResponseExtraChecksRealTimeFraudAlertsReportSummary
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CallcreditIdentityCheckResponseExtraChecksRealTimeFraudAlertsReportSummary' do
  before do
    # run before each test
    @instance = SwaggerClient::CallcreditIdentityCheckResponseExtraChecksRealTimeFraudAlertsReportSummary.new
  end
  ...
  describe 'test an instance of CallcreditIdentityCheckResponseExtraChecksRealTimeFraudAlertsReportSummary' do
    it 'should create an instance of CallcreditIdentityCheckResponseExtraChecksRealTimeFraudAlertsReportSummary' do
      expect(@instance).to be_instance_of(SwaggerClient::CallcreditIdentityCheckResponseExtraChecksRealTimeFraudAlertsReportSummary)
    end
  end
  describe 'test attribute "velocity_threshold"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "velocity_period"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "inconsistency_threshold"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "inconsistency_period"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "total_velocity_warnings"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "total_inconsistency_warnings"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
