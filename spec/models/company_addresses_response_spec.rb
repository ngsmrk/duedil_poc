...
# Unit tests for SwaggerClient::CompanyAddressesResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyAddressesResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyAddressesResponse.new
  end
  ...
  describe 'test an instance of CompanyAddressesResponse' do
    it 'should create an instance of CompanyAddressesResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyAddressesResponse)
    end
  end
