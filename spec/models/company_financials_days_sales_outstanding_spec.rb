...
# Unit tests for SwaggerClient::CompanyFinancialsDaysSalesOutstanding
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyFinancialsDaysSalesOutstanding' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyFinancialsDaysSalesOutstanding.new
  end
  ...
  describe 'test an instance of CompanyFinancialsDaysSalesOutstanding' do
    it 'should create an instance of CompanyFinancialsDaysSalesOutstanding' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyFinancialsDaysSalesOutstanding)
    end
  end
