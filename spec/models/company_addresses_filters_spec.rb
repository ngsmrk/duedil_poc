...
# Unit tests for SwaggerClient::CompanyAddressesFilters
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyAddressesFilters' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyAddressesFilters.new
  end
  ...
  describe 'test an instance of CompanyAddressesFilters' do
    it 'should create an instance of CompanyAddressesFilters' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyAddressesFilters)
    end
  end
