...
# Unit tests for SwaggerClient::CallcreditIdentityCheckResponseBankruptcyOrInsolvency
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CallcreditIdentityCheckResponseBankruptcyOrInsolvency' do
  before do
    # run before each test
    @instance = SwaggerClient::CallcreditIdentityCheckResponseBankruptcyOrInsolvency.new
  end
  ...
  describe 'test an instance of CallcreditIdentityCheckResponseBankruptcyOrInsolvency' do
    it 'should create an instance of CallcreditIdentityCheckResponseBankruptcyOrInsolvency' do
      expect(@instance).to be_instance_of(SwaggerClient::CallcreditIdentityCheckResponseBankruptcyOrInsolvency)
    end
  end
  describe 'test attribute "bai_record_count"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "bai_level_of_confidence"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
