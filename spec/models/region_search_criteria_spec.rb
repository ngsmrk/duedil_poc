...
# Unit tests for SwaggerClient::RegionSearchCriteria
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RegionSearchCriteria' do
  before do
    # run before each test
    @instance = SwaggerClient::RegionSearchCriteria.new
  end
  ...
  describe 'test an instance of RegionSearchCriteria' do
    it 'should create an instance of RegionSearchCriteria' do
      expect(@instance).to be_instance_of(SwaggerClient::RegionSearchCriteria)
    end
  end
