...
# Unit tests for SwaggerClient::CompanyFinancialsGearingPercentageOnLiabilityBasis
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyFinancialsGearingPercentageOnLiabilityBasis' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyFinancialsGearingPercentageOnLiabilityBasis.new
  end
  ...
  describe 'test an instance of CompanyFinancialsGearingPercentageOnLiabilityBasis' do
    it 'should create an instance of CompanyFinancialsGearingPercentageOnLiabilityBasis' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyFinancialsGearingPercentageOnLiabilityBasis)
    end
  end
