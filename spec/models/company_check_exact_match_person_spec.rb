...
# Unit tests for SwaggerClient::CompanyCheckExactMatchPerson
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyCheckExactMatchPerson' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyCheckExactMatchPerson.new
  end
  ...
  describe 'test an instance of CompanyCheckExactMatchPerson' do
    it 'should create an instance of CompanyCheckExactMatchPerson' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyCheckExactMatchPerson)
    end
  end
