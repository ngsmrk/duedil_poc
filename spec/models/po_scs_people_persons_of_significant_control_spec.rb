...
# Unit tests for SwaggerClient::PoSCSPeoplePersonsOfSignificantControl
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PoSCSPeoplePersonsOfSignificantControl' do
  before do
    # run before each test
    @instance = SwaggerClient::PoSCSPeoplePersonsOfSignificantControl.new
  end
  ...
  describe 'test an instance of PoSCSPeoplePersonsOfSignificantControl' do
    it 'should create an instance of PoSCSPeoplePersonsOfSignificantControl' do
      expect(@instance).to be_instance_of(SwaggerClient::PoSCSPeoplePersonsOfSignificantControl)
    end
  end
