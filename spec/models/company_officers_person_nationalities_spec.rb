...
# Unit tests for SwaggerClient::CompanyOfficersPersonNationalities
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyOfficersPersonNationalities' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyOfficersPersonNationalities.new
  end
  ...
  describe 'test an instance of CompanyOfficersPersonNationalities' do
    it 'should create an instance of CompanyOfficersPersonNationalities' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyOfficersPersonNationalities)
    end
  end
