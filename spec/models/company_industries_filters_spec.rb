...
# Unit tests for SwaggerClient::CompanyIndustriesFilters
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyIndustriesFilters' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyIndustriesFilters.new
  end
  ...
  describe 'test an instance of CompanyIndustriesFilters' do
    it 'should create an instance of CompanyIndustriesFilters' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyIndustriesFilters)
    end
  end
  describe 'test attribute "types"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
       #validator = Petstore::EnumTest::EnumAttributeValidator.new('Array<String>', ["SIC2003", "SIC2007", "NACE", "NAF"])
