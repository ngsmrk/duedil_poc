...
# Unit tests for SwaggerClient::CompanyCheckPossibleMatchPerson
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyCheckPossibleMatchPerson' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyCheckPossibleMatchPerson.new
  end
  ...
  describe 'test an instance of CompanyCheckPossibleMatchPerson' do
    it 'should create an instance of CompanyCheckPossibleMatchPerson' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyCheckPossibleMatchPerson)
    end
  end
