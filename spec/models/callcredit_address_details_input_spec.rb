...
# Unit tests for SwaggerClient::CallcreditAddressDetailsInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CallcreditAddressDetailsInput' do
  before do
    # run before each test
    @instance = SwaggerClient::CallcreditAddressDetailsInput.new
  end
  ...
  describe 'test an instance of CallcreditAddressDetailsInput' do
    it 'should create an instance of CallcreditAddressDetailsInput' do
      expect(@instance).to be_instance_of(SwaggerClient::CallcreditAddressDetailsInput)
    end
  end
