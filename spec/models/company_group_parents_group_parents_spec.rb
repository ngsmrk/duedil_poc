...
# Unit tests for SwaggerClient::CompanyGroupParentsGroupParents
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyGroupParentsGroupParents' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyGroupParentsGroupParents.new
  end
  ...
  describe 'test an instance of CompanyGroupParentsGroupParents' do
    it 'should create an instance of CompanyGroupParentsGroupParents' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyGroupParentsGroupParents)
    end
  end
  ...
  describe 'test attribute "degree_of_separation"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "is_immediate_parent"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "is_ultimate_parent"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
