...
# Unit tests for SwaggerClient::CompanyShareholders
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyShareholders' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyShareholders.new
  end
  ...
  describe 'test an instance of CompanyShareholders' do
    it 'should create an instance of CompanyShareholders' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyShareholders)
    end
  end
