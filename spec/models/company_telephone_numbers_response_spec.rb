...
# Unit tests for SwaggerClient::CompanyTelephoneNumbersResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyTelephoneNumbersResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyTelephoneNumbersResponse.new
  end
  ...
  describe 'test an instance of CompanyTelephoneNumbersResponse' do
    it 'should create an instance of CompanyTelephoneNumbersResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyTelephoneNumbersResponse)
    end
  end
