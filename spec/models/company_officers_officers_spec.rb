...
# Unit tests for SwaggerClient::CompanyOfficersOfficers
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyOfficersOfficers' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyOfficersOfficers.new
  end
  ...
  describe 'test an instance of CompanyOfficersOfficers' do
    it 'should create an instance of CompanyOfficersOfficers' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyOfficersOfficers)
    end
  end
  ...
  describe 'test attribute "disqualifications"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
