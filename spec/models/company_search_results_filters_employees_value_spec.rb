...
# Unit tests for SwaggerClient::CompanySearchResultsFiltersEmployeesValue
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanySearchResultsFiltersEmployeesValue' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanySearchResultsFiltersEmployeesValue.new
  end
  ...
  describe 'test an instance of CompanySearchResultsFiltersEmployeesValue' do
    it 'should create an instance of CompanySearchResultsFiltersEmployeesValue' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanySearchResultsFiltersEmployeesValue)
    end
  end
