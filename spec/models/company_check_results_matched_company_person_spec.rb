...
# Unit tests for SwaggerClient::CompanyCheckResultsMatchedCompanyPerson
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyCheckResultsMatchedCompanyPerson' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyCheckResultsMatchedCompanyPerson.new
  end
  ...
  describe 'test an instance of CompanyCheckResultsMatchedCompanyPerson' do
    it 'should create an instance of CompanyCheckResultsMatchedCompanyPerson' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyCheckResultsMatchedCompanyPerson)
    end
  end
