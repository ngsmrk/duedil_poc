...
# Unit tests for SwaggerClient::CompanyBankAccountsBankAccounts
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyBankAccountsBankAccounts' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyBankAccountsBankAccounts.new
  end
  ...
  describe 'test an instance of CompanyBankAccountsBankAccounts' do
    it 'should create an instance of CompanyBankAccountsBankAccounts' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyBankAccountsBankAccounts)
    end
  end
