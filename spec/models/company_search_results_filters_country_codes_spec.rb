...
# Unit tests for SwaggerClient::CompanySearchResultsFiltersCountryCodes
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanySearchResultsFiltersCountryCodes' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanySearchResultsFiltersCountryCodes.new
  end
  ...
  describe 'test an instance of CompanySearchResultsFiltersCountryCodes' do
    it 'should create an instance of CompanySearchResultsFiltersCountryCodes' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanySearchResultsFiltersCountryCodes)
    end
  end
