...
# Unit tests for SwaggerClient::CompanyBankAccounts
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyBankAccounts' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyBankAccounts.new
  end
  ...
  describe 'test an instance of CompanyBankAccounts' do
    it 'should create an instance of CompanyBankAccounts' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyBankAccounts)
    end
  end
