...
# Unit tests for SwaggerClient::CallcreditAddressDetailsInputAddressDetails
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CallcreditAddressDetailsInputAddressDetails' do
  before do
    # run before each test
    @instance = SwaggerClient::CallcreditAddressDetailsInputAddressDetails.new
  end
  ...
  describe 'test an instance of CallcreditAddressDetailsInputAddressDetails' do
    it 'should create an instance of CallcreditAddressDetailsInputAddressDetails' do
      expect(@instance).to be_instance_of(SwaggerClient::CallcreditAddressDetailsInputAddressDetails)
    end
  end
  ...
  describe 'test attribute "abode_number"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
