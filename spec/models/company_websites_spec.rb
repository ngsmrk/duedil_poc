...
# Unit tests for SwaggerClient::CompanyWebsites
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyWebsites' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyWebsites.new
  end
  ...
  describe 'test an instance of CompanyWebsites' do
    it 'should create an instance of CompanyWebsites' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyWebsites)
    end
  end
