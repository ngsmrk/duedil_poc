...
# Unit tests for SwaggerClient::RelatedCompaniesMutualMajorShareholders
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RelatedCompaniesMutualMajorShareholders' do
  before do
    # run before each test
    @instance = SwaggerClient::RelatedCompaniesMutualMajorShareholders.new
  end
  ...
  describe 'test an instance of RelatedCompaniesMutualMajorShareholders' do
    it 'should create an instance of RelatedCompaniesMutualMajorShareholders' do
      expect(@instance).to be_instance_of(SwaggerClient::RelatedCompaniesMutualMajorShareholders)
    end
  end
