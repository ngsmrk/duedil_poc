...
# Unit tests for SwaggerClient::OfficerSearchResultsDisqualifications
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OfficerSearchResultsDisqualifications' do
  before do
    # run before each test
    @instance = SwaggerClient::OfficerSearchResultsDisqualifications.new
  end
  ...
  describe 'test an instance of OfficerSearchResultsDisqualifications' do
    it 'should create an instance of OfficerSearchResultsDisqualifications' do
      expect(@instance).to be_instance_of(SwaggerClient::OfficerSearchResultsDisqualifications)
    end
  end
