...
# Unit tests for SwaggerClient::CompanySearchResultsFiltersNetAssetsValue
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanySearchResultsFiltersNetAssetsValue' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanySearchResultsFiltersNetAssetsValue.new
  end
  ...
  describe 'test an instance of CompanySearchResultsFiltersNetAssetsValue' do
    it 'should create an instance of CompanySearchResultsFiltersNetAssetsValue' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanySearchResultsFiltersNetAssetsValue)
    end
  end
