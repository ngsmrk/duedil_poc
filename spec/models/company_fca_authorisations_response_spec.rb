...
# Unit tests for SwaggerClient::CompanyFCAAuthorisationsResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyFCAAuthorisationsResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyFCAAuthorisationsResponse.new
  end
  ...
  describe 'test an instance of CompanyFCAAuthorisationsResponse' do
    it 'should create an instance of CompanyFCAAuthorisationsResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyFCAAuthorisationsResponse)
    end
  end
  ...
  describe 'test attribute "fca_authorisations"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
