...
# Unit tests for SwaggerClient::PEPsAndSanctionsIndividualSearchResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PEPsAndSanctionsIndividualSearchResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::PEPsAndSanctionsIndividualSearchResponse.new
  end
  ...
  describe 'test an instance of PEPsAndSanctionsIndividualSearchResponse' do
    it 'should create an instance of PEPsAndSanctionsIndividualSearchResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::PEPsAndSanctionsIndividualSearchResponse)
    end
  end
