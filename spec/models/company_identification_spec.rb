...
# Unit tests for SwaggerClient::CompanyIdentification
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyIdentification' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyIdentification.new
  end
  ...
  describe 'test an instance of CompanyIdentification' do
    it 'should create an instance of CompanyIdentification' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyIdentification)
    end
  end
