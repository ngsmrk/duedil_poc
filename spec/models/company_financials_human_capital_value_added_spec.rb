...
# Unit tests for SwaggerClient::CompanyFinancialsHumanCapitalValueAdded
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyFinancialsHumanCapitalValueAdded' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyFinancialsHumanCapitalValueAdded.new
  end
  ...
  describe 'test an instance of CompanyFinancialsHumanCapitalValueAdded' do
    it 'should create an instance of CompanyFinancialsHumanCapitalValueAdded' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyFinancialsHumanCapitalValueAdded)
    end
  end
