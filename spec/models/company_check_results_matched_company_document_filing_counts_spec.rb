...
# Unit tests for SwaggerClient::CompanyCheckResultsMatchedCompanyDocumentFilingCounts
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyCheckResultsMatchedCompanyDocumentFilingCounts' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyCheckResultsMatchedCompanyDocumentFilingCounts.new
  end
  ...
  describe 'test an instance of CompanyCheckResultsMatchedCompanyDocumentFilingCounts' do
    it 'should create an instance of CompanyCheckResultsMatchedCompanyDocumentFilingCounts' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyCheckResultsMatchedCompanyDocumentFilingCounts)
    end
  end
