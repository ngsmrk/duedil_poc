...
# Unit tests for SwaggerClient::PEPsAndSanctionsAnyIndividualSearchCriteria
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PEPsAndSanctionsAnyIndividualSearchCriteria' do
  before do
    # run before each test
    @instance = SwaggerClient::PEPsAndSanctionsAnyIndividualSearchCriteria.new
  end
  ...
  describe 'test an instance of PEPsAndSanctionsAnyIndividualSearchCriteria' do
    it 'should create an instance of PEPsAndSanctionsAnyIndividualSearchCriteria' do
      expect(@instance).to be_instance_of(SwaggerClient::PEPsAndSanctionsAnyIndividualSearchCriteria)
    end
  end
