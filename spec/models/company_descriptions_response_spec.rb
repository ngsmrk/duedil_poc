...
# Unit tests for SwaggerClient::CompanyDescriptionsResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyDescriptionsResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyDescriptionsResponse.new
  end
  ...
  describe 'test an instance of CompanyDescriptionsResponse' do
    it 'should create an instance of CompanyDescriptionsResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyDescriptionsResponse)
    end
  end
