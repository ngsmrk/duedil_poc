...
# Unit tests for SwaggerClient::RegionSearchResultsRegions
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RegionSearchResultsRegions' do
  before do
    # run before each test
    @instance = SwaggerClient::RegionSearchResultsRegions.new
  end
  ...
  describe 'test an instance of RegionSearchResultsRegions' do
    it 'should create an instance of RegionSearchResultsRegions' do
      expect(@instance).to be_instance_of(SwaggerClient::RegionSearchResultsRegions)
    end
  end
