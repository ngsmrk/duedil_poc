...
# Unit tests for SwaggerClient::RangeFilter
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RangeFilter' do
  before do
    # run before each test
    @instance = SwaggerClient::RangeFilter.new
  end
  ...
  describe 'test an instance of RangeFilter' do
    it 'should create an instance of RangeFilter' do
      expect(@instance).to be_instance_of(SwaggerClient::RangeFilter)
    end
  end
