...
# Unit tests for SwaggerClient::KeywordSearchCriteriaCriteria
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'KeywordSearchCriteriaCriteria' do
  before do
    # run before each test
    @instance = SwaggerClient::KeywordSearchCriteriaCriteria.new
  end
  ...
  describe 'test an instance of KeywordSearchCriteriaCriteria' do
    it 'should create an instance of KeywordSearchCriteriaCriteria' do
      expect(@instance).to be_instance_of(SwaggerClient::KeywordSearchCriteriaCriteria)
    end
  end
