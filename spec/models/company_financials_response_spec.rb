...
# Unit tests for SwaggerClient::CompanyFinancialsResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyFinancialsResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyFinancialsResponse.new
  end
  ...
  describe 'test an instance of CompanyFinancialsResponse' do
    it 'should create an instance of CompanyFinancialsResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyFinancialsResponse)
    end
  end
