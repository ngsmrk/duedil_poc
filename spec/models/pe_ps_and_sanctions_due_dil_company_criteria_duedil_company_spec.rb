...
# Unit tests for SwaggerClient::PEPsAndSanctionsDueDilCompanyCriteriaDuedilCompany
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PEPsAndSanctionsDueDilCompanyCriteriaDuedilCompany' do
  before do
    # run before each test
    @instance = SwaggerClient::PEPsAndSanctionsDueDilCompanyCriteriaDuedilCompany.new
  end
  ...
  describe 'test an instance of PEPsAndSanctionsDueDilCompanyCriteriaDuedilCompany' do
    it 'should create an instance of PEPsAndSanctionsDueDilCompanyCriteriaDuedilCompany' do
      expect(@instance).to be_instance_of(SwaggerClient::PEPsAndSanctionsDueDilCompanyCriteriaDuedilCompany)
    end
  end
