...
# Unit tests for SwaggerClient::CompanyFinancialsDaysPayableOutstanding
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyFinancialsDaysPayableOutstanding' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyFinancialsDaysPayableOutstanding.new
  end
  ...
  describe 'test an instance of CompanyFinancialsDaysPayableOutstanding' do
    it 'should create an instance of CompanyFinancialsDaysPayableOutstanding' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyFinancialsDaysPayableOutstanding)
    end
  end
