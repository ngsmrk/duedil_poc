...
# Unit tests for SwaggerClient::IndustriesMultiValueFilter
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IndustriesMultiValueFilter' do
  before do
    # run before each test
    @instance = SwaggerClient::IndustriesMultiValueFilter.new
  end
  ...
  describe 'test an instance of IndustriesMultiValueFilter' do
    it 'should create an instance of IndustriesMultiValueFilter' do
      expect(@instance).to be_instance_of(SwaggerClient::IndustriesMultiValueFilter)
    end
  end
