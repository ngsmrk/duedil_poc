...
# Unit tests for SwaggerClient::CompanyCheckResultsMatchedCompanyPepsSanctionsCheckWarning
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyCheckResultsMatchedCompanyPepsSanctionsCheckWarning' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyCheckResultsMatchedCompanyPepsSanctionsCheckWarning.new
  end
  ...
  describe 'test an instance of CompanyCheckResultsMatchedCompanyPepsSanctionsCheckWarning' do
    it 'should create an instance of CompanyCheckResultsMatchedCompanyPepsSanctionsCheckWarning' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyCheckResultsMatchedCompanyPepsSanctionsCheckWarning)
    end
  end
  describe 'test attribute "threshold_match_score"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "matches_triggering_warning"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
