...
# Unit tests for SwaggerClient::CompanyFinancialsGearingPercentageOnGrossDebtBasis
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyFinancialsGearingPercentageOnGrossDebtBasis' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyFinancialsGearingPercentageOnGrossDebtBasis.new
  end
  ...
  describe 'test an instance of CompanyFinancialsGearingPercentageOnGrossDebtBasis' do
    it 'should create an instance of CompanyFinancialsGearingPercentageOnGrossDebtBasis' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyFinancialsGearingPercentageOnGrossDebtBasis)
    end
  end
