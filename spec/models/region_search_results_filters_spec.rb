...
# Unit tests for SwaggerClient::RegionSearchResultsFilters
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RegionSearchResultsFilters' do
  before do
    # run before each test
    @instance = SwaggerClient::RegionSearchResultsFilters.new
  end
  ...
  describe 'test an instance of RegionSearchResultsFilters' do
    it 'should create an instance of RegionSearchResultsFilters' do
      expect(@instance).to be_instance_of(SwaggerClient::RegionSearchResultsFilters)
    end
  end
