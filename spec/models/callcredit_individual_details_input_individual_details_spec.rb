...
# Unit tests for SwaggerClient::CallcreditIndividualDetailsInputIndividualDetails
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CallcreditIndividualDetailsInputIndividualDetails' do
  before do
    # run before each test
    @instance = SwaggerClient::CallcreditIndividualDetailsInputIndividualDetails.new
  end
  ...
  describe 'test an instance of CallcreditIndividualDetailsInputIndividualDetails' do
    it 'should create an instance of CallcreditIndividualDetailsInputIndividualDetails' do
      expect(@instance).to be_instance_of(SwaggerClient::CallcreditIndividualDetailsInputIndividualDetails)
    end
  end
