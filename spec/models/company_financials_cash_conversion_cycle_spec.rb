...
# Unit tests for SwaggerClient::CompanyFinancialsCashConversionCycle
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyFinancialsCashConversionCycle' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyFinancialsCashConversionCycle.new
  end
  ...
  describe 'test an instance of CompanyFinancialsCashConversionCycle' do
    it 'should create an instance of CompanyFinancialsCashConversionCycle' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyFinancialsCashConversionCycle)
    end
  end
