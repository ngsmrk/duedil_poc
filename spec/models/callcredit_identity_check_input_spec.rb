...
# Unit tests for SwaggerClient::CallcreditIdentityCheckInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CallcreditIdentityCheckInput' do
  before do
    # run before each test
    @instance = SwaggerClient::CallcreditIdentityCheckInput.new
  end
  ...
  describe 'test an instance of CallcreditIdentityCheckInput' do
    it 'should create an instance of CallcreditIdentityCheckInput' do
      expect(@instance).to be_instance_of(SwaggerClient::CallcreditIdentityCheckInput)
    end
  end
  ...
  describe 'test attribute "individual_details"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
