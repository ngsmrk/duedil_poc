...
# Unit tests for SwaggerClient::SharedPersonMatchDateOfBirth
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SharedPersonMatchDateOfBirth' do
  before do
    # run before each test
    @instance = SwaggerClient::SharedPersonMatchDateOfBirth.new
  end
  ...
  describe 'test an instance of SharedPersonMatchDateOfBirth' do
    it 'should create an instance of SharedPersonMatchDateOfBirth' do
      expect(@instance).to be_instance_of(SwaggerClient::SharedPersonMatchDateOfBirth)
    end
  end
