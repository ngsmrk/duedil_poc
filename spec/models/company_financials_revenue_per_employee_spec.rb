...
# Unit tests for SwaggerClient::CompanyFinancialsRevenuePerEmployee
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyFinancialsRevenuePerEmployee' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyFinancialsRevenuePerEmployee.new
  end
  ...
  describe 'test an instance of CompanyFinancialsRevenuePerEmployee' do
    it 'should create an instance of CompanyFinancialsRevenuePerEmployee' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyFinancialsRevenuePerEmployee)
    end
  end
