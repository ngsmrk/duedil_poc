...
# Unit tests for SwaggerClient::CompanyCheckResultsMatchedCompanyFinancialSummary
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyCheckResultsMatchedCompanyFinancialSummary' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyCheckResultsMatchedCompanyFinancialSummary.new
  end
  ...
  describe 'test an instance of CompanyCheckResultsMatchedCompanyFinancialSummary' do
    it 'should create an instance of CompanyCheckResultsMatchedCompanyFinancialSummary' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyCheckResultsMatchedCompanyFinancialSummary)
    end
  end
