...
# Unit tests for SwaggerClient::CompanyCheckCriteria
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyCheckCriteria' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyCheckCriteria.new
  end
  ...
  describe 'test an instance of CompanyCheckCriteria' do
    it 'should create an instance of CompanyCheckCriteria' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyCheckCriteria)
    end
  end
