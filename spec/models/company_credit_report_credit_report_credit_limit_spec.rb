...
# Unit tests for SwaggerClient::CompanyCreditReportCreditReportCreditLimit
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyCreditReportCreditReportCreditLimit' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyCreditReportCreditReportCreditLimit.new
  end
  ...
  describe 'test an instance of CompanyCreditReportCreditReportCreditLimit' do
    it 'should create an instance of CompanyCreditReportCreditReportCreditLimit' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyCreditReportCreditReportCreditLimit)
    end
  end
  ...
  describe 'test attribute "since_date"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
