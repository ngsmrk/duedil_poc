...
# Unit tests for SwaggerClient::CompanyFinancialsDaysInventoryOutstanding
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyFinancialsDaysInventoryOutstanding' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyFinancialsDaysInventoryOutstanding.new
  end
  ...
  describe 'test an instance of CompanyFinancialsDaysInventoryOutstanding' do
    it 'should create an instance of CompanyFinancialsDaysInventoryOutstanding' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyFinancialsDaysInventoryOutstanding)
    end
  end
