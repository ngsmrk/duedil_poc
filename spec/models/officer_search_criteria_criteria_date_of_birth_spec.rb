...
# Unit tests for SwaggerClient::OfficerSearchCriteriaCriteriaDateOfBirth
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OfficerSearchCriteriaCriteriaDateOfBirth' do
  before do
    # run before each test
    @instance = SwaggerClient::OfficerSearchCriteriaCriteriaDateOfBirth.new
  end
  ...
  describe 'test an instance of OfficerSearchCriteriaCriteriaDateOfBirth' do
    it 'should create an instance of OfficerSearchCriteriaCriteriaDateOfBirth' do
      expect(@instance).to be_instance_of(SwaggerClient::OfficerSearchCriteriaCriteriaDateOfBirth)
    end
  end
