...
# Unit tests for SwaggerClient::OfficerIdentification
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OfficerIdentification' do
  before do
    # run before each test
    @instance = SwaggerClient::OfficerIdentification.new
  end
  ...
  describe 'test an instance of OfficerIdentification' do
    it 'should create an instance of OfficerIdentification' do
      expect(@instance).to be_instance_of(SwaggerClient::OfficerIdentification)
    end
  end
