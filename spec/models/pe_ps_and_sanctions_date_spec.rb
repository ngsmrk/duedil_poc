...
# Unit tests for SwaggerClient::PEPsAndSanctionsDate
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PEPsAndSanctionsDate' do
  before do
    # run before each test
    @instance = SwaggerClient::PEPsAndSanctionsDate.new
  end
  ...
  describe 'test an instance of PEPsAndSanctionsDate' do
    it 'should create an instance of PEPsAndSanctionsDate' do
      expect(@instance).to be_instance_of(SwaggerClient::PEPsAndSanctionsDate)
    end
  end
