...
# Unit tests for SwaggerClient::PEPsAndSanctionsAnyIndividualCriteria
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PEPsAndSanctionsAnyIndividualCriteria' do
  before do
    # run before each test
    @instance = SwaggerClient::PEPsAndSanctionsAnyIndividualCriteria.new
  end
  ...
  describe 'test an instance of PEPsAndSanctionsAnyIndividualCriteria' do
    it 'should create an instance of PEPsAndSanctionsAnyIndividualCriteria' do
      expect(@instance).to be_instance_of(SwaggerClient::PEPsAndSanctionsAnyIndividualCriteria)
    end
  end
end
