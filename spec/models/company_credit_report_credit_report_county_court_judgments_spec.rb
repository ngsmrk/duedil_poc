...
# Unit tests for SwaggerClient::CompanyCreditReportCreditReportCountyCourtJudgments
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyCreditReportCreditReportCountyCourtJudgments' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyCreditReportCreditReportCountyCourtJudgments.new
  end
  ...
  describe 'test an instance of CompanyCreditReportCreditReportCountyCourtJudgments' do
    it 'should create an instance of CompanyCreditReportCreditReportCountyCourtJudgments' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyCreditReportCreditReportCountyCourtJudgments)
    end
  end
