...
# Unit tests for SwaggerClient::RegionsMultiValueFilterExcept
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RegionsMultiValueFilterExcept' do
  before do
    # run before each test
    @instance = SwaggerClient::RegionsMultiValueFilterExcept.new
  end
  ...
  describe 'test an instance of RegionsMultiValueFilterExcept' do
    it 'should create an instance of RegionsMultiValueFilterExcept' do
      expect(@instance).to be_instance_of(SwaggerClient::RegionsMultiValueFilterExcept)
    end
  end
