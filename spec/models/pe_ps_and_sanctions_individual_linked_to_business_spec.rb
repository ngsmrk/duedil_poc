...
# Unit tests for SwaggerClient::PEPsAndSanctionsIndividualLinkedToBusiness
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PEPsAndSanctionsIndividualLinkedToBusiness' do
  before do
    # run before each test
    @instance = SwaggerClient::PEPsAndSanctionsIndividualLinkedToBusiness.new
  end
  ...
  describe 'test an instance of PEPsAndSanctionsIndividualLinkedToBusiness' do
    it 'should create an instance of PEPsAndSanctionsIndividualLinkedToBusiness' do
      expect(@instance).to be_instance_of(SwaggerClient::PEPsAndSanctionsIndividualLinkedToBusiness)
    end
  end
