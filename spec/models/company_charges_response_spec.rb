...
# Unit tests for SwaggerClient::CompanyChargesResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyChargesResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyChargesResponse.new
  end
  ...
  describe 'test an instance of CompanyChargesResponse' do
    it 'should create an instance of CompanyChargesResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyChargesResponse)
    end
  end
