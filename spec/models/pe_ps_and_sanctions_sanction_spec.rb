...
# Unit tests for SwaggerClient::PEPsAndSanctionsSanction
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PEPsAndSanctionsSanction' do
  before do
    # run before each test
    @instance = SwaggerClient::PEPsAndSanctionsSanction.new
  end
  ...
  describe 'test an instance of PEPsAndSanctionsSanction' do
    it 'should create an instance of PEPsAndSanctionsSanction' do
      expect(@instance).to be_instance_of(SwaggerClient::PEPsAndSanctionsSanction)
    end
  end
