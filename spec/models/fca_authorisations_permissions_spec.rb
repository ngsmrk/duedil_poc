...
# Unit tests for SwaggerClient::FCAAuthorisationsPermissions
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FCAAuthorisationsPermissions' do
  before do
    # run before each test
    @instance = SwaggerClient::FCAAuthorisationsPermissions.new
  end
  ...
  describe 'test an instance of FCAAuthorisationsPermissions' do
    it 'should create an instance of FCAAuthorisationsPermissions' do
      expect(@instance).to be_instance_of(SwaggerClient::FCAAuthorisationsPermissions)
    end
  end
  describe 'test attribute "activity_category"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "activity_description"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
