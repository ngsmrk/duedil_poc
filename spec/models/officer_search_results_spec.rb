...
# Unit tests for SwaggerClient::OfficerSearchResults
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OfficerSearchResults' do
  before do
    # run before each test
    @instance = SwaggerClient::OfficerSearchResults.new
  end
  ...
  describe 'test an instance of OfficerSearchResults' do
    it 'should create an instance of OfficerSearchResults' do
      expect(@instance).to be_instance_of(SwaggerClient::OfficerSearchResults)
    end
  end
