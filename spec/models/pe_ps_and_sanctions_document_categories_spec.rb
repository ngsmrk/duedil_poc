...
# Unit tests for SwaggerClient::PEPsAndSanctionsDocumentCategories
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PEPsAndSanctionsDocumentCategories' do
  before do
    # run before each test
    @instance = SwaggerClient::PEPsAndSanctionsDocumentCategories.new
  end
  ...
  describe 'test an instance of PEPsAndSanctionsDocumentCategories' do
    it 'should create an instance of PEPsAndSanctionsDocumentCategories' do
      expect(@instance).to be_instance_of(SwaggerClient::PEPsAndSanctionsDocumentCategories)
    end
  end
  describe 'test attribute "name"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
       #validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["Adverse Media", "Corporate/Business", "Disqualified Director", "Financial Regulator", "ID/V", "Insolvent", "Law Enforcement", "PEP", "Sanction"])
