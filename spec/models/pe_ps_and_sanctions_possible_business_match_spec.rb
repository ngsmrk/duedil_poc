...
# Unit tests for SwaggerClient::PEPsAndSanctionsPossibleBusinessMatch
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PEPsAndSanctionsPossibleBusinessMatch' do
  before do
    # run before each test
    @instance = SwaggerClient::PEPsAndSanctionsPossibleBusinessMatch.new
  end
  ...
  describe 'test an instance of PEPsAndSanctionsPossibleBusinessMatch' do
    it 'should create an instance of PEPsAndSanctionsPossibleBusinessMatch' do
      expect(@instance).to be_instance_of(SwaggerClient::PEPsAndSanctionsPossibleBusinessMatch)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
       #validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["business"])
