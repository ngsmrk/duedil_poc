...
# Unit tests for SwaggerClient::CompanyFinancialsCfoToSalesRatio
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyFinancialsCfoToSalesRatio' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyFinancialsCfoToSalesRatio.new
  end
  ...
  describe 'test an instance of CompanyFinancialsCfoToSalesRatio' do
    it 'should create an instance of CompanyFinancialsCfoToSalesRatio' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyFinancialsCfoToSalesRatio)
    end
  end
