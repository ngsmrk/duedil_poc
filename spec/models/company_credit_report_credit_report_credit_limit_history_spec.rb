...
# Unit tests for SwaggerClient::CompanyCreditReportCreditReportCreditLimitHistory
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyCreditReportCreditReportCreditLimitHistory' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyCreditReportCreditReportCreditLimitHistory.new
  end
  ...
  describe 'test an instance of CompanyCreditReportCreditReportCreditLimitHistory' do
    it 'should create an instance of CompanyCreditReportCreditReportCreditLimitHistory' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyCreditReportCreditReportCreditLimitHistory)
    end
  end
