...
# Unit tests for SwaggerClient::CompanyGroupSubsidiaries
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyGroupSubsidiaries' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyGroupSubsidiaries.new
  end
  ...
  describe 'test an instance of CompanyGroupSubsidiaries' do
    it 'should create an instance of CompanyGroupSubsidiaries' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyGroupSubsidiaries)
    end
  end
