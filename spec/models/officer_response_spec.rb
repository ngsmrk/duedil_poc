...
# Unit tests for SwaggerClient::OfficerResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OfficerResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::OfficerResponse.new
  end
  ...
  describe 'test an instance of OfficerResponse' do
    it 'should create an instance of OfficerResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::OfficerResponse)
    end
  end
