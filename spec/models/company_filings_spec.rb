...
# Unit tests for SwaggerClient::CompanyFilings
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyFilings' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyFilings.new
  end
  ...
  describe 'test an instance of CompanyFilings' do
    it 'should create an instance of CompanyFilings' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyFilings)
    end
  end
