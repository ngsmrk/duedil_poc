...
# Unit tests for SwaggerClient::RegionsMultiValueFilter
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RegionsMultiValueFilter' do
  before do
    # run before each test
    @instance = SwaggerClient::RegionsMultiValueFilter.new
  end
  ...
  describe 'test an instance of RegionsMultiValueFilter' do
    it 'should create an instance of RegionsMultiValueFilter' do
      expect(@instance).to be_instance_of(SwaggerClient::RegionsMultiValueFilter)
    end
  end
