...
# Unit tests for SwaggerClient::CompanySearchResultsFiltersTotalAssetsValue
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanySearchResultsFiltersTotalAssetsValue' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanySearchResultsFiltersTotalAssetsValue.new
  end
  ...
  describe 'test an instance of CompanySearchResultsFiltersTotalAssetsValue' do
    it 'should create an instance of CompanySearchResultsFiltersTotalAssetsValue' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanySearchResultsFiltersTotalAssetsValue)
    end
  end
