...
# Unit tests for SwaggerClient::CompanyCheckResultsMatchedCompanyCompany
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyCheckResultsMatchedCompanyCompany' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyCheckResultsMatchedCompanyCompany.new
  end
  ...
  describe 'test an instance of CompanyCheckResultsMatchedCompanyCompany' do
    it 'should create an instance of CompanyCheckResultsMatchedCompanyCompany' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyCheckResultsMatchedCompanyCompany)
    end
  end
  ...
  describe 'test attribute "office_address"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
