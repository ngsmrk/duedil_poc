...
# Unit tests for SwaggerClient::PEPsAndSanctionsPossibleIndividualMatch
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PEPsAndSanctionsPossibleIndividualMatch' do
  before do
    # run before each test
    @instance = SwaggerClient::PEPsAndSanctionsPossibleIndividualMatch.new
  end
  ...
  describe 'test an instance of PEPsAndSanctionsPossibleIndividualMatch' do
    it 'should create an instance of PEPsAndSanctionsPossibleIndividualMatch' do
      expect(@instance).to be_instance_of(SwaggerClient::PEPsAndSanctionsPossibleIndividualMatch)
    end
  end
