...
# Unit tests for SwaggerClient::FinancialValueSimple
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FinancialValueSimple' do
  before do
    # run before each test
    @instance = SwaggerClient::FinancialValueSimple.new
  end
  ...
  describe 'test an instance of FinancialValueSimple' do
    it 'should create an instance of FinancialValueSimple' do
      expect(@instance).to be_instance_of(SwaggerClient::FinancialValueSimple)
    end
  end
