...
# Unit tests for SwaggerClient::CompanyRelatedNamesRelatedNames
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyRelatedNamesRelatedNames' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyRelatedNamesRelatedNames.new
  end
  ...
  describe 'test an instance of CompanyRelatedNamesRelatedNames' do
    it 'should create an instance of CompanyRelatedNamesRelatedNames' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyRelatedNamesRelatedNames)
    end
  end
