...
# Unit tests for SwaggerClient::CompanySearchResultsFiltersKeywordsExcept
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanySearchResultsFiltersKeywordsExcept' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanySearchResultsFiltersKeywordsExcept.new
  end
  ...
  describe 'test an instance of CompanySearchResultsFiltersKeywordsExcept' do
    it 'should create an instance of CompanySearchResultsFiltersKeywordsExcept' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanySearchResultsFiltersKeywordsExcept)
    end
  end
