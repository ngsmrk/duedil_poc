...
# Unit tests for SwaggerClient::CompanyOfficers
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyOfficers' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyOfficers.new
  end
  ...
  describe 'test an instance of CompanyOfficers' do
    it 'should create an instance of CompanyOfficers' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyOfficers)
    end
  end
