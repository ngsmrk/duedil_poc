...
# Unit tests for SwaggerClient::CompanyRelatedNamesResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyRelatedNamesResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyRelatedNamesResponse.new
  end
  ...
  describe 'test an instance of CompanyRelatedNamesResponse' do
    it 'should create an instance of CompanyRelatedNamesResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyRelatedNamesResponse)
    end
  end
