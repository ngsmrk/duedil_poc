...
# Unit tests for SwaggerClient::PoSCStatements
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PoSCStatements' do
  before do
    # run before each test
    @instance = SwaggerClient::PoSCStatements.new
  end
  ...
  describe 'test an instance of PoSCStatements' do
    it 'should create an instance of PoSCStatements' do
      expect(@instance).to be_instance_of(SwaggerClient::PoSCStatements)
    end
  end
