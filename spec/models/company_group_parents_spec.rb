...
# Unit tests for SwaggerClient::CompanyGroupParents
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyGroupParents' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyGroupParents.new
  end
  ...
  describe 'test an instance of CompanyGroupParents' do
    it 'should create an instance of CompanyGroupParents' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyGroupParents)
    end
  end
