...
# Unit tests for SwaggerClient::CompanyCheckResultsMatchedCompanyShareholdersGreaterOrEqualTenPercent
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyCheckResultsMatchedCompanyShareholdersGreaterOrEqualTenPercent' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyCheckResultsMatchedCompanyShareholdersGreaterOrEqualTenPercent.new
  end
  ...
  describe 'test an instance of CompanyCheckResultsMatchedCompanyShareholdersGreaterOrEqualTenPercent' do
    it 'should create an instance of CompanyCheckResultsMatchedCompanyShareholdersGreaterOrEqualTenPercent' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyCheckResultsMatchedCompanyShareholdersGreaterOrEqualTenPercent)
    end
  end
  ...
  describe 'test attribute "total_shareholding"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "total_shareholding_percentage"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "shareholdings"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "possible_matches"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "not_matched"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
