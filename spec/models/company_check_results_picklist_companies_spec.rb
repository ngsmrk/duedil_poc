...
# Unit tests for SwaggerClient::CompanyCheckResultsPicklistCompanies
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyCheckResultsPicklistCompanies' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyCheckResultsPicklistCompanies.new
  end
  ...
  describe 'test an instance of CompanyCheckResultsPicklistCompanies' do
    it 'should create an instance of CompanyCheckResultsPicklistCompanies' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyCheckResultsPicklistCompanies)
    end
  end
