...
# Unit tests for SwaggerClient::KeywordSearchResultsFilters
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'KeywordSearchResultsFilters' do
  before do
    # run before each test
    @instance = SwaggerClient::KeywordSearchResultsFilters.new
  end
  ...
  describe 'test an instance of KeywordSearchResultsFilters' do
    it 'should create an instance of KeywordSearchResultsFilters' do
      expect(@instance).to be_instance_of(SwaggerClient::KeywordSearchResultsFilters)
    end
  end
