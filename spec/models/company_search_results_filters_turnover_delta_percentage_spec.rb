...
# Unit tests for SwaggerClient::CompanySearchResultsFiltersTurnoverDeltaPercentage
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanySearchResultsFiltersTurnoverDeltaPercentage' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanySearchResultsFiltersTurnoverDeltaPercentage.new
  end
  ...
  describe 'test an instance of CompanySearchResultsFiltersTurnoverDeltaPercentage' do
    it 'should create an instance of CompanySearchResultsFiltersTurnoverDeltaPercentage' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanySearchResultsFiltersTurnoverDeltaPercentage)
    end
  end
