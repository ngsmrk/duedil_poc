...
# Unit tests for SwaggerClient::CompanyCheckExactMatch
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyCheckExactMatch' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyCheckExactMatch.new
  end
  ...
  describe 'test an instance of CompanyCheckExactMatch' do
    it 'should create an instance of CompanyCheckExactMatch' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyCheckExactMatch)
    end
  end
