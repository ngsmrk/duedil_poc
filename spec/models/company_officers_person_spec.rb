...
# Unit tests for SwaggerClient::CompanyOfficersPerson
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyOfficersPerson' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyOfficersPerson.new
  end
  ...
  describe 'test an instance of CompanyOfficersPerson' do
    it 'should create an instance of CompanyOfficersPerson' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyOfficersPerson)
    end
  end
