...
# Unit tests for SwaggerClient::OfficerSearchResultsFiltersHonorific
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OfficerSearchResultsFiltersHonorific' do
  before do
    # run before each test
    @instance = SwaggerClient::OfficerSearchResultsFiltersHonorific.new
  end
  ...
  describe 'test an instance of OfficerSearchResultsFiltersHonorific' do
    it 'should create an instance of OfficerSearchResultsFiltersHonorific' do
      expect(@instance).to be_instance_of(SwaggerClient::OfficerSearchResultsFiltersHonorific)
    end
  end
