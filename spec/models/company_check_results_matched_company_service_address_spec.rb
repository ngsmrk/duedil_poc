...
# Unit tests for SwaggerClient::CompanyCheckResultsMatchedCompanyServiceAddress
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyCheckResultsMatchedCompanyServiceAddress' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyCheckResultsMatchedCompanyServiceAddress.new
  end
  ...
  describe 'test an instance of CompanyCheckResultsMatchedCompanyServiceAddress' do
    it 'should create an instance of CompanyCheckResultsMatchedCompanyServiceAddress' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyCheckResultsMatchedCompanyServiceAddress)
    end
  end
  ...
  describe 'test attribute "structured_address"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
