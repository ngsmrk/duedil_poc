...
# Unit tests for SwaggerClient::CompanyCheckResultsMatchedCompanyPscStatements
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyCheckResultsMatchedCompanyPscStatements' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyCheckResultsMatchedCompanyPscStatements.new
  end
  ...
  describe 'test an instance of CompanyCheckResultsMatchedCompanyPscStatements' do
    it 'should create an instance of CompanyCheckResultsMatchedCompanyPscStatements' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyCheckResultsMatchedCompanyPscStatements)
    end
  end
  describe 'test attribute "filed_at"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "ceased_at"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
