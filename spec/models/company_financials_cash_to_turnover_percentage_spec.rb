...
# Unit tests for SwaggerClient::CompanyFinancialsCashToTurnoverPercentage
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyFinancialsCashToTurnoverPercentage' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyFinancialsCashToTurnoverPercentage.new
  end
  ...
  describe 'test an instance of CompanyFinancialsCashToTurnoverPercentage' do
    it 'should create an instance of CompanyFinancialsCashToTurnoverPercentage' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyFinancialsCashToTurnoverPercentage)
    end
  end
