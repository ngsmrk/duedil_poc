...
# Unit tests for SwaggerClient::OfficerPerson
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OfficerPerson' do
  before do
    # run before each test
    @instance = SwaggerClient::OfficerPerson.new
  end
  ...
  describe 'test an instance of OfficerPerson' do
    it 'should create an instance of OfficerPerson' do
      expect(@instance).to be_instance_of(SwaggerClient::OfficerPerson)
    end
  end
