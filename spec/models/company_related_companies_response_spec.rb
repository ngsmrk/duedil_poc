...
# Unit tests for SwaggerClient::CompanyRelatedCompaniesResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyRelatedCompaniesResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyRelatedCompaniesResponse.new
  end
  ...
  describe 'test an instance of CompanyRelatedCompaniesResponse' do
    it 'should create an instance of CompanyRelatedCompaniesResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyRelatedCompaniesResponse)
    end
  end
  ...
  describe 'test attribute "related_companies"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
