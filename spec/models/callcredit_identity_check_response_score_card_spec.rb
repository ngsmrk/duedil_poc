...
# Unit tests for SwaggerClient::CallcreditIdentityCheckResponseScoreCard
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CallcreditIdentityCheckResponseScoreCard' do
  before do
    # run before each test
    @instance = SwaggerClient::CallcreditIdentityCheckResponseScoreCard.new
  end
  ...
  describe 'test an instance of CallcreditIdentityCheckResponseScoreCard' do
    it 'should create an instance of CallcreditIdentityCheckResponseScoreCard' do
      expect(@instance).to be_instance_of(SwaggerClient::CallcreditIdentityCheckResponseScoreCard)
    end
  end
