...
# Unit tests for SwaggerClient::CompanyFinancialsNetMarginPercentage
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyFinancialsNetMarginPercentage' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyFinancialsNetMarginPercentage.new
  end
  ...
  describe 'test an instance of CompanyFinancialsNetMarginPercentage' do
    it 'should create an instance of CompanyFinancialsNetMarginPercentage' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyFinancialsNetMarginPercentage)
    end
  end
