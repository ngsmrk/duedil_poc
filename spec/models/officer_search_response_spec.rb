...
# Unit tests for SwaggerClient::OfficerSearchResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OfficerSearchResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::OfficerSearchResponse.new
  end
  ...
  describe 'test an instance of OfficerSearchResponse' do
    it 'should create an instance of OfficerSearchResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::OfficerSearchResponse)
    end
  end
