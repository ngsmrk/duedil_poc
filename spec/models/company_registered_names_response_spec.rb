...
# Unit tests for SwaggerClient::CompanyRegisteredNamesResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyRegisteredNamesResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyRegisteredNamesResponse.new
  end
  ...
  describe 'test an instance of CompanyRegisteredNamesResponse' do
    it 'should create an instance of CompanyRegisteredNamesResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyRegisteredNamesResponse)
    end
  end
  ...
  describe 'test attribute "registered_names"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
