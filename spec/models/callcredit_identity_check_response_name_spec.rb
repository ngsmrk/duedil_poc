...
# Unit tests for SwaggerClient::CallcreditIdentityCheckResponseName
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CallcreditIdentityCheckResponseName' do
  before do
    # run before each test
    @instance = SwaggerClient::CallcreditIdentityCheckResponseName.new
  end
  ...
  describe 'test an instance of CallcreditIdentityCheckResponseName' do
    it 'should create an instance of CallcreditIdentityCheckResponseName' do
      expect(@instance).to be_instance_of(SwaggerClient::CallcreditIdentityCheckResponseName)
    end
  end
  describe 'test attribute "name_pick_list_found"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "name_matched"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
