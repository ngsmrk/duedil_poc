...
# Unit tests for SwaggerClient::CompanyTelephoneNumbersAddress
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyTelephoneNumbersAddress' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyTelephoneNumbersAddress.new
  end
  ...
  describe 'test an instance of CompanyTelephoneNumbersAddress' do
    it 'should create an instance of CompanyTelephoneNumbersAddress' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyTelephoneNumbersAddress)
    end
  end
