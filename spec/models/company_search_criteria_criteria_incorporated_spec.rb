...
# Unit tests for SwaggerClient::CompanySearchCriteriaCriteriaIncorporated
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanySearchCriteriaCriteriaIncorporated' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanySearchCriteriaCriteriaIncorporated.new
  end
  ...
  describe 'test an instance of CompanySearchCriteriaCriteriaIncorporated' do
    it 'should create an instance of CompanySearchCriteriaCriteriaIncorporated' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanySearchCriteriaCriteriaIncorporated)
    end
  end
