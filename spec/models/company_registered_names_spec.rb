...
# Unit tests for SwaggerClient::CompanyRegisteredNames
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyRegisteredNames' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyRegisteredNames.new
  end
  ...
  describe 'test an instance of CompanyRegisteredNames' do
    it 'should create an instance of CompanyRegisteredNames' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyRegisteredNames)
    end
  end
