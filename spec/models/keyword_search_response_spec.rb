...
# Unit tests for SwaggerClient::KeywordSearchResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'KeywordSearchResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::KeywordSearchResponse.new
  end
  ...
  describe 'test an instance of KeywordSearchResponse' do
    it 'should create an instance of KeywordSearchResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::KeywordSearchResponse)
    end
  end
