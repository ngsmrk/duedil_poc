...
# Unit tests for SwaggerClient::CompanyCheckResultsMatchedCompanyOfficers
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyCheckResultsMatchedCompanyOfficers' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyCheckResultsMatchedCompanyOfficers.new
  end
  ...
  describe 'test an instance of CompanyCheckResultsMatchedCompanyOfficers' do
    it 'should create an instance of CompanyCheckResultsMatchedCompanyOfficers' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyCheckResultsMatchedCompanyOfficers)
    end
  end
  describe 'test attribute "officer_id"' do
    it 'should work' do
  ...
  describe 'test attribute "type"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
       #validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["person", "company"])
