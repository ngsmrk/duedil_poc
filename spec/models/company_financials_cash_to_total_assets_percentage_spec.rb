...
# Unit tests for SwaggerClient::CompanyFinancialsCashToTotalAssetsPercentage
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyFinancialsCashToTotalAssetsPercentage' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyFinancialsCashToTotalAssetsPercentage.new
  end
  ...
  describe 'test an instance of CompanyFinancialsCashToTotalAssetsPercentage' do
    it 'should create an instance of CompanyFinancialsCashToTotalAssetsPercentage' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyFinancialsCashToTotalAssetsPercentage)
    end
  end
