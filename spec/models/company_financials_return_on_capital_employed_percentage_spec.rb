...
# Unit tests for SwaggerClient::CompanyFinancialsReturnOnCapitalEmployedPercentage
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyFinancialsReturnOnCapitalEmployedPercentage' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyFinancialsReturnOnCapitalEmployedPercentage.new
  end
  ...
  describe 'test an instance of CompanyFinancialsReturnOnCapitalEmployedPercentage' do
    it 'should create an instance of CompanyFinancialsReturnOnCapitalEmployedPercentage' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyFinancialsReturnOnCapitalEmployedPercentage)
    end
  end
