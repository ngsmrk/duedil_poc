...
# Unit tests for SwaggerClient::IndustriesMultiValueFilterValues
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IndustriesMultiValueFilterValues' do
  before do
    # run before each test
    @instance = SwaggerClient::IndustriesMultiValueFilterValues.new
  end
  ...
  describe 'test an instance of IndustriesMultiValueFilterValues' do
    it 'should create an instance of IndustriesMultiValueFilterValues' do
      expect(@instance).to be_instance_of(SwaggerClient::IndustriesMultiValueFilterValues)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
       #validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["SIC2003", "SIC2007", "NACE", "NAF"])
  ...
  describe 'test attribute "implied"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
