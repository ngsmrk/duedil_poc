...
# Unit tests for SwaggerClient::PEPsAndSanctionsRelatedName
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PEPsAndSanctionsRelatedName' do
  before do
    # run before each test
    @instance = SwaggerClient::PEPsAndSanctionsRelatedName.new
  end
  ...
  describe 'test an instance of PEPsAndSanctionsRelatedName' do
    it 'should create an instance of PEPsAndSanctionsRelatedName' do
      expect(@instance).to be_instance_of(SwaggerClient::PEPsAndSanctionsRelatedName)
    end
  end
