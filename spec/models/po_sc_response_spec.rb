...
# Unit tests for SwaggerClient::PoSCResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PoSCResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::PoSCResponse.new
  end
  ...
  describe 'test an instance of PoSCResponse' do
    it 'should create an instance of PoSCResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::PoSCResponse)
    end
  end
