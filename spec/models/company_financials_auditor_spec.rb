...
# Unit tests for SwaggerClient::CompanyFinancialsAuditor
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyFinancialsAuditor' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyFinancialsAuditor.new
  end
  ...
  describe 'test an instance of CompanyFinancialsAuditor' do
    it 'should create an instance of CompanyFinancialsAuditor' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyFinancialsAuditor)
    end
  end
