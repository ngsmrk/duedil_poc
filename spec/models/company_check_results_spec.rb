...
# Unit tests for SwaggerClient::CompanyCheckResults
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyCheckResults' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyCheckResults.new
  end
  ...
  describe 'test an instance of CompanyCheckResults' do
    it 'should create an instance of CompanyCheckResults' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyCheckResults)
    end
  end
