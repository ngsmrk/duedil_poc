...
# Unit tests for SwaggerClient::CallcreditExtraChecksInput
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CallcreditExtraChecksInput' do
  before do
    # run before each test
    @instance = SwaggerClient::CallcreditExtraChecksInput.new
  end
  ...
  describe 'test an instance of CallcreditExtraChecksInput' do
    it 'should create an instance of CallcreditExtraChecksInput' do
      expect(@instance).to be_instance_of(SwaggerClient::CallcreditExtraChecksInput)
    end
  end
