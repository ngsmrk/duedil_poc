...
# Unit tests for SwaggerClient::KeywordSearchResults
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'KeywordSearchResults' do
  before do
    # run before each test
    @instance = SwaggerClient::KeywordSearchResults.new
  end
  ...
  describe 'test an instance of KeywordSearchResults' do
    it 'should create an instance of KeywordSearchResults' do
      expect(@instance).to be_instance_of(SwaggerClient::KeywordSearchResults)
    end
  end
