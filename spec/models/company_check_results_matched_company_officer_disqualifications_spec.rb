...
# Unit tests for SwaggerClient::CompanyCheckResultsMatchedCompanyOfficerDisqualifications
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyCheckResultsMatchedCompanyOfficerDisqualifications' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyCheckResultsMatchedCompanyOfficerDisqualifications.new
  end
  ...
  describe 'test an instance of CompanyCheckResultsMatchedCompanyOfficerDisqualifications' do
    it 'should create an instance of CompanyCheckResultsMatchedCompanyOfficerDisqualifications' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyCheckResultsMatchedCompanyOfficerDisqualifications)
    end
  end
  describe 'test attribute "current_officer_disqualified"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "former_officer_disqualified"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
