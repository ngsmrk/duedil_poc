...
# Unit tests for SwaggerClient::CompanyCharges
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyCharges' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyCharges.new
  end
  ...
  describe 'test an instance of CompanyCharges' do
    it 'should create an instance of CompanyCharges' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyCharges)
    end
  end
