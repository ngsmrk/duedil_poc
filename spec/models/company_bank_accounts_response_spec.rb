...
# Unit tests for SwaggerClient::CompanyBankAccountsResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyBankAccountsResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyBankAccountsResponse.new
  end
  ...
  describe 'test an instance of CompanyBankAccountsResponse' do
    it 'should create an instance of CompanyBankAccountsResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyBankAccountsResponse)
    end
  end
