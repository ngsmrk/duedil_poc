...
# Unit tests for SwaggerClient::CompanyOfficersFilters
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyOfficersFilters' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyOfficersFilters.new
  end
  ...
  describe 'test an instance of CompanyOfficersFilters' do
    it 'should create an instance of CompanyOfficersFilters' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyOfficersFilters)
    end
  end
  describe 'test attribute "appointment_statuses"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
       #validator = Petstore::EnumTest::EnumAttributeValidator.new('Array<String>', ["open", "closed", "retired"])
       #validator.allowable_values.each do |value|
       #  expect { @instance.appointment_statuses = value }.not_to raise_error
       #end
    end
  end
