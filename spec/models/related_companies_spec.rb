...
# Unit tests for SwaggerClient::RelatedCompanies
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RelatedCompanies' do
  before do
    # run before each test
    @instance = SwaggerClient::RelatedCompanies.new
  end
  ...
  describe 'test an instance of RelatedCompanies' do
    it 'should create an instance of RelatedCompanies' do
      expect(@instance).to be_instance_of(SwaggerClient::RelatedCompanies)
    end
  end
