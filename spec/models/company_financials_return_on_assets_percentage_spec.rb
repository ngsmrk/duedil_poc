...
# Unit tests for SwaggerClient::CompanyFinancialsReturnOnAssetsPercentage
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyFinancialsReturnOnAssetsPercentage' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyFinancialsReturnOnAssetsPercentage.new
  end
  ...
  describe 'test an instance of CompanyFinancialsReturnOnAssetsPercentage' do
    it 'should create an instance of CompanyFinancialsReturnOnAssetsPercentage' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyFinancialsReturnOnAssetsPercentage)
    end
  end
