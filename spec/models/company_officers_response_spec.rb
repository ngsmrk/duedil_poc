...
# Unit tests for SwaggerClient::CompanyOfficersResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyOfficersResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyOfficersResponse.new
  end
  ...
  describe 'test an instance of CompanyOfficersResponse' do
    it 'should create an instance of CompanyOfficersResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyOfficersResponse)
    end
  end
