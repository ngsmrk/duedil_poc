...
# Unit tests for SwaggerClient::SharedNotMatched
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SharedNotMatched' do
  before do
    # run before each test
    @instance = SwaggerClient::SharedNotMatched.new
  end
  ...
  describe 'test an instance of SharedNotMatched' do
    it 'should create an instance of SharedNotMatched' do
      expect(@instance).to be_instance_of(SwaggerClient::SharedNotMatched)
    end
  end
  describe 'test attribute "suspected_type"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
       #validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["person", "company"])
       #validator.allowable_values.each do |value|
       #  expect { @instance.suspected_type = value }.not_to raise_error
       #end
    end
  end
