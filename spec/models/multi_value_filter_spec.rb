...
# Unit tests for SwaggerClient::MultiValueFilter
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MultiValueFilter' do
  before do
    # run before each test
    @instance = SwaggerClient::MultiValueFilter.new
  end
  ...
  describe 'test an instance of MultiValueFilter' do
    it 'should create an instance of MultiValueFilter' do
      expect(@instance).to be_instance_of(SwaggerClient::MultiValueFilter)
    end
  end
