...
# Unit tests for SwaggerClient::CompanyCheckResultsMatchedCompanyPersonResidency
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyCheckResultsMatchedCompanyPersonResidency' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyCheckResultsMatchedCompanyPersonResidency.new
  end
  ...
  describe 'test an instance of CompanyCheckResultsMatchedCompanyPersonResidency' do
    it 'should create an instance of CompanyCheckResultsMatchedCompanyPersonResidency' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyCheckResultsMatchedCompanyPersonResidency)
    end
  end
