...
# Unit tests for SwaggerClient::SocialMediaProfilesSocialMediaProfiles
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SocialMediaProfilesSocialMediaProfiles' do
  before do
    # run before each test
    @instance = SwaggerClient::SocialMediaProfilesSocialMediaProfiles.new
  end
  ...
  describe 'test an instance of SocialMediaProfilesSocialMediaProfiles' do
    it 'should create an instance of SocialMediaProfilesSocialMediaProfiles' do
      expect(@instance).to be_instance_of(SwaggerClient::SocialMediaProfilesSocialMediaProfiles)
    end
  end
