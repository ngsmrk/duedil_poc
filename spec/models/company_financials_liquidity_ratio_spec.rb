...
# Unit tests for SwaggerClient::CompanyFinancialsLiquidityRatio
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyFinancialsLiquidityRatio' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyFinancialsLiquidityRatio.new
  end
  ...
  describe 'test an instance of CompanyFinancialsLiquidityRatio' do
    it 'should create an instance of CompanyFinancialsLiquidityRatio' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyFinancialsLiquidityRatio)
    end
  end
