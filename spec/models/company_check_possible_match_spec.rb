...
# Unit tests for SwaggerClient::CompanyCheckPossibleMatch
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyCheckPossibleMatch' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyCheckPossibleMatch.new
  end
  ...
  describe 'test an instance of CompanyCheckPossibleMatch' do
    it 'should create an instance of CompanyCheckPossibleMatch' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyCheckPossibleMatch)
    end
  end
