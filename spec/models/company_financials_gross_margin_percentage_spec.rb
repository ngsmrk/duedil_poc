...
# Unit tests for SwaggerClient::CompanyFinancialsGrossMarginPercentage
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyFinancialsGrossMarginPercentage' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyFinancialsGrossMarginPercentage.new
  end
  ...
  describe 'test an instance of CompanyFinancialsGrossMarginPercentage' do
    it 'should create an instance of CompanyFinancialsGrossMarginPercentage' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyFinancialsGrossMarginPercentage)
    end
  end
