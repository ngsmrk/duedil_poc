...
# Unit tests for SwaggerClient::CompanyCheckResultsMatchedCompanyPepsSanctionsCheck
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyCheckResultsMatchedCompanyPepsSanctionsCheck' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyCheckResultsMatchedCompanyPepsSanctionsCheck.new
  end
  ...
  describe 'test an instance of CompanyCheckResultsMatchedCompanyPepsSanctionsCheck' do
    it 'should create an instance of CompanyCheckResultsMatchedCompanyPepsSanctionsCheck' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyCheckResultsMatchedCompanyPepsSanctionsCheck)
    end
  end
