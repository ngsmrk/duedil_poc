...
# Unit tests for SwaggerClient::CreditRiskMultiValueFilter
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreditRiskMultiValueFilter' do
  before do
    # run before each test
    @instance = SwaggerClient::CreditRiskMultiValueFilter.new
  end
  ...
  describe 'test an instance of CreditRiskMultiValueFilter' do
    it 'should create an instance of CreditRiskMultiValueFilter' do
      expect(@instance).to be_instance_of(SwaggerClient::CreditRiskMultiValueFilter)
    end
  end
