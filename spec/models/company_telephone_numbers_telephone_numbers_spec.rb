...
# Unit tests for SwaggerClient::CompanyTelephoneNumbersTelephoneNumbers
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompanyTelephoneNumbersTelephoneNumbers' do
  before do
    # run before each test
    @instance = SwaggerClient::CompanyTelephoneNumbersTelephoneNumbers.new
  end
  ...
  describe 'test an instance of CompanyTelephoneNumbersTelephoneNumbers' do
    it 'should create an instance of CompanyTelephoneNumbersTelephoneNumbers' do
      expect(@instance).to be_instance_of(SwaggerClient::CompanyTelephoneNumbersTelephoneNumbers)
    end
  end
  ...
  describe 'test attribute "tps_registered"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
