...
# Unit tests for SwaggerClient::OfficerSearchResultsFiltersDateOfBirth
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OfficerSearchResultsFiltersDateOfBirth' do
  before do
    # run before each test
    @instance = SwaggerClient::OfficerSearchResultsFiltersDateOfBirth.new
  end
  ...
  describe 'test an instance of OfficerSearchResultsFiltersDateOfBirth' do
    it 'should create an instance of OfficerSearchResultsFiltersDateOfBirth' do
      expect(@instance).to be_instance_of(SwaggerClient::OfficerSearchResultsFiltersDateOfBirth)
    end
  end
