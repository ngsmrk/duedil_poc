...
# Unit tests for SwaggerClient::PEPsAndSanctionsBusinessSearchResults
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PEPsAndSanctionsBusinessSearchResults' do
  before do
    # run before each test
    @instance = SwaggerClient::PEPsAndSanctionsBusinessSearchResults.new
  end
  ...
  describe 'test an instance of PEPsAndSanctionsBusinessSearchResults' do
    it 'should create an instance of PEPsAndSanctionsBusinessSearchResults' do
      expect(@instance).to be_instance_of(SwaggerClient::PEPsAndSanctionsBusinessSearchResults)
    end
  end
