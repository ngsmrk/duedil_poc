...
# Unit tests for SwaggerClient::CreditReportApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreditReportApi' do
  before do
    # run before each test
    @instance = SwaggerClient::CreditReportApi.new
  end
  ...
  describe 'test an instance of CreditReportApi' do
    it 'should create an instance of CreditReportApi' do
      expect(@instance).to be_instance_of(SwaggerClient::CreditReportApi)
    end
  end

  # unit tests for company_country_code_company_id_credit_report_format_get
  # Credit report
  ...
  describe 'company_country_code_company_id_credit_report_format_get test' do
    it "should work" do
