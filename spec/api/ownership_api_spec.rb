...
# Unit tests for SwaggerClient::OwnershipApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OwnershipApi' do
  before do
    # run before each test
    @instance = SwaggerClient::OwnershipApi.new
  end
  ...
  describe 'test an instance of OwnershipApi' do
    it 'should create an instance of OwnershipApi' do
      expect(@instance).to be_instance_of(SwaggerClient::OwnershipApi)
    end
  end

  # unit tests for company_country_code_company_id_bank_accounts_format_get
  ...
  describe 'company_country_code_company_id_bank_accounts_format_get test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for company_country_code_company_id_charges_format_get
  # Company charges
  ...
  describe 'company_country_code_company_id_charges_format_get test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for company_country_code_company_id_fca_authorisations_format_get
  ...
  describe 'company_country_code_company_id_fca_authorisations_format_get test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for company_country_code_company_id_filings_format_get
  # Company filings
  ...
  describe 'company_country_code_company_id_filings_format_get test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for company_country_code_company_id_gazette_notices_format_get
  ...
  describe 'company_country_code_company_id_gazette_notices_format_get test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for company_country_code_company_id_group_parents_format_get
  ...
  describe 'company_country_code_company_id_group_parents_format_get test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for company_country_code_company_id_group_subsidiaries_format_get
  ...
  describe 'company_country_code_company_id_group_subsidiaries_format_get test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for company_country_code_company_id_persons_significant_control_format_get
  ...
  # @option opts [Integer] :limit Configures the maximum number of items from the collection to be returned in the given API call
  # @return [PoSCResponse]
  describe 'company_country_code_company_id_persons_significant_control_format_get test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for company_country_code_company_id_portfolio_companies_format_get
  ...
  describe 'company_country_code_company_id_portfolio_companies_format_get test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for company_country_code_company_id_related_companies_format_get
  ...
  describe 'company_country_code_company_id_related_companies_format_get test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for company_country_code_company_id_shareholders_format_get
  ...
  describe 'company_country_code_company_id_shareholders_format_get test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
