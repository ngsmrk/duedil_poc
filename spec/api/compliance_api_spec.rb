...
# Unit tests for SwaggerClient::ComplianceApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ComplianceApi' do
  before do
    # run before each test
    @instance = SwaggerClient::ComplianceApi.new
  end
  ...
  describe 'test an instance of ComplianceApi' do
    it 'should create an instance of ComplianceApi' do
      expect(@instance).to be_instance_of(SwaggerClient::ComplianceApi)
    end
  end

  # unit tests for callcredit_identity_check_format_post
  # Identity check
  ...
  describe 'callcredit_identity_check_format_post test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for duedil_company_check_format_post
  # Company check
  ...
  describe 'duedil_company_check_format_post test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
