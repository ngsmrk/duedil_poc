...
# Unit tests for SwaggerClient::FinancialsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FinancialsApi' do
  before do
    # run before each test
    @instance = SwaggerClient::FinancialsApi.new
  end
  ...
  describe 'test an instance of FinancialsApi' do
    it 'should create an instance of FinancialsApi' do
      expect(@instance).to be_instance_of(SwaggerClient::FinancialsApi)
    end
  end

  # unit tests for company_country_code_company_id_financials_format_get
  # Company financials
  ...
  describe 'company_country_code_company_id_financials_format_get test' do
    it "should work" do
