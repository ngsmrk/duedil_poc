...
module SwaggerClient
  ...
  class CompanyFilingsResponse
    ...
    def self.swagger_types
      {
        ...
        :'filings' => :'Array<CompanyFilingsFilings>'
      }
    end
    ...
    def list_invalid_properties
      ...
      if @filings.nil?
        invalid_properties.push("invalid value for 'filings', filings cannot be nil.")
      end
    ...
    def hash
      [country_code, company_id, pagination, filings].hash
    end
