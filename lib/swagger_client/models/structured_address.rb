...
module SwaggerClient
  ...
  class StructuredAddress
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'premises')
        self.premises = attributes[:'premises']
      end
      ...
      if attributes.has_key?(:'postTown')
        self.post_town = attributes[:'postTown']
      end
    ...
    def list_invalid_properties
      ...
      if @premises.nil?
        invalid_properties.push("invalid value for 'premises', premises cannot be nil.")
      end
      ...
      if @dependent_locality.nil?
        invalid_properties.push("invalid value for 'dependent_locality', dependent_locality cannot be nil.")
      end

      if @post_town.nil?
        invalid_properties.push("invalid value for 'post_town', post_town cannot be nil.")
      end
    ...
    def valid?
      return false if @premises.nil?
      return false if @thoroughfare.nil?
      return false if @dependent_locality.nil?
      return false if @post_town.nil?
    ...
    def hash
      [premises, thoroughfare, dependent_locality, post_town, county, postcode, country_code].hash
    end
