...
module SwaggerClient
  ...
  class PEPsAndSanctionsPossibleIndividualMatch
    ...
    def self.swagger_types
      {
        :'match_score' => :'Integer',
        :'type' => :'String',
        :'individual' => :'PEPsAndSanctionsIndividual'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'individual')
    ...
    def list_invalid_properties
      ...
      if @match_score.nil?
        invalid_properties.push("invalid value for 'match_score', match_score cannot be nil.")
      end
    ...
    def valid?
      return false if @match_score.nil?
    ...
    def hash
      [match_score, type, individual].hash
    end
