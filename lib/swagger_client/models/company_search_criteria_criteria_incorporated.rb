...
module SwaggerClient
  # Companies whose incorporation date falls within the given range
  class CompanySearchCriteriaCriteriaIncorporated
    attr_accessor :from
    ...
    def self.swagger_types
      {
        :'from' => :'CompanySearchCriteriaCriteriaIncorporatedFrom',
        :'to' => :'CompanySearchCriteriaCriteriaIncorporatedFrom'
      }
    end
