...
module SwaggerClient
  ...
  class CallcreditIdentityCheckResponseMatchSummary
    # IndividualReport = a full match has been achieved; SurnameReport = a surname match has been achieved; AddressReport = an address match has been achieved; NoMatchFound = no matches have been achieved; Picklist = a picklist has been returned
    attr_accessor :match_level

    attr_accessor :applicant_verified

    attr_accessor :num_primary_checks

    attr_accessor :num_primary_other_ids_confirmed

    attr_accessor :num_corroborative_checks
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'matchLevel')
        self.match_level = attributes[:'matchLevel']
      end

      if attributes.has_key?(:'applicantVerified')
        self.applicant_verified = attributes[:'applicantVerified']
      end

      if attributes.has_key?(:'numPrimaryChecks')
        self.num_primary_checks = attributes[:'numPrimaryChecks']
      end

      if attributes.has_key?(:'numPrimaryOtherIdsConfirmed')
        self.num_primary_other_ids_confirmed = attributes[:'numPrimaryOtherIdsConfirmed']
      end

      if attributes.has_key?(:'numCorroborativeChecks')
        self.num_corroborative_checks = attributes[:'numCorroborativeChecks']
      end
    ...
    def list_invalid_properties
      ...
      if @applicant_verified.nil?
        invalid_properties.push("invalid value for 'applicant_verified', applicant_verified cannot be nil.")
      end

      if @num_primary_checks.nil?
        invalid_properties.push("invalid value for 'num_primary_checks', num_primary_checks cannot be nil.")
      end

      if @num_primary_other_ids_confirmed.nil?
        invalid_properties.push("invalid value for 'num_primary_other_ids_confirmed', num_primary_other_ids_confirmed cannot be nil.")
      end

      if @num_corroborative_checks.nil?
        invalid_properties.push("invalid value for 'num_corroborative_checks', num_corroborative_checks cannot be nil.")
      end
    ...
    def valid?
      ...
      return false if @applicant_verified.nil?
      return false if @num_primary_checks.nil?
      return false if @num_primary_other_ids_confirmed.nil?
      return false if @num_corroborative_checks.nil?
      return true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          applicant_verified == o.applicant_verified &&
          num_primary_checks == o.num_primary_checks &&
          num_primary_other_ids_confirmed == o.num_primary_other_ids_confirmed &&
          num_corroborative_checks == o.num_corroborative_checks
    end
    ...
    def hash
      [match_level, applicant_verified, num_primary_checks, num_primary_other_ids_confirmed, num_corroborative_checks].hash
    end
