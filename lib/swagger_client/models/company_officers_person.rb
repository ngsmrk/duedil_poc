...
module SwaggerClient
  ...
  class CompanyOfficersPerson
    ...
    def self.swagger_types
      {
        ...
        :'middle_name' => :'String',
        :'last_name' => :'String',
        :'nationalities' => :'Array<CompanyOfficersPersonNationalities>',
        :'date_of_birth' => :'OfficerSearchCriteriaCriteriaDateOfBirthFrom'
      }
    end
    ...
    def hash
      [honorific, first_name, middle_name, last_name, nationalities, date_of_birth].hash
    end
