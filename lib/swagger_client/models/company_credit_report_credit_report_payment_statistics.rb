...
module SwaggerClient
  ...
  class CompanyCreditReportCreditReportPaymentStatistics
    attr_accessor :total_invoices_sampled

    attr_accessor :threshold_days

    attr_accessor :invoices_paid

    attr_accessor :invoices_outstanding

    attr_accessor :payment_trend
    ...
    def self.swagger_types
      {
        ...
        :'invoices_paid' => :'CompanyCreditReportCreditReportPaymentStatisticsInvoicesPaid',
        :'invoices_outstanding' => :'CompanyCreditReportCreditReportPaymentStatisticsInvoicesPaid',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'totalInvoicesSampled')
        self.total_invoices_sampled = attributes[:'totalInvoicesSampled']
      end

      if attributes.has_key?(:'thresholdDays')
        self.threshold_days = attributes[:'thresholdDays']
      end

      if attributes.has_key?(:'invoicesPaid')
        self.invoices_paid = attributes[:'invoicesPaid']
      end

      if attributes.has_key?(:'invoicesOutstanding')
        self.invoices_outstanding = attributes[:'invoicesOutstanding']
      end

      if attributes.has_key?(:'paymentTrend')
        self.payment_trend = attributes[:'paymentTrend']
      end
    ...
    def list_invalid_properties
      ...
      if @total_invoices_sampled.nil?
        invalid_properties.push("invalid value for 'total_invoices_sampled', total_invoices_sampled cannot be nil.")
      end

      if @threshold_days.nil?
        invalid_properties.push("invalid value for 'threshold_days', threshold_days cannot be nil.")
      end

      if @invoices_paid.nil?
        invalid_properties.push("invalid value for 'invoices_paid', invoices_paid cannot be nil.")
      end

      if @invoices_outstanding.nil?
        invalid_properties.push("invalid value for 'invoices_outstanding', invoices_outstanding cannot be nil.")
      end

      if @payment_trend.nil?
        invalid_properties.push("invalid value for 'payment_trend', payment_trend cannot be nil.")
      end
    ...
    def valid?
      return false if @total_invoices_sampled.nil?
      return false if @threshold_days.nil?
      return false if @invoices_paid.nil?
      return false if @invoices_outstanding.nil?
      return false if @payment_trend.nil?
      payment_trend_validator = EnumAttributeValidator.new('String', ["Improving", "Worsening", "Stable"])
      return false unless payment_trend_validator.valid?(@payment_trend)
      return true
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] payment_trend Object to be assigned
    def payment_trend=(payment_trend)
      validator = EnumAttributeValidator.new('String', ["Improving", "Worsening", "Stable"])
      unless validator.valid?(payment_trend)
        fail ArgumentError, "invalid value for 'payment_trend', must be one of #{validator.allowable_values}."
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          total_invoices_sampled == o.total_invoices_sampled &&
          threshold_days == o.threshold_days &&
          invoices_paid == o.invoices_paid &&
          invoices_outstanding == o.invoices_outstanding &&
          payment_trend == o.payment_trend
    end
    ...
    def hash
      [total_invoices_sampled, threshold_days, invoices_paid, invoices_outstanding, payment_trend].hash
    end
