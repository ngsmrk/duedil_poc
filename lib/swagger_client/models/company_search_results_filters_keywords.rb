...
module SwaggerClient
  # Optional keywords issued in the search request
  class CompanySearchResultsFiltersKeywords
    ...
    def self.swagger_types
      {
        :'values' => :'Array<String>',
        :'mode' => :'String',
        :'except' => :'CompanySearchResultsFiltersKeywordsExcept'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'except')
        self.except = attributes[:'except']
      end
    ...
    def valid?
      mode_validator = EnumAttributeValidator.new('String', ["any", "all"])
