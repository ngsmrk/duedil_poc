...
module SwaggerClient
  ...
  class CallcreditIdentityCheckResponseName
    attr_accessor :name_pick_list_found

    attr_accessor :name_matched
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'namePickListFound')
        self.name_pick_list_found = attributes[:'namePickListFound']
      end

      if attributes.has_key?(:'nameMatched')
        self.name_matched = attributes[:'nameMatched']
      end
    ...
    def list_invalid_properties
      ...
      if @name_pick_list_found.nil?
        invalid_properties.push("invalid value for 'name_pick_list_found', name_pick_list_found cannot be nil.")
      end

      if @name_matched.nil?
        invalid_properties.push("invalid value for 'name_matched', name_matched cannot be nil.")
      end
    ...
    def valid?
      return false if @name_pick_list_found.nil?
      return false if @name_matched.nil?
      return true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          name_pick_list_found == o.name_pick_list_found &&
          name_matched == o.name_matched
    end
    ...
    def hash
      [name_pick_list_found, name_matched].hash
    end
