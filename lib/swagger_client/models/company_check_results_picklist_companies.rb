...
module SwaggerClient
  ...
  class CompanyCheckResultsPicklistCompanies
    ...
    def hash
      [country_code, company_id, name, type, incorporation_date, official_status, simplified_status, primary_website, registered_address].hash
    end
