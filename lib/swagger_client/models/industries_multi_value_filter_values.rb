...
module SwaggerClient
  # Filter values
  class IndustriesMultiValueFilterValues
    attr_accessor :code

    attr_accessor :type

    # Expands the search across other industry code types that match closely the category you have searched for. This filter is *Optional* and will be `false` if not provided
    attr_accessor :implied
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'implied')
        self.implied = attributes[:'implied']
      else
        self.implied = false
      end
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ["SIC2003", "SIC2007", "NACE", "NAF"])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["SIC2003", "SIC2007", "NACE", "NAF"])
