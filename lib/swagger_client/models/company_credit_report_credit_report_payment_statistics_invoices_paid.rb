...
module SwaggerClient
  ...
  class CompanyCreditReportCreditReportPaymentStatisticsInvoicesPaid
    attr_accessor :before_threshold

    attr_accessor :after_threshold
    ...
    def self.swagger_types
      {
        :'before_threshold' => :'CompanyCreditReportCreditReportPaymentStatisticsInvoicesPaidBeforeThreshold',
        :'after_threshold' => :'CompanyCreditReportCreditReportPaymentStatisticsInvoicesPaidBeforeThreshold'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'beforeThreshold')
        self.before_threshold = attributes[:'beforeThreshold']
      end

      if attributes.has_key?(:'afterThreshold')
        self.after_threshold = attributes[:'afterThreshold']
      end
    ...
    def list_invalid_properties
      ...
      if @before_threshold.nil?
        invalid_properties.push("invalid value for 'before_threshold', before_threshold cannot be nil.")
      end

      if @after_threshold.nil?
        invalid_properties.push("invalid value for 'after_threshold', after_threshold cannot be nil.")
      end
    ...
    def valid?
      return false if @before_threshold.nil?
      return false if @after_threshold.nil?
      return true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          before_threshold == o.before_threshold &&
          after_threshold == o.after_threshold
    end
    ...
    def hash
      [before_threshold, after_threshold].hash
    end
