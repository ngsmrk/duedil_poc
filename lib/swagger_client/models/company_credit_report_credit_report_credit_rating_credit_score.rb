...
module SwaggerClient
  ...
  class CompanyCreditReportCreditReportCreditRatingCreditScore
    attr_accessor :value
    ...
    attr_accessor :value_last_change
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'rangeMin')
        self.range_min = attributes[:'rangeMin']
      end

      if attributes.has_key?(:'rangeMax')
        self.range_max = attributes[:'rangeMax']
      end
      ...
      if attributes.has_key?(:'valueLastChange')
        self.value_last_change = attributes[:'valueLastChange']
      end
    ...
    def list_invalid_properties
      ...
      if @range_min.nil?
        invalid_properties.push("invalid value for 'range_min', range_min cannot be nil.")
      end

      if @range_max.nil?
        invalid_properties.push("invalid value for 'range_max', range_max cannot be nil.")
      end
      ...
      if @value_last_change.nil?
        invalid_properties.push("invalid value for 'value_last_change', value_last_change cannot be nil.")
      end
    ...
    def valid?
      ...
      return false if @range_min.nil?
      return false if @range_max.nil?
      return false if @description.nil?
      return false if @value_last_change.nil?
      return true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          value_last_change == o.value_last_change
    end
    ...
    def hash
      [value, range_min, range_max, description, value_last_change].hash
    end
