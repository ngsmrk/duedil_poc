...
module SwaggerClient
  class CompanyCreditRisk
    ...
    def build_from_hash(value)
      constantValues = CompanyCreditRisk.constants.select{|c| CompanyCreditRisk::const_get(c) == value}
      raise "Invalid ENUM value #{value} for class #CompanyCreditRisk" if constantValues.empty?
      value
    end
  end
