...
module SwaggerClient
  ...
  class PEPsAndSanctionsAddress
    ...
    def self.swagger_types
      {
        :'full_address' => :'String',
        :'country_code' => :'String',
        :'source_address' => :'PEPsAndSanctionsAddressSourceAddress'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'sourceAddress')
        self.source_address = attributes[:'sourceAddress']
      end
    ...
    def hash
      [full_address, country_code, source_address].hash
    end
