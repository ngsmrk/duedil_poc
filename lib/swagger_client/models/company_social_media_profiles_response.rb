...
module SwaggerClient
  ...
  class CompanySocialMediaProfilesResponse
    ...
    def self.swagger_types
      {
        ...
        :'social_media_profiles' => :'Array<SocialMediaProfilesSocialMediaProfiles>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'socialMediaProfiles')
        if (value = attributes[:'socialMediaProfiles']).is_a?(Array)
    ...
    def list_invalid_properties
      ...
      if @social_media_profiles.nil?
        invalid_properties.push("invalid value for 'social_media_profiles', social_media_profiles cannot be nil.")
      end
    ...
    def valid?
      ...
      return false if @social_media_profiles.nil?
      return true
    end
    ...
    def hash
      [country_code, company_id, pagination, social_media_profiles].hash
    end
