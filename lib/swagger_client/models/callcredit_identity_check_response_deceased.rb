...
module SwaggerClient
  ...
  class CallcreditIdentityCheckResponseDeceased
    # Whether or not the individual is found to be deceased on the [General Register Office](http://www.gro.gov.uk/).
    attr_accessor :gro_match

    # Whether or not the individual is found on the [Halo](http://www.halofraudprevention.com/) database of deceased records.
    attr_accessor :halo_match

    attr_accessor :halo_level_of_confidence
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'groMatch')
        self.gro_match = attributes[:'groMatch']
      end

      if attributes.has_key?(:'haloMatch')
        self.halo_match = attributes[:'haloMatch']
      end

      if attributes.has_key?(:'haloLevelOfConfidence')
        self.halo_level_of_confidence = attributes[:'haloLevelOfConfidence']
      end
    ...
    def list_invalid_properties
      ...
      if @gro_match.nil?
        invalid_properties.push("invalid value for 'gro_match', gro_match cannot be nil.")
      end

      if @halo_match.nil?
        invalid_properties.push("invalid value for 'halo_match', halo_match cannot be nil.")
      end

      if @halo_level_of_confidence.nil?
        invalid_properties.push("invalid value for 'halo_level_of_confidence', halo_level_of_confidence cannot be nil.")
      end
    ...
    def valid?
      return false if @gro_match.nil?
      return false if @halo_match.nil?
      return false if @halo_level_of_confidence.nil?
      return true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          gro_match == o.gro_match &&
          halo_match == o.halo_match &&
          halo_level_of_confidence == o.halo_level_of_confidence
    end
    ...
    def hash
      [gro_match, halo_match, halo_level_of_confidence].hash
    end
