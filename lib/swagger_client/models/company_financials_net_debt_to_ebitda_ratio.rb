...
module SwaggerClient
  # Net Debt divided by annualised EBITDA; Net Debt = Bank Loans & Overdrafts + Other Short Term Finances + Total Long Term Liabilities - Cash
  class CompanyFinancialsNetDebtToEBITDARatio
    attr_accessor :value
