...
module SwaggerClient
  ...
  class SharedPersonMatchNationalities
    attr_accessor :demonym
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'demonym')
        self.demonym = attributes[:'demonym']
      end
    ...
    def list_invalid_properties
      ...
      if @demonym.nil?
        invalid_properties.push("invalid value for 'demonym', demonym cannot be nil.")
      end
