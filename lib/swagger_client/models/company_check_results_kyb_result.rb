...
module SwaggerClient
  ...
  class CompanyCheckResultsKybResult
    attr_accessor :value

    # List of possible reasons for a FAIL score.
    ...
    def valid?
      ...
      value_validator = EnumAttributeValidator.new('String', ["PASS", "FAIL", "PICKLIST"])
    ...
    def value=(value)
      validator = EnumAttributeValidator.new('String', ["PASS", "FAIL", "PICKLIST"])
