...
module SwaggerClient
  ...
  class GazetteNoticesGazetteNotices
    attr_accessor :publication_date

    attr_accessor :notice_id

    attr_accessor :notice_type
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'noticeId')
        self.notice_id = attributes[:'noticeId']
      end

      if attributes.has_key?(:'noticeType')
        self.notice_type = attributes[:'noticeType']
      end
    ...
    def list_invalid_properties
      ...
      if @notice_id.nil?
        invalid_properties.push("invalid value for 'notice_id', notice_id cannot be nil.")
      end

      if @notice_type.nil?
        invalid_properties.push("invalid value for 'notice_type', notice_type cannot be nil.")
      end

      if @edition.nil?
        invalid_properties.push("invalid value for 'edition', edition cannot be nil.")
      end
    ...
    def valid?
      ...
      return false if @notice_id.nil?
      return false if @notice_type.nil?
    ...
    def hash
      [publication_date, notice_id, notice_type, edition, issue, details].hash
    end
