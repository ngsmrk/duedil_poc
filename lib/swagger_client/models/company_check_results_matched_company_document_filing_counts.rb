...
module SwaggerClient
  ...
  class CompanyCheckResultsMatchedCompanyDocumentFilingCounts
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'appointments')
        self.appointments = attributes[:'appointments']
      end
      ...
      if attributes.has_key?(:'incorporation')
        self.incorporation = attributes[:'incorporation']
      end

      if attributes.has_key?(:'capital')
    ...
    def list_invalid_properties
      ...
      if @incorporation.nil?
        invalid_properties.push("invalid value for 'incorporation', incorporation cannot be nil.")
      end

      if @capital.nil?
        invalid_properties.push("invalid value for 'capital', capital cannot be nil.")
      end

      if @miscellaneous.nil?
        invalid_properties.push("invalid value for 'miscellaneous', miscellaneous cannot be nil.")
      end
    ...
    def valid?
      ...
      return false if @incorporation.nil?
      return false if @capital.nil?
      return false if @miscellaneous.nil?
      return true
    end
    ...
    def hash
      [accounts, annual_returns, appointments, registered_address, charges, incorporation, capital, miscellaneous].hash
    end
