...
module SwaggerClient
  ...
  class CompanyGazetteNoticesResponse
    ...
    def self.swagger_types
      {
        ...
        :'gazette_notices' => :'Array<GazetteNoticesGazetteNotices>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'gazetteNotices')
        if (value = attributes[:'gazetteNotices']).is_a?(Array)
          self.gazette_notices = value
        end
      end
    ...
    def list_invalid_properties
      ...
      if @gazette_notices.nil?
        invalid_properties.push("invalid value for 'gazette_notices', gazette_notices cannot be nil.")
      end
    ...
    def valid?
      ...
      return false if @gazette_notices.nil?
      return true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          gazette_notices == o.gazette_notices
    end
    ...
    def hash
      [country_code, company_id, pagination, gazette_notices].hash
    end
