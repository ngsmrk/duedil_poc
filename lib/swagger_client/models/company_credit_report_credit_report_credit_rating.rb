...
module SwaggerClient
  ...
  class CompanyCreditReportCreditReportCreditRating
    attr_accessor :credit_score

    attr_accessor :credit_band
    ...
    def self.swagger_types
      {
        :'credit_score' => :'CompanyCreditReportCreditReportCreditRatingCreditScore',
        :'credit_band' => :'CompanyCreditReportCreditReportCreditRatingCreditBand',
        :'since_date' => :'Date'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'creditBand')
        self.credit_band = attributes[:'creditBand']
      end

      if attributes.has_key?(:'sinceDate')
        self.since_date = attributes[:'sinceDate']
      end
    ...
    def list_invalid_properties
      ...
      if @credit_score.nil?
        invalid_properties.push("invalid value for 'credit_score', credit_score cannot be nil.")
      end

      if @credit_band.nil?
        invalid_properties.push("invalid value for 'credit_band', credit_band cannot be nil.")
      end

      if @since_date.nil?
        invalid_properties.push("invalid value for 'since_date', since_date cannot be nil.")
      end
    ...
    def valid?
      return false if @credit_score.nil?
      return false if @credit_band.nil?
      return false if @since_date.nil?
      return true
    end
    ...
    def hash
      [credit_score, credit_band, since_date].hash
    end
