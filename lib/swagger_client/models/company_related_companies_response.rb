...
module SwaggerClient
  ...
  class CompanyRelatedCompaniesResponse
    ...
    attr_accessor :related_companies
    ...
    def self.swagger_types
      {
        ...
        :'related_companies' => :'Array<RelatedCompaniesRelatedCompanies>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'relatedCompanies')
        if (value = attributes[:'relatedCompanies']).is_a?(Array)
          self.related_companies = value
        end
      end
    ...
    def list_invalid_properties
      ...
      if @related_companies.nil?
        invalid_properties.push("invalid value for 'related_companies', related_companies cannot be nil.")
      end
    ...
    def valid?
      ...
      return false if @related_companies.nil?
      return true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          related_companies == o.related_companies
    end
    ...
    def hash
      [country_code, company_id, pagination, related_companies].hash
    end
