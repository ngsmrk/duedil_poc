...
module SwaggerClient
  ...
  class CallcreditIdentityCheckResponseExtraChecksRealTimeFraudAlertsReport
    attr_accessor :summary

    # Contains results from the data velocity checks within Real-Time Fraud Alerts
    attr_accessor :velocity_data

    attr_accessor :inconsistency_data
    ...
    def self.swagger_types
      {
        :'summary' => :'CallcreditIdentityCheckResponseExtraChecksRealTimeFraudAlertsReportSummary',
        :'velocity_data' => :'Array<CallcreditIdentityCheckResponseExtraChecksRealTimeFraudAlertsReportVelocityData>',
        :'inconsistency_data' => :'CallcreditIdentityCheckResponseExtraChecksRealTimeFraudAlertsReportInconsistencyData'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'velocityData')
        if (value = attributes[:'velocityData']).is_a?(Array)
          self.velocity_data = value
        end
      end

      if attributes.has_key?(:'inconsistencyData')
        self.inconsistency_data = attributes[:'inconsistencyData']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          summary == o.summary &&
          velocity_data == o.velocity_data &&
          inconsistency_data == o.inconsistency_data
    end
    ...
    def hash
      [summary, velocity_data, inconsistency_data].hash
    end
