...
module SwaggerClient
  # Optional officer date of birth range issued in the search request
  class OfficerSearchResultsFiltersDateOfBirth
    attr_accessor :from
    ...
    def self.swagger_types
      {
        :'from' => :'OfficerSearchCriteriaCriteriaDateOfBirthFrom',
        :'to' => :'OfficerSearchCriteriaCriteriaDateOfBirthFrom'
      }
    end
