...
module SwaggerClient
  ...
  class CompanySearchResultsCompanies
    ...
    def self.swagger_types
      {
        ...
        :'industries' => :'Array<CompanyIndustry>',
        :'credit_risk' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'creditRisk')
        self.credit_risk = attributes[:'creditRisk']
      end
    ...
    def hash
      [country_code, company_id, name, type, incorporation_date, official_status, simplified_status, keywords, domains, addresses, industries, credit_risk].hash
    end
