...
module SwaggerClient
  ...
  class CompanyChargesCharges
    ...
    attr_accessor :date_filed

    attr_accessor :date_satisfied

    attr_accessor :persons_entitled

    attr_accessor :amount_secured

    attr_accessor :short_particulars
    ...
    def self.swagger_types
      {
        ...
        :'date_filed' => :'Date',
        :'date_satisfied' => :'Date',
        :'persons_entitled' => :'Array<CompanyFinancialsAuditor>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'dateFiled')
        self.date_filed = attributes[:'dateFiled']
      end

      if attributes.has_key?(:'dateSatisfied')
        self.date_satisfied = attributes[:'dateSatisfied']
      end

      if attributes.has_key?(:'personsEntitled')
        if (value = attributes[:'personsEntitled']).is_a?(Array)
          self.persons_entitled = value
        end
      end

      if attributes.has_key?(:'amountSecured')
        self.amount_secured = attributes[:'amountSecured']
      end

      if attributes.has_key?(:'shortParticulars')
        self.short_particulars = attributes[:'shortParticulars']
      end
    ...
    def list_invalid_properties
      ...
      if @date_filed.nil?
        invalid_properties.push("invalid value for 'date_filed', date_filed cannot be nil.")
      end

      if @date_satisfied.nil?
        invalid_properties.push("invalid value for 'date_satisfied', date_satisfied cannot be nil.")
      end

      if @persons_entitled.nil?
        invalid_properties.push("invalid value for 'persons_entitled', persons_entitled cannot be nil.")
      end

      if @amount_secured.nil?
        invalid_properties.push("invalid value for 'amount_secured', amount_secured cannot be nil.")
      end

      if @short_particulars.nil?
        invalid_properties.push("invalid value for 'short_particulars', short_particulars cannot be nil.")
      end
    ...
    def valid?
      ...
      status_validator = EnumAttributeValidator.new('String', ["Outstanding", "Satisfied", "Partially satisfied"])
      return false unless status_validator.valid?(@status)
      return false if @date_created.nil?
      return false if @date_filed.nil?
      return false if @date_satisfied.nil?
      return false if @persons_entitled.nil?
      return false if @amount_secured.nil?
      return false if @short_particulars.nil?
      return true
    end
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ["Outstanding", "Satisfied", "Partially satisfied"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          date_satisfied == o.date_satisfied &&
          persons_entitled == o.persons_entitled &&
          amount_secured == o.amount_secured &&
          short_particulars == o.short_particulars
    end
    ...
    def hash
      [type, status, date_created, date_filed, date_satisfied, persons_entitled, amount_secured, short_particulars].hash
    end
