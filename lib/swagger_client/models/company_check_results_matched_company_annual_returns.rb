...
module SwaggerClient
  ...
  class CompanyCheckResultsMatchedCompanyAnnualReturns
    attr_accessor :latest_annual_return_date

    attr_accessor :next_annual_return_due_date

    attr_accessor :next_annual_return_overdue
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'latestAnnualReturnDate')
        self.latest_annual_return_date = attributes[:'latestAnnualReturnDate']
      end

      if attributes.has_key?(:'nextAnnualReturnDueDate')
        self.next_annual_return_due_date = attributes[:'nextAnnualReturnDueDate']
      end

      if attributes.has_key?(:'nextAnnualReturnOverdue')
        self.next_annual_return_overdue = attributes[:'nextAnnualReturnOverdue']
      end
    ...
    def list_invalid_properties
      ...
      if @latest_annual_return_date.nil?
        invalid_properties.push("invalid value for 'latest_annual_return_date', latest_annual_return_date cannot be nil.")
      end

      if @next_annual_return_due_date.nil?
        invalid_properties.push("invalid value for 'next_annual_return_due_date', next_annual_return_due_date cannot be nil.")
      end

      if @next_annual_return_overdue.nil?
        invalid_properties.push("invalid value for 'next_annual_return_overdue', next_annual_return_overdue cannot be nil.")
      end
    ...
    def valid?
      return false if @latest_annual_return_date.nil?
      return false if @next_annual_return_due_date.nil?
      return false if @next_annual_return_overdue.nil?
      return true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          latest_annual_return_date == o.latest_annual_return_date &&
          next_annual_return_due_date == o.next_annual_return_due_date &&
          next_annual_return_overdue == o.next_annual_return_overdue
    end
    ...
    def hash
      [latest_annual_return_date, next_annual_return_due_date, next_annual_return_overdue].hash
    end
