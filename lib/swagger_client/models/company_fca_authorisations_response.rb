...
module SwaggerClient
  ...
  class CompanyFCAAuthorisationsResponse
    ...
    attr_accessor :fca_authorisations
    ...
    def self.swagger_types
      {
        ...
        :'fca_authorisations' => :'Array<FCAAuthorisationsFcaAuthorisations>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'fcaAuthorisations')
        if (value = attributes[:'fcaAuthorisations']).is_a?(Array)
          self.fca_authorisations = value
        end
      end
    ...
    def list_invalid_properties
      ...
      if @fca_authorisations.nil?
        invalid_properties.push("invalid value for 'fca_authorisations', fca_authorisations cannot be nil.")
      end
    ...
    def valid?
      ...
      return false if @fca_authorisations.nil?
      return true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          fca_authorisations == o.fca_authorisations
    end
    ...
    def hash
      [country_code, company_id, pagination, fca_authorisations].hash
    end
