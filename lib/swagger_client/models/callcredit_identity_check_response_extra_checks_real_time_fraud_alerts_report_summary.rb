...
module SwaggerClient
  # Contains summarised information on the configuration used and results returned
  class CallcreditIdentityCheckResponseExtraChecksRealTimeFraudAlertsReportSummary
    # The threshold value for Velocity results, above which warnings are triggered. As set in the configuration
    attr_accessor :velocity_threshold

    # The time period over which Velocity data is evaluated. As set in the configuration
    attr_accessor :velocity_period

    # The threshold value for Inconsistency results above which warnings are triggered. As set in the configuration
    attr_accessor :inconsistency_threshold

    # The time period over which Inconsistency data is evaluated. As set in the configuration
    attr_accessor :inconsistency_period

    # The total number of Velocity warnings returned
    attr_accessor :total_velocity_warnings

    # The total number of Inconsistency warnings returned
    attr_accessor :total_inconsistency_warnings
    ...
    def self.swagger_types
      {
        ...
        :'inconsistency_threshold' => :'Integer',
        :'inconsistency_period' => :'String',
        :'total_velocity_warnings' => :'Integer',
        :'total_inconsistency_warnings' => :'Integer'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'velocityThreshold')
        self.velocity_threshold = attributes[:'velocityThreshold']
      end

      if attributes.has_key?(:'velocityPeriod')
        self.velocity_period = attributes[:'velocityPeriod']
      end

      if attributes.has_key?(:'inconsistencyThreshold')
        self.inconsistency_threshold = attributes[:'inconsistencyThreshold']
      end

      if attributes.has_key?(:'inconsistencyPeriod')
        self.inconsistency_period = attributes[:'inconsistencyPeriod']
      end

      if attributes.has_key?(:'totalVelocityWarnings')
        self.total_velocity_warnings = attributes[:'totalVelocityWarnings']
      end

      if attributes.has_key?(:'totalInconsistencyWarnings')
        self.total_inconsistency_warnings = attributes[:'totalInconsistencyWarnings']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          velocity_threshold == o.velocity_threshold &&
          velocity_period == o.velocity_period &&
          inconsistency_threshold == o.inconsistency_threshold &&
          inconsistency_period == o.inconsistency_period &&
          total_velocity_warnings == o.total_velocity_warnings &&
          total_inconsistency_warnings == o.total_inconsistency_warnings
    end
    ...
    def hash
      [velocity_threshold, velocity_period, inconsistency_threshold, inconsistency_period, total_velocity_warnings, total_inconsistency_warnings].hash
    end
