...
module SwaggerClient
  ...
  class CompanyOfficersFilters
    attr_accessor :appointment_statuses
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'appointmentStatuses')
        if (value = attributes[:'appointmentStatuses']).is_a?(Array)
          self.appointment_statuses = value
        end
      end
    ...
    def list_invalid_properties
      ...
      if @appointment_statuses.nil?
        invalid_properties.push("invalid value for 'appointment_statuses', appointment_statuses cannot be nil.")
      end
    ...
    def valid?
      return false if @appointment_statuses.nil?
      return true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          appointment_statuses == o.appointment_statuses
    end
