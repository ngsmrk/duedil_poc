...
module SwaggerClient
  ...
  class CompanyCheckResultsMatchedCompanyFinancialSummary
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'filingDate')
        self.filing_date = attributes[:'filingDate']
      end
    ...
    def list_invalid_properties
      ...
      if @filing_date.nil?
        invalid_properties.push("invalid value for 'filing_date', filing_date cannot be nil.")
      end
    ...
    def valid?
      return false if @filing_date.nil?
    ...
    def hash
      [filing_date, turnover, ebitda, post_tax_profit, total_assets, net_assets].hash
    end
