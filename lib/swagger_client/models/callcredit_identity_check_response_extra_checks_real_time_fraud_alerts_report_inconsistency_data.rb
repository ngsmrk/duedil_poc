...
module SwaggerClient
  ...
  class CallcreditIdentityCheckResponseExtraChecksRealTimeFraudAlertsReportInconsistencyData
    # The ‘Type’ attribute defines the Inconsistency data item which matches the input data that the results have been generated for. The ‘Type’ attribute can be one of the following below.
    attr_accessor :group
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'inconsistencies')
        if (value = attributes[:'inconsistencies']).is_a?(Array)
          self.inconsistencies = value
        end
      end
    ...
    def valid?
      group_validator = EnumAttributeValidator.new('String', ["Identity", "Address", "DateOfBirth", "BankDetails", "CardDetails", "EmailAddress", "IPAddress", "TelephoneNumber"])
