...
module SwaggerClient
  ...
  class CompanyTelephoneNumbersResponse
    ...
    def self.swagger_types
      {
        ...
        :'telephone_numbers' => :'Array<CompanyTelephoneNumbersTelephoneNumbers>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'telephoneNumbers')
        if (value = attributes[:'telephoneNumbers']).is_a?(Array)
    ...
    def list_invalid_properties
      ...
      if @telephone_numbers.nil?
        invalid_properties.push("invalid value for 'telephone_numbers', telephone_numbers cannot be nil.")
      end
    ...
    def valid?
      ...
      return false if @telephone_numbers.nil?
      return true
    end
    ...
    def hash
      [country_code, company_id, pagination, telephone_numbers].hash
    end
