...
module SwaggerClient
  ...
  class CompanyRegisteredNamesResponse
    ...
    attr_accessor :registered_names
    ...
    def self.swagger_types
      {
        ...
        :'registered_names' => :'Array<CompanyRegisteredNamesRegisteredNames>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'registeredNames')
        if (value = attributes[:'registeredNames']).is_a?(Array)
          self.registered_names = value
        end
      end
    ...
    def list_invalid_properties
      ...
      if @registered_names.nil?
        invalid_properties.push("invalid value for 'registered_names', registered_names cannot be nil.")
      end
    ...
    def valid?
      ...
      return false if @registered_names.nil?
      return true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          registered_names == o.registered_names
    end
    ...
    def hash
      [country_code, company_id, pagination, registered_names].hash
    end
