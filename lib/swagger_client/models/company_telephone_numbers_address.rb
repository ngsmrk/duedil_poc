...
module SwaggerClient
  ...
  class CompanyTelephoneNumbersAddress
    # A ready-to-render single-line string representation of an address.
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'structuredAddress')
        self.structured_address = attributes[:'structuredAddress']
      end
    ...
    def list_invalid_properties
      ...
      if @structured_address.nil?
        invalid_properties.push("invalid value for 'structured_address', structured_address cannot be nil.")
      end

      if @geolocation.nil?
        invalid_properties.push("invalid value for 'geolocation', geolocation cannot be nil.")
      end
    ...
    def valid?
      ...
      return false if @structured_address.nil?
      return false if @geolocation.nil?
      return true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          structured_address == o.structured_address &&
    ...
    def hash
      [full_address, structured_address, geolocation].hash
    end
