...
module SwaggerClient
  ...
  class CallcreditIdentityCheckResponseExtraChecksEmailRiskReport
    # A risk rating on a scale from one to a thousand. The higher the score, the higher the risk
    attr_accessor :score

    attr_accessor :email_address

    # An assessment of the level of fraud risk associated with the email address provided, based on the risk score.   Very High - 899-1000  High - 799-898  Medium High - 599-798 Neutral - 300-598  Low - 100-299  Very Low - 0-99
    attr_accessor :risk_level

    # Relevant information to understand the score
    attr_accessor :description

    # The date which the email mailbox was created.
    attr_accessor :created_date

    # The date which the email address was first verified.
    attr_accessor :first_verified_date

    # Current status of the email address   Active - Email mailbox is currently active  Inactive - Email mailbox is currently not active  Expired - Email mailbox was previously active but not currently  Unknown - Unable to determine email mailbox status
    ...
    def self.swagger_types
      {
        ...
        :'status' => :'String',
        :'domain' => :'CallcreditIdentityCheckResponseExtraChecksEmailRiskReportDomain'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'riskLevel')
        self.risk_level = attributes[:'riskLevel']
      end
      ...
      if attributes.has_key?(:'firstVerifiedDate')
        self.first_verified_date = attributes[:'firstVerifiedDate']
      end
    ...
    def valid?
      risk_level_validator = EnumAttributeValidator.new('String', ["very-high", "high", "medium-high", "neutral", "low", "very-low"])
      return false unless risk_level_validator.valid?(@risk_level)
      status_validator = EnumAttributeValidator.new('String', ["active", "inactive", "expired", "unknown"])
    ...
    def risk_level=(risk_level)
      validator = EnumAttributeValidator.new('String', ["very-high", "high", "medium-high", "neutral", "low", "very-low"])
      unless validator.valid?(risk_level)
        fail ArgumentError, "invalid value for 'risk_level', must be one of #{validator.allowable_values}."
      end
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ["active", "inactive", "expired", "unknown"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          first_verified_date == o.first_verified_date &&
          status == o.status &&
          domain == o.domain
    end
    ...
    def hash
      [score, email_address, risk_level, description, created_date, first_verified_date, status, domain].hash
    end
