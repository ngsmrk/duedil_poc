...
module SwaggerClient
  ...
  class CompanyCheckResultsMatchedCompanyPscStatements
    attr_accessor :filed_at

    attr_accessor :ceased_at
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'filedAt')
        self.filed_at = attributes[:'filedAt']
      end

      if attributes.has_key?(:'ceasedAt')
        self.ceased_at = attributes[:'ceasedAt']
      end

      if attributes.has_key?(:'statementType')
        self.statement_type = attributes[:'statementType']
      end
    ...
    def list_invalid_properties
      ...
      if @filed_at.nil?
        invalid_properties.push("invalid value for 'filed_at', filed_at cannot be nil.")
      end

      if @ceased_at.nil?
        invalid_properties.push("invalid value for 'ceased_at', ceased_at cannot be nil.")
      end
    ...
    def valid?
      return false if @filed_at.nil?
      return false if @ceased_at.nil?
    ...
    def hash
      [filed_at, ceased_at, statement_type].hash
    end
