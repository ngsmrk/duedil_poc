...
module SwaggerClient
  ...
  class CompanyResponse
    ...
    def hash
      [country_code, company_id, name, type, incorporation_country, incorporation_date, official_status, simplified_status, number_of_employees, primary_website, registered_address, charitable_identities_count, accounts, financial_summary].hash
    end
