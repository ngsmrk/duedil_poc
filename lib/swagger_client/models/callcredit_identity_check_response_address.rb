...
module SwaggerClient
  ...
  class CallcreditIdentityCheckResponseAddress
    # Whether or not an address picklist has been found for the address provided
    attr_accessor :address_pick_list_found

    # The matched current address for the individual
    attr_accessor :current_address_matched

    # The most recent forwarding address for the individual, if present
    attr_accessor :forwarding_address

    attr_accessor :num_address_links

    attr_accessor :paf_valid

    # Individual is listed as a director at current address provided
    attr_accessor :director_at_home
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'addressPickListFound')
        self.address_pick_list_found = attributes[:'addressPickListFound']
      end

      if attributes.has_key?(:'currentAddressMatched')
        self.current_address_matched = attributes[:'currentAddressMatched']
      end

      if attributes.has_key?(:'forwardingAddress')
        self.forwarding_address = attributes[:'forwardingAddress']
      end

      if attributes.has_key?(:'numAddressLinks')
        self.num_address_links = attributes[:'numAddressLinks']
      end

      if attributes.has_key?(:'pafValid')
        self.paf_valid = attributes[:'pafValid']
      end

      if attributes.has_key?(:'directorAtHome')
        self.director_at_home = attributes[:'directorAtHome']
      end
    ...
    def list_invalid_properties
      ...
      if @address_pick_list_found.nil?
        invalid_properties.push("invalid value for 'address_pick_list_found', address_pick_list_found cannot be nil.")
      end

      if @current_address_matched.nil?
        invalid_properties.push("invalid value for 'current_address_matched', current_address_matched cannot be nil.")
      end

      if @forwarding_address.nil?
        invalid_properties.push("invalid value for 'forwarding_address', forwarding_address cannot be nil.")
      end

      if @num_address_links.nil?
        invalid_properties.push("invalid value for 'num_address_links', num_address_links cannot be nil.")
      end

      if @paf_valid.nil?
        invalid_properties.push("invalid value for 'paf_valid', paf_valid cannot be nil.")
      end

      if @director_at_home.nil?
        invalid_properties.push("invalid value for 'director_at_home', director_at_home cannot be nil.")
      end
    ...
    def valid?
      return false if @address_pick_list_found.nil?
      return false if @current_address_matched.nil?
      return false if @forwarding_address.nil?
      return false if @num_address_links.nil?
      return false if @paf_valid.nil?
      return false if @director_at_home.nil?
      return true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          address_pick_list_found == o.address_pick_list_found &&
          current_address_matched == o.current_address_matched &&
          forwarding_address == o.forwarding_address &&
          num_address_links == o.num_address_links &&
          paf_valid == o.paf_valid &&
          director_at_home == o.director_at_home
    end
    ...
    def hash
      [address_pick_list_found, current_address_matched, forwarding_address, num_address_links, paf_valid, director_at_home].hash
    end
