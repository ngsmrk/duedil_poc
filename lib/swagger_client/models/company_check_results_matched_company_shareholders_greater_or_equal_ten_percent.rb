...
module SwaggerClient
  ...
  class CompanyCheckResultsMatchedCompanyShareholdersGreaterOrEqualTenPercent
    ...
    def self.swagger_types
      {
        ...
        :'possible_matches' => :'Array<CompanyCheckPossibleMatch>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'possibleMatches')
        if (value = attributes[:'possibleMatches']).is_a?(Array)
          self.possible_matches = value
        end
      end
