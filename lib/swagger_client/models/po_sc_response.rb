...
module SwaggerClient
  ...
  class PoSCResponse
    ...
    def self.swagger_types
      {
        ...
        :'statements' => :'Array<CompanyCheckResultsMatchedCompanyPscStatements>',
        :'persons_of_significant_control' => :'Array<PoSCSPeoplePersonsOfSignificantControl>'
      }
    end
    ...
    def hash
      [country_code, company_id, pagination, statements, persons_of_significant_control].hash
    end
