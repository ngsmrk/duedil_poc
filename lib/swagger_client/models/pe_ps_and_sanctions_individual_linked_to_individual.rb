...
module SwaggerClient
  ...
  class PEPsAndSanctionsIndividualLinkedToIndividual
    ...
    def list_invalid_properties
      ...
      if @association.nil?
        invalid_properties.push("invalid value for 'association', association cannot be nil.")
      end
    ...
    def hash
      [lookup_id, name, association].hash
    end
