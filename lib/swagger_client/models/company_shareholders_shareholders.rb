...
module SwaggerClient
  ...
  class CompanyShareholdersShareholders
    attr_accessor :source_name

    attr_accessor :total_shareholding

    attr_accessor :total_shareholding_percentage

    attr_accessor :shareholdings

    attr_accessor :exact_matches

    attr_accessor :possible_matches
    ...
    def self.swagger_types
      {
        ...
        :'shareholdings' => :'Array<CompanyCheckResultsMatchedCompanyShareholdings>',
        :'exact_matches' => :'SharedExactMatches',
        :'possible_matches' => :'SharedPossibleMatches',
        :'not_matched' => :'SharedNotMatched'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'totalShareholding')
        self.total_shareholding = attributes[:'totalShareholding']
      end

      if attributes.has_key?(:'totalShareholdingPercentage')
        self.total_shareholding_percentage = attributes[:'totalShareholdingPercentage']
      end

      if attributes.has_key?(:'shareholdings')
        if (value = attributes[:'shareholdings']).is_a?(Array)
          self.shareholdings = value
        end
      end

      if attributes.has_key?(:'exactMatches')
        self.exact_matches = attributes[:'exactMatches']
      end

      if attributes.has_key?(:'possibleMatches')
        self.possible_matches = attributes[:'possibleMatches']
      end

      if attributes.has_key?(:'notMatched')
        self.not_matched = attributes[:'notMatched']
      end
    ...
    def list_invalid_properties
      ...
      if @total_shareholding.nil?
        invalid_properties.push("invalid value for 'total_shareholding', total_shareholding cannot be nil.")
      end

      if @total_shareholding_percentage.nil?
        invalid_properties.push("invalid value for 'total_shareholding_percentage', total_shareholding_percentage cannot be nil.")
      end

      if @shareholdings.nil?
        invalid_properties.push("invalid value for 'shareholdings', shareholdings cannot be nil.")
      end

      if @exact_matches.nil?
        invalid_properties.push("invalid value for 'exact_matches', exact_matches cannot be nil.")
      end

      if @possible_matches.nil?
        invalid_properties.push("invalid value for 'possible_matches', possible_matches cannot be nil.")
      end

      if @not_matched.nil?
        invalid_properties.push("invalid value for 'not_matched', not_matched cannot be nil.")
      end
    ...
    def valid?
      ...
      return false if @total_shareholding.nil?
      return false if @total_shareholding_percentage.nil?
      return false if @shareholdings.nil?
      return false if @exact_matches.nil?
      return false if @possible_matches.nil?
      return false if @not_matched.nil?
      return true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          total_shareholding == o.total_shareholding &&
          total_shareholding_percentage == o.total_shareholding_percentage &&
          shareholdings == o.shareholdings &&
          exact_matches == o.exact_matches &&
          possible_matches == o.possible_matches &&
          not_matched == o.not_matched
    end
    ...
    def hash
      [source_name, total_shareholding, total_shareholding_percentage, shareholdings, exact_matches, possible_matches, not_matched].hash
    end
