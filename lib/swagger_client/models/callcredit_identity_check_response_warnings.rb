...
module SwaggerClient
  ...
  class CallcreditIdentityCheckResponseWarnings
    # Whether or not forward address links have been found
    attr_accessor :forward_address_links

    # Whether or not the individual matches to deceased data
    attr_accessor :deceased

    # Whether or not the individual is found on the Gone Away Suppression (GAS) from the REaD Group, which tracks relocations in the UK
    attr_accessor :gone_away

    # Whether or not the individual's electoral roll registration is less than 12 months old
    attr_accessor :length_of_residence

    # Whether or not the name matches to the Politically Exposed People database
    attr_accessor :pep

    # Whether or not the name matches to the HM Treasury financial sanctions database
    attr_accessor :sanction

    # Whether or not the name matches to the OFAC Specially Designated Nationals database
    attr_accessor :sdn

    # Whether or not any of the applicant's Callcredit's SHARE records have been opened within the last 12 months
    attr_accessor :share_length_of_residency
    ...
    def self.swagger_types
      {
        :'forward_address_links' => :'BOOLEAN',
        :'deceased' => :'BOOLEAN',
        :'gone_away' => :'BOOLEAN',
        :'length_of_residence' => :'BOOLEAN',
        :'pep' => :'BOOLEAN',
        :'sanction' => :'BOOLEAN',
        :'sdn' => :'BOOLEAN',
        :'share_length_of_residency' => :'BOOLEAN'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'forwardAddressLinks')
        self.forward_address_links = attributes[:'forwardAddressLinks']
      end
      ...
      if attributes.has_key?(:'goneAway')
        self.gone_away = attributes[:'goneAway']
      end

      if attributes.has_key?(:'lengthOfResidence')
        self.length_of_residence = attributes[:'lengthOfResidence']
      end

      if attributes.has_key?(:'pep')
        self.pep = attributes[:'pep']
      end

      if attributes.has_key?(:'sanction')
        self.sanction = attributes[:'sanction']
      end

      if attributes.has_key?(:'sdn')
        self.sdn = attributes[:'sdn']
      end

      if attributes.has_key?(:'shareLengthOfResidency')
        self.share_length_of_residency = attributes[:'shareLengthOfResidency']
      end
    ...
    def list_invalid_properties
      ...
      if @forward_address_links.nil?
        invalid_properties.push("invalid value for 'forward_address_links', forward_address_links cannot be nil.")
      end
      ...
      if @gone_away.nil?
        invalid_properties.push("invalid value for 'gone_away', gone_away cannot be nil.")
      end

      if @length_of_residence.nil?
        invalid_properties.push("invalid value for 'length_of_residence', length_of_residence cannot be nil.")
      end
      ...
      if @sanction.nil?
        invalid_properties.push("invalid value for 'sanction', sanction cannot be nil.")
      end

      if @sdn.nil?
        invalid_properties.push("invalid value for 'sdn', sdn cannot be nil.")
      end

      if @share_length_of_residency.nil?
        invalid_properties.push("invalid value for 'share_length_of_residency', share_length_of_residency cannot be nil.")
      end
    ...
    def valid?
      return false if @forward_address_links.nil?
      return false if @deceased.nil?
      return false if @gone_away.nil?
      return false if @length_of_residence.nil?
      return false if @pep.nil?
      return false if @sanction.nil?
      return false if @sdn.nil?
      return false if @share_length_of_residency.nil?
      return true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          forward_address_links == o.forward_address_links &&
          deceased == o.deceased &&
          gone_away == o.gone_away &&
          length_of_residence == o.length_of_residence &&
          pep == o.pep &&
          sanction == o.sanction &&
          sdn == o.sdn &&
          share_length_of_residency == o.share_length_of_residency
    end
    ...
    def hash
      [forward_address_links, deceased, gone_away, length_of_residence, pep, sanction, sdn, share_length_of_residency].hash
    end
