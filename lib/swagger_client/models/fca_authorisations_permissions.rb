...
module SwaggerClient
  ...
  class FCAAuthorisationsPermissions
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'activityDescription')
        self.activity_description = attributes[:'activityDescription']
      end
    ...
    def list_invalid_properties
      ...
      if @activity_category.nil?
        invalid_properties.push("invalid value for 'activity_category', activity_category cannot be nil.")
      end

      if @activity_description.nil?
        invalid_properties.push("invalid value for 'activity_description', activity_description cannot be nil.")
      end
    ...
    def valid?
      return false if @activity_category.nil?
      return false if @activity_description.nil?
      return true
    end
    ...
    def hash
      [activity_category, activity_description].hash
    end
