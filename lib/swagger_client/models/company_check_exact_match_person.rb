...
module SwaggerClient
  ...
  class CompanyCheckExactMatchPerson
    ...
    def self.swagger_types
      {
        ...
        :'middle_name' => :'String',
        :'last_name' => :'String',
        :'nationalities' => :'Array<SharedPersonMatchNationalities>',
    ...
    def hash
      [honorific, first_name, middle_name, last_name, nationalities, date_of_birth, officer_id].hash
    end
