...
module SwaggerClient
  ...
  class CompanyCreditReportCreditReportCountyCourtJudgmentsExactMatches
    ...
    def self.swagger_types
      {
        ...
        :'date' => :'Date',
        :'court' => :'String',
        :'amount' => :'CompanyCreditReportCreditReportCountyCourtJudgmentsAmount',
        :'status' => :'String',
        :'satisfied_date' => :'Date',
        :'address' => :'CompanyCheckResultsMatchedCompanyPersonServiceAddress'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'court')
        self.court = attributes[:'court']
      end
      ...
      if attributes.has_key?(:'satisfiedDate')
        self.satisfied_date = attributes[:'satisfiedDate']
      end
    ...
    def list_invalid_properties
      ...
      if @case_number.nil?
        invalid_properties.push("invalid value for 'case_number', case_number cannot be nil.")
      end
      ...
      if @court.nil?
        invalid_properties.push("invalid value for 'court', court cannot be nil.")
      end
      ...
      if @satisfied_date.nil?
        invalid_properties.push("invalid value for 'satisfied_date', satisfied_date cannot be nil.")
      end
    ...
    def valid?
      return false if @case_number.nil?
      return false if @date.nil?
      return false if @court.nil?
      return false if @amount.nil?
      return false if @status.nil?
      status_validator = EnumAttributeValidator.new('String', ["Unknown", "Satisfied", "Active judgment"])
      return false unless status_validator.valid?(@status)
      return false if @satisfied_date.nil?
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ["Unknown", "Satisfied", "Active judgment"])
    ...
    def hash
      [case_number, date, court, amount, status, satisfied_date, address].hash
    end
