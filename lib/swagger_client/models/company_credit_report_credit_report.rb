...
module SwaggerClient
  ...
  class CompanyCreditReportCreditReport
    attr_accessor :credit_rating

    attr_accessor :credit_limit

    attr_accessor :credit_score_history

    attr_accessor :credit_limit_history

    attr_accessor :commentary

    attr_accessor :county_court_judgments

    attr_accessor :payment_statistics
    ...
    def self.swagger_types
      {
        :'credit_rating' => :'CompanyCreditReportCreditReportCreditRating',
        :'credit_limit' => :'CompanyCreditReportCreditReportCreditLimit',
        :'credit_score_history' => :'Array<CompanyCreditReportCreditReportCreditScoreHistory>',
        :'credit_limit_history' => :'Array<CompanyCreditReportCreditReportCreditLimitHistory>',
        :'commentary' => :'Array<CompanyCreditReportCreditReportCommentary>',
        :'county_court_judgments' => :'CompanyCreditReportCreditReportCountyCourtJudgments',
        :'payment_statistics' => :'CompanyCreditReportCreditReportPaymentStatistics'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'creditRating')
        self.credit_rating = attributes[:'creditRating']
      end
      ...
      if attributes.has_key?(:'creditScoreHistory')
        if (value = attributes[:'creditScoreHistory']).is_a?(Array)
          self.credit_score_history = value
        end
      end

      if attributes.has_key?(:'creditLimitHistory')
        if (value = attributes[:'creditLimitHistory']).is_a?(Array)
          self.credit_limit_history = value
        end
      end

      if attributes.has_key?(:'commentary')
        if (value = attributes[:'commentary']).is_a?(Array)
      ...
      if attributes.has_key?(:'paymentStatistics')
        self.payment_statistics = attributes[:'paymentStatistics']
      end
    ...
    def list_invalid_properties
      ...
      if @credit_score_history.nil?
        invalid_properties.push("invalid value for 'credit_score_history', credit_score_history cannot be nil.")
      end

      if @credit_limit_history.nil?
        invalid_properties.push("invalid value for 'credit_limit_history', credit_limit_history cannot be nil.")
      end

      if @commentary.nil?
        invalid_properties.push("invalid value for 'commentary', commentary cannot be nil.")
      end
      ...
      if @payment_statistics.nil?
        invalid_properties.push("invalid value for 'payment_statistics', payment_statistics cannot be nil.")
      end
    ...
    def valid?
      ...
      return false if @credit_score_history.nil?
      return false if @credit_limit_history.nil?
      return false if @commentary.nil?
      return false if @county_court_judgments.nil?
      return false if @payment_statistics.nil?
      return true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          credit_score_history == o.credit_score_history &&
          credit_limit_history == o.credit_limit_history &&
          commentary == o.commentary &&
          county_court_judgments == o.county_court_judgments &&
          payment_statistics == o.payment_statistics
    end
    ...
    def hash
      [credit_rating, credit_limit, credit_score_history, credit_limit_history, commentary, county_court_judgments, payment_statistics].hash
    end
