...
module SwaggerClient
  # Company check result containing any relevant information and check warnings and/or failures
  class CompanyCheckResults
    attr_accessor :criteria

    attr_accessor :kyb_result

    attr_accessor :warnings

    attr_accessor :matched_company

    attr_accessor :picklist_companies

    attr_accessor :report_charged
    ...
    def self.swagger_types
      {
        :'criteria' => :'Object',
        :'kyb_result' => :'CompanyCheckResultsKybResult',
        :'warnings' => :'CompanyCheckResultsWarnings',
        :'matched_company' => :'CompanyCheckResultsMatchedCompany',
        :'picklist_companies' => :'Array<CompanyCheckResultsPicklistCompanies>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'kybResult')
        self.kyb_result = attributes[:'kybResult']
      end
      ...
      if attributes.has_key?(:'matchedCompany')
        self.matched_company = attributes[:'matchedCompany']
      end

      if attributes.has_key?(:'picklistCompanies')
        if (value = attributes[:'picklistCompanies']).is_a?(Array)
          self.picklist_companies = value
        end
      end

      if attributes.has_key?(:'reportCharged')
        self.report_charged = attributes[:'reportCharged']
      end
    ...
    def list_invalid_properties
      ...
      if @kyb_result.nil?
        invalid_properties.push("invalid value for 'kyb_result', kyb_result cannot be nil.")
      end
      ...
      if @matched_company.nil?
        invalid_properties.push("invalid value for 'matched_company', matched_company cannot be nil.")
      end

      if @picklist_companies.nil?
        invalid_properties.push("invalid value for 'picklist_companies', picklist_companies cannot be nil.")
      end

      if @report_charged.nil?
        invalid_properties.push("invalid value for 'report_charged', report_charged cannot be nil.")
      end
    ...
    def valid?
      ...
      return false if @kyb_result.nil?
      return false if @warnings.nil?
      return false if @matched_company.nil?
      return false if @picklist_companies.nil?
      return false if @report_charged.nil?
      return true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          criteria == o.criteria &&
          kyb_result == o.kyb_result &&
          warnings == o.warnings &&
          matched_company == o.matched_company &&
          picklist_companies == o.picklist_companies &&
          report_charged == o.report_charged
    end
    ...
    def hash
      [criteria, kyb_result, warnings, matched_company, picklist_companies, report_charged].hash
    end
