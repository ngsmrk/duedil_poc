...
module SwaggerClient
  ...
  class PEPsAndSanctionsDocument
    ...
    def self.swagger_types
      {
        ...
        :'date_collected' => :'Date',
        :'document_url' => :'String',
        :'categories' => :'Array<PEPsAndSanctionsDocumentCategories>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'originalUrl')
        self.original_url = attributes[:'originalUrl']
      end

      if attributes.has_key?(:'dateCollected')
        self.date_collected = attributes[:'dateCollected']
      end
    ...
    def hash
      [document_id, original_url, date_collected, document_url, categories].hash
    end
