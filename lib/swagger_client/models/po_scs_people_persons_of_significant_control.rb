...
module SwaggerClient
  ...
  class PoSCSPeoplePersonsOfSignificantControl
    attr_accessor :type
    ...
    attr_accessor :other_legal_entity

    attr_accessor :natures_of_control

    attr_accessor :is_shareholder
    ...
    def self.swagger_types
      {
        :'type' => :'String',
        :'person' => :'CompanyCheckResultsMatchedCompanyPerson',
        :'company' => :'CompanyCheckResultsMatchedCompanyCompany',
        :'other_legal_entity' => :'CompanyCheckResultsMatchedCompanyOtherLegalEntity',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'otherLegalEntity')
        self.other_legal_entity = attributes[:'otherLegalEntity']
      end

      if attributes.has_key?(:'naturesOfControl')
        if (value = attributes[:'naturesOfControl']).is_a?(Array)
          self.natures_of_control = value
        end
      end

      if attributes.has_key?(:'isShareholder')
        self.is_shareholder = attributes[:'isShareholder']
      end
    ...
    def list_invalid_properties
      ...
      if @other_legal_entity.nil?
        invalid_properties.push("invalid value for 'other_legal_entity', other_legal_entity cannot be nil.")
      end

      if @natures_of_control.nil?
        invalid_properties.push("invalid value for 'natures_of_control', natures_of_control cannot be nil.")
      end

      if @is_shareholder.nil?
        invalid_properties.push("invalid value for 'is_shareholder', is_shareholder cannot be nil.")
      end
    ...
    def valid?
      ...
      return false if @other_legal_entity.nil?
      return false if @natures_of_control.nil?
      return false if @is_shareholder.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          person == o.person &&
          company == o.company &&
          other_legal_entity == o.other_legal_entity &&
          natures_of_control == o.natures_of_control &&
          is_shareholder == o.is_shareholder &&
    ...
    def hash
      [type, person, company, other_legal_entity, natures_of_control, is_shareholder, exact_matches, possible_matches].hash
    end
