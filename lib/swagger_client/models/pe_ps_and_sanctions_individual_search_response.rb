...
module SwaggerClient
  ...
  class PEPsAndSanctionsIndividualSearchResponse
    ...
    def self.swagger_types
      {
        ...
        :'possible_matches' => :'Array<PEPsAndSanctionsPossibleIndividualMatch>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'totalMatches')
        self.total_matches = attributes[:'totalMatches']
      end
    ...
    def hash
      [total_matches, possible_matches].hash
    end
