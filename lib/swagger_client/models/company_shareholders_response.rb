...
module SwaggerClient
  ...
  class CompanyShareholdersResponse
    ...
    def self.swagger_types
      {
        ...
        :'shareholders' => :'Array<CompanyShareholdersShareholders>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'shareholders')
        if (value = attributes[:'shareholders']).is_a?(Array)
          self.shareholders = value
        end
      end
    ...
    def list_invalid_properties
      ...
      if @shareholders.nil?
        invalid_properties.push("invalid value for 'shareholders', shareholders cannot be nil.")
      end
    ...
    def valid?
      ...
      return false if @shareholders.nil?
      return true
    end
    ...
    def hash
      [country_code, company_id, pagination, total_company_shares, shareholders].hash
    end
