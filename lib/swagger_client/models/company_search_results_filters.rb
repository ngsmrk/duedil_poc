...
module SwaggerClient
  ...
  class CompanySearchResultsFilters
    ...
    # Optional company addresses issued in the search request
    ...
    # Optional range of total asset delta percentages issued in the search request
    ...
    def self.swagger_types
      {
        :'name' => :'String',
        :'domain_names' => :'CompanySearchResultsFiltersDomainNames',
        :'keywords' => :'CompanySearchResultsFiltersKeywords',
        :'country_codes' => :'CompanySearchResultsFiltersCountryCodes',
        :'simplified_statuses' => :'CompanySearchResultsFiltersSimplifiedStatuses',
        :'regions' => :'Object',
        :'industries' => :'Object',
        :'incorporated' => :'CompanySearchResultsFiltersIncorporated',
        :'employees_value' => :'CompanySearchResultsFiltersEmployeesValue',
        :'employees_delta_percentage' => :'CompanySearchResultsFiltersEmployeesDeltaPercentage',
        :'turnover_value' => :'CompanySearchResultsFiltersTurnoverValue',
        :'turnover_delta_percentage' => :'CompanySearchResultsFiltersTurnoverDeltaPercentage',
        :'ebitda_value' => :'CompanySearchResultsFiltersEbitdaValue',
        :'ebitda_delta_percentage' => :'CompanySearchResultsFiltersEbitdaDeltaPercentage',
        :'net_assets_value' => :'CompanySearchResultsFiltersNetAssetsValue',
        :'net_assets_delta_percentage' => :'CompanySearchResultsFiltersNetAssetsDeltaPercentage',
        :'total_assets_value' => :'CompanySearchResultsFiltersTotalAssetsValue',
        :'total_assets_delta_percentage' => :'Object',
        :'post_tax_profit_value' => :'CompanySearchResultsFiltersPostTaxProfitValue',
        :'post_tax_profit_delta_percentage' => :'CompanySearchResultsFiltersPostTaxProfitDeltaPercentage'
      }
    end
