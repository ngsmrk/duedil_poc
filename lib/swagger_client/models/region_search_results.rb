...
module SwaggerClient
  # Confirmation of optional search filters used in the request
  class RegionSearchResults
    ...
    def self.swagger_types
      {
        :'filters' => :'RegionSearchResultsFilters',
        :'regions' => :'Array<RegionSearchResultsRegions>'
      }
    end
