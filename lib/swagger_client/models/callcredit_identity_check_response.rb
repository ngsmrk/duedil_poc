...
module SwaggerClient
  ...
  class CallcreditIdentityCheckResponse
    # CallValidate reference number, please use this if contacting Callcredit regarding this query.
    attr_accessor :call_validate_reference

    attr_accessor :match_summary
    ...
    attr_accessor :electoral_roll

    attr_accessor :deceased

    attr_accessor :county_court_judgments

    attr_accessor :bankruptcy_or_insolvency

    attr_accessor :callcredit_share

    attr_accessor :notice_of_corrections

    attr_accessor :extra_checks
    ...
    def self.swagger_types
      {
        ...
        :'match_summary' => :'CallcreditIdentityCheckResponseMatchSummary',
        :'score_card' => :'CallcreditIdentityCheckResponseScoreCard',
        :'warnings' => :'CallcreditIdentityCheckResponseWarnings',
        :'name' => :'CallcreditIdentityCheckResponseName',
        :'address' => :'CallcreditIdentityCheckResponseAddress',
        :'date_of_birth' => :'CallcreditIdentityCheckResponseDateOfBirth',
        :'electoral_roll' => :'CallcreditIdentityCheckResponseElectoralRoll',
        :'deceased' => :'CallcreditIdentityCheckResponseDeceased',
        :'county_court_judgments' => :'CallcreditIdentityCheckResponseCountyCourtJudgments',
        :'bankruptcy_or_insolvency' => :'CallcreditIdentityCheckResponseBankruptcyOrInsolvency',
        :'callcredit_share' => :'CallcreditIdentityCheckResponseCallcreditSHARE',
        :'notice_of_corrections' => :'String',
        :'extra_checks' => :'CallcreditIdentityCheckResponseExtraChecks'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'callValidateReference')
        self.call_validate_reference = attributes[:'callValidateReference']
      end

      if attributes.has_key?(:'matchSummary')
        self.match_summary = attributes[:'matchSummary']
      end

      if attributes.has_key?(:'scoreCard')
        self.score_card = attributes[:'scoreCard']
      end
      ...
      if attributes.has_key?(:'electoralRoll')
        self.electoral_roll = attributes[:'electoralRoll']
      end

      if attributes.has_key?(:'deceased')
        self.deceased = attributes[:'deceased']
      end

      if attributes.has_key?(:'countyCourtJudgments')
        self.county_court_judgments = attributes[:'countyCourtJudgments']
      end

      if attributes.has_key?(:'bankruptcyOrInsolvency')
        self.bankruptcy_or_insolvency = attributes[:'bankruptcyOrInsolvency']
      end

      if attributes.has_key?(:'callcreditSHARE')
        self.callcredit_share = attributes[:'callcreditSHARE']
      end

      if attributes.has_key?(:'noticeOfCorrections')
        self.notice_of_corrections = attributes[:'noticeOfCorrections']
      end

      if attributes.has_key?(:'extraChecks')
        self.extra_checks = attributes[:'extraChecks']
      end
    ...
    def list_invalid_properties
      ...
      if @call_validate_reference.nil?
        invalid_properties.push("invalid value for 'call_validate_reference', call_validate_reference cannot be nil.")
      end

      if @match_summary.nil?
        invalid_properties.push("invalid value for 'match_summary', match_summary cannot be nil.")
      end

      if @score_card.nil?
        invalid_properties.push("invalid value for 'score_card', score_card cannot be nil.")
      end
      ...
      if @electoral_roll.nil?
        invalid_properties.push("invalid value for 'electoral_roll', electoral_roll cannot be nil.")
      end

      if @deceased.nil?
        invalid_properties.push("invalid value for 'deceased', deceased cannot be nil.")
      end

      if @county_court_judgments.nil?
        invalid_properties.push("invalid value for 'county_court_judgments', county_court_judgments cannot be nil.")
      end

      if @bankruptcy_or_insolvency.nil?
        invalid_properties.push("invalid value for 'bankruptcy_or_insolvency', bankruptcy_or_insolvency cannot be nil.")
      end

      if @callcredit_share.nil?
        invalid_properties.push("invalid value for 'callcredit_share', callcredit_share cannot be nil.")
      end

      if @notice_of_corrections.nil?
        invalid_properties.push("invalid value for 'notice_of_corrections', notice_of_corrections cannot be nil.")
      end

      if @extra_checks.nil?
        invalid_properties.push("invalid value for 'extra_checks', extra_checks cannot be nil.")
      end
    ...
    def valid?
      return false if @call_validate_reference.nil?
      return false if @match_summary.nil?
      return false if @score_card.nil?
      return false if @warnings.nil?
      return false if @name.nil?
      return false if @address.nil?
      return false if @date_of_birth.nil?
      return false if @electoral_roll.nil?
      return false if @deceased.nil?
      return false if @county_court_judgments.nil?
      return false if @bankruptcy_or_insolvency.nil?
      return false if @callcredit_share.nil?
      return false if @notice_of_corrections.nil?
      return false if @extra_checks.nil?
      return true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          call_validate_reference == o.call_validate_reference &&
          ...
          electoral_roll == o.electoral_roll &&
          deceased == o.deceased &&
          county_court_judgments == o.county_court_judgments &&
          bankruptcy_or_insolvency == o.bankruptcy_or_insolvency &&
          callcredit_share == o.callcredit_share &&
          notice_of_corrections == o.notice_of_corrections &&
          extra_checks == o.extra_checks
    end
    ...
    def hash
      [call_validate_reference, match_summary, score_card, warnings, name, address, date_of_birth, electoral_roll, deceased, county_court_judgments, bankruptcy_or_insolvency, callcredit_share, notice_of_corrections, extra_checks].hash
    end
