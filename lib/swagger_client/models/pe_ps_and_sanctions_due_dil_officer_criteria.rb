...
module SwaggerClient
  ...
  class PEPsAndSanctionsDueDilOfficerCriteria
    attr_accessor :duedil_officer
    ...
    def self.swagger_types
      {
        :'duedil_officer' => :'PEPsAndSanctionsDueDilOfficerCriteriaDuedilOfficer'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'duedilOfficer')
        self.duedil_officer = attributes[:'duedilOfficer']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          duedil_officer == o.duedil_officer
    end
