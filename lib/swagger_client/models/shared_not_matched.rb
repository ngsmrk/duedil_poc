...
module SwaggerClient
  ...
  class SharedNotMatched
    attr_accessor :suspected_type
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'suspectedType')
        self.suspected_type = attributes[:'suspectedType']
      end
    ...
    def list_invalid_properties
      ...
      if @suspected_type.nil?
        invalid_properties.push("invalid value for 'suspected_type', suspected_type cannot be nil.")
      end
    ...
    def valid?
      return false if @suspected_type.nil?
      suspected_type_validator = EnumAttributeValidator.new('String', ["person", "company"])
      return false unless suspected_type_validator.valid?(@suspected_type)
      return true
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] suspected_type Object to be assigned
    def suspected_type=(suspected_type)
      validator = EnumAttributeValidator.new('String', ["person", "company"])
      unless validator.valid?(suspected_type)
        fail ArgumentError, "invalid value for 'suspected_type', must be one of #{validator.allowable_values}."
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          suspected_type == o.suspected_type
    end
