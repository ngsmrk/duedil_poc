...
module SwaggerClient
  ...
  class CallcreditIdentityCheckResponseElectoralRoll
    # 1 = individual found on current Annual Electoral Register; 3 = individual found on previous Annual Electoral Register; 4 = individual found on current Rolling Electoral Register; 5 = individual found on previous Rolling Electoral Register
    attr_accessor :er_match

    attr_accessor :er_level_of_confidence
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'erMatch')
        self.er_match = attributes[:'erMatch']
      end

      if attributes.has_key?(:'erLevelOfConfidence')
        self.er_level_of_confidence = attributes[:'erLevelOfConfidence']
      end
    ...
    def list_invalid_properties
      ...
      if @er_match.nil?
        invalid_properties.push("invalid value for 'er_match', er_match cannot be nil.")
      end

      if @er_level_of_confidence.nil?
        invalid_properties.push("invalid value for 'er_level_of_confidence', er_level_of_confidence cannot be nil.")
      end
    ...
    def valid?
      return false if @er_match.nil?
      return false if @er_level_of_confidence.nil?
      return true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          er_match == o.er_match &&
          er_level_of_confidence == o.er_level_of_confidence
    end
    ...
    def hash
      [er_match, er_level_of_confidence].hash
    end
