...
module SwaggerClient
  ...
  class PEPsAndSanctionsSanction
    attr_accessor :type
    ...
    def self.swagger_types
      {
        :'type' => :'PEPsAndSanctionsSanctionType',
        :'is_current' => :'BOOLEAN'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'isCurrent')
        self.is_current = attributes[:'isCurrent']
      end
