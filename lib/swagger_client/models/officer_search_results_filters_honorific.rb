...
module SwaggerClient
  # Optional officer title issued in the search request
  class OfficerSearchResultsFiltersHonorific
    ...
    def valid?
      ...
      mode_validator = EnumAttributeValidator.new('String', ["any"])
    ...
    def mode=(mode)
      validator = EnumAttributeValidator.new('String', ["any"])
