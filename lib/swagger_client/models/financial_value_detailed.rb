...
module SwaggerClient
  ...
  class FinancialValueDetailed
    attr_accessor :value

    attr_accessor :delta_absolute

    attr_accessor :delta_percentage

    attr_accessor :three_year_cagr
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'deltaAbsolute')
        self.delta_absolute = attributes[:'deltaAbsolute']
      end

      if attributes.has_key?(:'deltaPercentage')
        self.delta_percentage = attributes[:'deltaPercentage']
      end

      if attributes.has_key?(:'threeYearCAGR')
        self.three_year_cagr = attributes[:'threeYearCAGR']
      end

      if attributes.has_key?(:'fiveYearCAGR')
        self.five_year_cagr = attributes[:'fiveYearCAGR']
      end

      if attributes.has_key?(:'tenYearCAGR')
        self.ten_year_cagr = attributes[:'tenYearCAGR']
      end
    ...
    def list_invalid_properties
      ...
      if @delta_absolute.nil?
        invalid_properties.push("invalid value for 'delta_absolute', delta_absolute cannot be nil.")
      end

      if @delta_percentage.nil?
        invalid_properties.push("invalid value for 'delta_percentage', delta_percentage cannot be nil.")
      end

      if @three_year_cagr.nil?
        invalid_properties.push("invalid value for 'three_year_cagr', three_year_cagr cannot be nil.")
      end

      if @five_year_cagr.nil?
        invalid_properties.push("invalid value for 'five_year_cagr', five_year_cagr cannot be nil.")
      end

      if @ten_year_cagr.nil?
        invalid_properties.push("invalid value for 'ten_year_cagr', ten_year_cagr cannot be nil.")
      end
    ...
    def valid?
      ...
      return false if @delta_absolute.nil?
      return false if @delta_percentage.nil?
      return false if @three_year_cagr.nil?
      return false if @five_year_cagr.nil?
      return false if @ten_year_cagr.nil?
      return true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          value == o.value &&
          delta_absolute == o.delta_absolute &&
          delta_percentage == o.delta_percentage &&
          three_year_cagr == o.three_year_cagr &&
          five_year_cagr == o.five_year_cagr &&
          ten_year_cagr == o.ten_year_cagr
    end
    ...
    def hash
      [value, delta_absolute, delta_percentage, three_year_cagr, five_year_cagr, ten_year_cagr].hash
    end
