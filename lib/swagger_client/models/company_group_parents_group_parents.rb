...
module SwaggerClient
  ...
  class CompanyGroupParentsGroupParents
    ...
    attr_accessor :degree_of_separation

    attr_accessor :is_immediate_parent

    attr_accessor :is_ultimate_parent
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'degreeOfSeparation')
        self.degree_of_separation = attributes[:'degreeOfSeparation']
      end

      if attributes.has_key?(:'isImmediateParent')
        self.is_immediate_parent = attributes[:'isImmediateParent']
      end

      if attributes.has_key?(:'isUltimateParent')
        self.is_ultimate_parent = attributes[:'isUltimateParent']
      end
    ...
    def list_invalid_properties
      ...
      if @degree_of_separation.nil?
        invalid_properties.push("invalid value for 'degree_of_separation', degree_of_separation cannot be nil.")
      end

      if @is_immediate_parent.nil?
        invalid_properties.push("invalid value for 'is_immediate_parent', is_immediate_parent cannot be nil.")
      end

      if @is_ultimate_parent.nil?
        invalid_properties.push("invalid value for 'is_ultimate_parent', is_ultimate_parent cannot be nil.")
      end
    ...
    def valid?
      ...
      return false if @degree_of_separation.nil?
      return false if @is_immediate_parent.nil?
      return false if @is_ultimate_parent.nil?
      return true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          name == o.name &&
          degree_of_separation == o.degree_of_separation &&
          is_immediate_parent == o.is_immediate_parent &&
          is_ultimate_parent == o.is_ultimate_parent
    end
    ...
    def hash
      [country_code, company_id, name, degree_of_separation, is_immediate_parent, is_ultimate_parent].hash
    end
