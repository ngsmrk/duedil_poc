...
module SwaggerClient
  ...
  class PEPsAndSanctionsDatasetSummary
    attr_accessor :peps

    attr_accessor :sanctions_current

    attr_accessor :sanctions_previous

    attr_accessor :law_enforcement

    attr_accessor :financial_regulator_penalties

    attr_accessor :disqualified_directors

    attr_accessor :insolvencies
    ...
    def self.swagger_types
      {
        :'peps' => :'BOOLEAN',
        :'sanctions_current' => :'BOOLEAN',
        :'sanctions_previous' => :'BOOLEAN',
        :'law_enforcement' => :'BOOLEAN',
        :'financial_regulator_penalties' => :'BOOLEAN',
        :'disqualified_directors' => :'BOOLEAN',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'peps')
        self.peps = attributes[:'peps']
      else
        self.peps = true
      end

      if attributes.has_key?(:'sanctionsCurrent')
        self.sanctions_current = attributes[:'sanctionsCurrent']
      else
        self.sanctions_current = true
      end

      if attributes.has_key?(:'sanctionsPrevious')
        self.sanctions_previous = attributes[:'sanctionsPrevious']
      else
        self.sanctions_previous = true
      end

      if attributes.has_key?(:'lawEnforcement')
        self.law_enforcement = attributes[:'lawEnforcement']
      else
        self.law_enforcement = true
      end

      if attributes.has_key?(:'financialRegulatorPenalties')
        self.financial_regulator_penalties = attributes[:'financialRegulatorPenalties']
      else
        self.financial_regulator_penalties = true
      end

      if attributes.has_key?(:'disqualifiedDirectors')
        self.disqualified_directors = attributes[:'disqualifiedDirectors']
      else
        self.disqualified_directors = true
      end

      if attributes.has_key?(:'insolvencies')
        self.insolvencies = attributes[:'insolvencies']
      else
        self.insolvencies = true
      end

      if attributes.has_key?(:'adverseMedia')
        self.adverse_media = attributes[:'adverseMedia']
      else
        self.adverse_media = true
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          peps == o.peps &&
          sanctions_current == o.sanctions_current &&
          sanctions_previous == o.sanctions_previous &&
          law_enforcement == o.law_enforcement &&
          financial_regulator_penalties == o.financial_regulator_penalties &&
          disqualified_directors == o.disqualified_directors &&
          insolvencies == o.insolvencies &&
    ...
    def hash
      [peps, sanctions_current, sanctions_previous, law_enforcement, financial_regulator_penalties, disqualified_directors, insolvencies, adverse_media].hash
    end
