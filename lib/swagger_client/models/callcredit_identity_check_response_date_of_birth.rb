...
module SwaggerClient
  ...
  class CallcreditIdentityCheckResponseDateOfBirth
    # Number of dates of birth confirmed against Callcredit's SHARE records used in the decision
    attr_accessor :dob_confirmed_records

    attr_accessor :dob_total_records

    attr_accessor :dob_level_of_confidence
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'dobConfirmedRecords')
        self.dob_confirmed_records = attributes[:'dobConfirmedRecords']
      end

      if attributes.has_key?(:'dobTotalRecords')
        self.dob_total_records = attributes[:'dobTotalRecords']
      end

      if attributes.has_key?(:'dobLevelOfConfidence')
        self.dob_level_of_confidence = attributes[:'dobLevelOfConfidence']
      end
    ...
    def list_invalid_properties
      ...
      if @dob_confirmed_records.nil?
        invalid_properties.push("invalid value for 'dob_confirmed_records', dob_confirmed_records cannot be nil.")
      end

      if @dob_total_records.nil?
        invalid_properties.push("invalid value for 'dob_total_records', dob_total_records cannot be nil.")
      end

      if @dob_level_of_confidence.nil?
        invalid_properties.push("invalid value for 'dob_level_of_confidence', dob_level_of_confidence cannot be nil.")
      end
    ...
    def valid?
      return false if @dob_confirmed_records.nil?
      return false if @dob_total_records.nil?
      return false if @dob_level_of_confidence.nil?
      return true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          dob_confirmed_records == o.dob_confirmed_records &&
          dob_total_records == o.dob_total_records &&
          dob_level_of_confidence == o.dob_level_of_confidence
    end
    ...
    def hash
      [dob_confirmed_records, dob_total_records, dob_level_of_confidence].hash
    end
