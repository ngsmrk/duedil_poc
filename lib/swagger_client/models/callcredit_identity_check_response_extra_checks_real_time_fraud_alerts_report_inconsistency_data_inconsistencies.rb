...
module SwaggerClient
  ...
  class CallcreditIdentityCheckResponseExtraChecksRealTimeFraudAlertsReportInconsistencyDataInconsistencies
    # The ‘Type’ attribute defines the Inconsistency data item which does not match the input data that the results have been generated for. The ‘Type’ attribute can be one of the following below.
    attr_accessor :type

    # The date and time that the input data items were last seen inconsistently, within the VelocityPeriod and Level* set in the configuration.
    attr_accessor :last_seen

    # The number of times that distinct inconsistent data has been seen, within the VelocityPeriod and Level* set in the configuration.
    attr_accessor :times_seen

    # If the TimesSeen exceeds the InconsistencyThreshold set in the configuration this will be ‘true’, otherwise ‘false’.
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'timesSeen')
        self.times_seen = attributes[:'timesSeen']
      end
    ...
    def valid?
      type_validator = EnumAttributeValidator.new('String', ["Identity", "Address", "DateOfBirth", "BankDetails", "CardDetails", "EmailAddress", "IPAddress", "TelephoneNumber"])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["Identity", "Address", "DateOfBirth", "BankDetails", "CardDetails", "EmailAddress", "IPAddress", "TelephoneNumber"])
    ...
    def hash
      [type, last_seen, times_seen, warning].hash
    end
