...
module SwaggerClient
  ...
  class CallcreditIdentityCheckResponseCountyCourtJudgments
    # Number of County Court Judgments (CCJs) listed against the individual
    attr_accessor :ccj_count

    attr_accessor :ccj_level_of_confidence
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ccjCount')
        self.ccj_count = attributes[:'ccjCount']
      end

      if attributes.has_key?(:'ccjLevelOfConfidence')
        self.ccj_level_of_confidence = attributes[:'ccjLevelOfConfidence']
      end
    ...
    def list_invalid_properties
      ...
      if @ccj_count.nil?
        invalid_properties.push("invalid value for 'ccj_count', ccj_count cannot be nil.")
      end

      if @ccj_level_of_confidence.nil?
        invalid_properties.push("invalid value for 'ccj_level_of_confidence', ccj_level_of_confidence cannot be nil.")
      end
    ...
    def valid?
      return false if @ccj_count.nil?
      return false if @ccj_level_of_confidence.nil?
      return true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ccj_count == o.ccj_count &&
          ccj_level_of_confidence == o.ccj_level_of_confidence
    end
    ...
    def hash
      [ccj_count, ccj_level_of_confidence].hash
    end
