...
module SwaggerClient
  ...
  class PEPsAndSanctionsDueDilCompanyCriteria
    attr_accessor :duedil_company
    ...
    def self.swagger_types
      {
        :'duedil_company' => :'PEPsAndSanctionsDueDilCompanyCriteriaDuedilCompany'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'duedilCompany')
        self.duedil_company = attributes[:'duedilCompany']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          duedil_company == o.duedil_company
    end
