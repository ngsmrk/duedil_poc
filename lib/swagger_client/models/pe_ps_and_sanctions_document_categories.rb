...
module SwaggerClient
  ...
  class PEPsAndSanctionsDocumentCategories
    attr_accessor :name
    ...
    def valid?
      name_validator = EnumAttributeValidator.new('String', ["Adverse Media", "Corporate/Business", "Disqualified Director", "Financial Regulator", "ID/V", "Insolvent", "Law Enforcement", "PEP", "Sanction"])
    ...
    def name=(name)
      validator = EnumAttributeValidator.new('String', ["Adverse Media", "Corporate/Business", "Disqualified Director", "Financial Regulator", "ID/V", "Insolvent", "Law Enforcement", "PEP", "Sanction"])
