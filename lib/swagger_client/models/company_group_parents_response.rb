...
module SwaggerClient
  ...
  class CompanyGroupParentsResponse
    ...
    def self.swagger_types
      {
        ...
        :'group_parents' => :'Array<CompanyGroupParentsGroupParents>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'groupParents')
        if (value = attributes[:'groupParents']).is_a?(Array)
          self.group_parents = value
        end
      end
    ...
    def list_invalid_properties
      ...
      if @group_parents.nil?
        invalid_properties.push("invalid value for 'group_parents', group_parents cannot be nil.")
      end
    ...
    def valid?
      ...
      return false if @group_parents.nil?
      return true
    end
    ...
    def hash
      [country_code, company_id, pagination, group_parents].hash
    end
