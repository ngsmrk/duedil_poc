...
module SwaggerClient
  ...
  class CompanyCheckResultsMatchedCompanyCompany
    ...
    def self.swagger_types
      {
        :'source_name' => :'String',
        :'office_address' => :'CompanyCheckResultsMatchedCompanyPersonServiceAddress',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'officeAddress')
        self.office_address = attributes[:'officeAddress']
      end
    ...
    def list_invalid_properties
      ...
      if @office_address.nil?
        invalid_properties.push("invalid value for 'office_address', office_address cannot be nil.")
      end
    ...
    def valid?
      ...
      return false if @office_address.nil?
    ...
    def hash
      [source_name, office_address, registration_number].hash
    end
