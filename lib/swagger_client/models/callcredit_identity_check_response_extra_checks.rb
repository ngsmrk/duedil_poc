...
module SwaggerClient
  ...
  class CallcreditIdentityCheckResponseExtraChecks
    attr_accessor :email_risk

    attr_accessor :real_time_fraud_alerts
    ...
    def self.swagger_types
      {
        :'email_risk' => :'CallcreditIdentityCheckResponseExtraChecksEmailRisk',
        :'real_time_fraud_alerts' => :'CallcreditIdentityCheckResponseExtraChecksRealTimeFraudAlerts'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'emailRisk')
        self.email_risk = attributes[:'emailRisk']
      end

      if attributes.has_key?(:'realTimeFraudAlerts')
        self.real_time_fraud_alerts = attributes[:'realTimeFraudAlerts']
      end
    ...
    def list_invalid_properties
      ...
      if @email_risk.nil?
        invalid_properties.push("invalid value for 'email_risk', email_risk cannot be nil.")
      end

      if @real_time_fraud_alerts.nil?
        invalid_properties.push("invalid value for 'real_time_fraud_alerts', real_time_fraud_alerts cannot be nil.")
      end
    ...
    def valid?
      return false if @email_risk.nil?
      return false if @real_time_fraud_alerts.nil?
      return true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          email_risk == o.email_risk &&
          real_time_fraud_alerts == o.real_time_fraud_alerts
    end
    ...
    def hash
      [email_risk, real_time_fraud_alerts].hash
    end
