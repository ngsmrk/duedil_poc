...
module SwaggerClient
  ...
  class CompanyCheckResultsMatchedCompanyUltimateParents
    ...
    def hash
      [country_code, company_id, name, total_company_shares, number_of_shareholders, shareholders_greater_or_equal_ten_percent].hash
    end
