...
module SwaggerClient
  ...
  class KeyCompanyInformation
    # Registered company name
    attr_accessor :name

    # Jurisdiction-specific company type
    attr_accessor :type

    attr_accessor :incorporation_country

    # Incorporation date in ISO 8601 date format (YYYY-MM-DD)
    attr_accessor :incorporation_date

    # Jurisdiction-specific company status
    ...
    # The number of charities reporting this company as their corporate identity
    attr_accessor :charitable_identities_count
    ...
    def self.swagger_types
      {
        ...
        :'accounts' => :'KeyCompanyInformationAccounts',
        :'financial_summary' => :'KeyCompanyInformationFinancialSummary'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'charitableIdentitiesCount')
        self.charitable_identities_count = attributes[:'charitableIdentitiesCount']
      end
      ...
      if attributes.has_key?(:'financialSummary')
        self.financial_summary = attributes[:'financialSummary']
      end
    ...
    def list_invalid_properties
      ...
      if @charitable_identities_count.nil?
        invalid_properties.push("invalid value for 'charitable_identities_count', charitable_identities_count cannot be nil.")
      end
    ...
    def valid?
      ...
      return false if @charitable_identities_count.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          charitable_identities_count == o.charitable_identities_count &&
          accounts == o.accounts &&
    ...
    def hash
      [name, type, incorporation_country, incorporation_date, official_status, simplified_status, number_of_employees, primary_website, registered_address, charitable_identities_count, accounts, financial_summary].hash
    end
