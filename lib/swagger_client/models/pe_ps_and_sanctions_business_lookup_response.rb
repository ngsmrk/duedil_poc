...
module SwaggerClient
  ...
  class PEPsAndSanctionsBusinessLookupResponse
    ...
    def self.swagger_types
      {
        ...
        :'linked_businesses' => :'Array<PEPsAndSanctionsBusinessLinkedToBusiness>',
        :'linked_individuals' => :'Array<PEPsAndSanctionsIndividualLinkedToBusiness>',
        :'related_names' => :'Array<PEPsAndSanctionsRelatedName>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'relatedNames')
        if (value = attributes[:'relatedNames']).is_a?(Array)
          self.related_names = value
        end
      end
    ...
    def list_invalid_properties
      ...
      if @related_names.nil?
        invalid_properties.push("invalid value for 'related_names', related_names cannot be nil.")
      end
    ...
    def valid?
      ...
      return false if @related_names.nil?
      return true
    end
    ...
    def hash
      [lookup_id, name, website, telephone, fax, addresses, global_datasets, documents, sanctions, notes, linked_businesses, linked_individuals, related_names].hash
    end
