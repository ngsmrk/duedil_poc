...
module SwaggerClient
  ...
  class OfficerSearchResultsFilters
    # Optional officer name issued in the search request
    attr_accessor :name

    # Optional officer disqualification flag issued in the search request
    attr_accessor :is_disqualified

    # Optional officer corporate flag issued in the search request
    ...
    def self.swagger_types
      {
        ...
        :'date_of_birth' => :'OfficerSearchResultsFiltersDateOfBirth',
        :'honorific' => :'OfficerSearchResultsFiltersHonorific'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'isDisqualified')
        self.is_disqualified = attributes[:'isDisqualified']
      end
    ...
    def hash
      [name, is_disqualified, is_corporate, date_of_birth, honorific].hash
    end
