...
module SwaggerClient
  ...
  class OfficerSearchCriteriaCriteria
    # Registered officer name
    attr_accessor :name

    # Officers who have a current disqualification from acting as officer under UK company law
    attr_accessor :is_disqualified

    # Officers who have been matched to a known company
    ...
    def self.swagger_types
      {
        ...
        :'date_of_birth' => :'OfficerSearchCriteriaCriteriaDateOfBirth',
        :'honorific' => :'OfficerSearchCriteriaCriteriaHonorific'
      }
    end
