...
module SwaggerClient
  ...
  class CallcreditIdentityCheckResponseCallcreditSHARE
    # Number of records found for the individual on Callcredit's SHARE database
    attr_accessor :share_record_count

    attr_accessor :share_level_of_confidence
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'shareRecordCount')
        self.share_record_count = attributes[:'shareRecordCount']
      end

      if attributes.has_key?(:'shareLevelOfConfidence')
        self.share_level_of_confidence = attributes[:'shareLevelOfConfidence']
      end
    ...
    def list_invalid_properties
      ...
      if @share_record_count.nil?
        invalid_properties.push("invalid value for 'share_record_count', share_record_count cannot be nil.")
      end

      if @share_level_of_confidence.nil?
        invalid_properties.push("invalid value for 'share_level_of_confidence', share_level_of_confidence cannot be nil.")
      end
    ...
    def valid?
      return false if @share_record_count.nil?
      return false if @share_level_of_confidence.nil?
      return true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          share_record_count == o.share_record_count &&
          share_level_of_confidence == o.share_level_of_confidence
    end
    ...
    def hash
      [share_record_count, share_level_of_confidence].hash
    end
