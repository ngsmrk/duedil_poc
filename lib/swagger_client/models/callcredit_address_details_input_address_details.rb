...
module SwaggerClient
  # Mandatory fields are buildingName or buildingNumber or abodeNumber and postcode. If a flat or apartment is being searched, please supply this in abodeNumber and also provide buildingName or buildingNumber and postcode.
  class CallcreditAddressDetailsInputAddressDetails
    attr_accessor :building_name

    attr_accessor :building_number

    attr_accessor :abode_number
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'abodeNumber')
        self.abode_number = attributes[:'abodeNumber']
      end
    ...
    def list_invalid_properties
      ...
      if !@building_name.nil? && @building_name.to_s.length > 50
        invalid_properties.push("invalid value for 'building_name', the character length must be smaller than or equal to 50.")
      end

      if !@building_number.nil? && @building_number.to_s.length > 50
        invalid_properties.push("invalid value for 'building_number', the character length must be smaller than or equal to 50.")
      end

      if !@abode_number.nil? && @abode_number.to_s.length > 50
        invalid_properties.push("invalid value for 'abode_number', the character length must be smaller than or equal to 50.")
      end
      ...
      if !@town.nil? && @town.to_s.length > 25
        invalid_properties.push("invalid value for 'town', the character length must be smaller than or equal to 25.")
      end
      ...
      if @postcode.to_s.length > 8
        invalid_properties.push("invalid value for 'postcode', the character length must be smaller than or equal to 8.")
      end
    ...
    def valid?
      return false if !@building_name.nil? && @building_name.to_s.length > 50
      return false if !@building_number.nil? && @building_number.to_s.length > 50
      return false if !@abode_number.nil? && @abode_number.to_s.length > 50
      ...
      return false if !@town.nil? && @town.to_s.length > 25
      return false if @postcode.nil?
      return false if @postcode.to_s.length > 8
      return true
    end
    ...
    def building_name=(building_name)
      ...
      if !building_name.nil? && building_name.to_s.length > 50
        fail ArgumentError, "invalid value for 'building_name', the character length must be smaller than or equal to 50."
      end
    ...
    def building_number=(building_number)
      ...
      if !building_number.nil? && building_number.to_s.length > 50
        fail ArgumentError, "invalid value for 'building_number', the character length must be smaller than or equal to 50."
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] abode_number Value to be assigned
    def abode_number=(abode_number)

      if !abode_number.nil? && abode_number.to_s.length > 50
        fail ArgumentError, "invalid value for 'abode_number', the character length must be smaller than or equal to 50."
      end

      @abode_number = abode_number
    end
    ...
    def town=(town)
      ...
      if !town.nil? && town.to_s.length > 25
        fail ArgumentError, "invalid value for 'town', the character length must be smaller than or equal to 25."
      end
    ...
    def postcode=(postcode)
      ...
      if postcode.to_s.length > 8
        fail ArgumentError, "invalid value for 'postcode', the character length must be smaller than or equal to 8."
      end
    ...
    def hash
      [building_name, building_number, abode_number, address1, address2, address3, town, postcode].hash
    end
