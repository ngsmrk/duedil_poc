...
module SwaggerClient
  ...
  class CompanyCreditReportCreditReportPaymentStatisticsInvoicesPaidBeforeThreshold
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'percentageOfTotal')
        self.percentage_of_total = attributes[:'percentageOfTotal']
      end
    ...
    def list_invalid_properties
      ...
      if @percentage_of_total.nil?
        invalid_properties.push("invalid value for 'percentage_of_total', percentage_of_total cannot be nil.")
      end
    ...
    def valid?
      ...
      return false if @percentage_of_total.nil?
      return true
    end
    ...
    def hash
      [number, percentage_of_total].hash
    end
