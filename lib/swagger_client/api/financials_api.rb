...
module SwaggerClient
  class FinancialsApi
    ...
    def company_country_code_company_id_financials_format_get(country_code, company_id, format, opts = {})
      data, _status_code, _headers = company_country_code_company_id_financials_format_get_with_http_info(country_code, company_id, format, opts)
      return data
    end
    ...
    # @return [Array<(CompanyFinancialsResponse, Fixnum, Hash)>] CompanyFinancialsResponse data, response status code and response headers
    def company_country_code_company_id_financials_format_get_with_http_info(country_code, company_id, format, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: FinancialsApi.company_country_code_company_id_financials_format_get ..."
      end
      # verify the required parameter 'country_code' is set
      if @api_client.config.client_side_validation && country_code.nil?
        fail ArgumentError, "Missing the required parameter 'country_code' when calling FinancialsApi.company_country_code_company_id_financials_format_get"
      end
      # verify the required parameter 'company_id' is set
      if @api_client.config.client_side_validation && company_id.nil?
        fail ArgumentError, "Missing the required parameter 'company_id' when calling FinancialsApi.company_country_code_company_id_financials_format_get"
      end
      # verify the required parameter 'format' is set
      if @api_client.config.client_side_validation && format.nil?
        fail ArgumentError, "Missing the required parameter 'format' when calling FinancialsApi.company_country_code_company_id_financials_format_get"
      end
      # verify enum value
      ...
      # resource path
      local_var_path = "/company/{countryCode}/{companyId}/financials.{format}".sub('{' + 'countryCode' + '}', country_code.to_s).sub('{' + 'companyId' + '}', company_id.to_s).sub('{' + 'format' + '}', format.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'CompanyFinancialsResponse')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FinancialsApi#company_country_code_company_id_financials_format_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
