...
module SwaggerClient
  class SearchApi
    ...
    def search_companies_format_post(format, body, opts = {})
      data, _status_code, _headers = search_companies_format_post_with_http_info(format, body, opts)
      return data
    end
    ...
    # @return [Array<(CompanySearchResponse, Fixnum, Hash)>] CompanySearchResponse data, response status code and response headers
    def search_companies_format_post_with_http_info(format, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: SearchApi.search_companies_format_post ..."
      end
      # verify the required parameter 'format' is set
      if @api_client.config.client_side_validation && format.nil?
        fail ArgumentError, "Missing the required parameter 'format' when calling SearchApi.search_companies_format_post"
      end
      # verify enum value
      ...
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling SearchApi.search_companies_format_post"
      end
      # resource path
      local_var_path = "/search/companies.{format}".sub('{' + 'format' + '}', format.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'CompanySearchResponse')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SearchApi#search_companies_format_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def search_keywords_format_post(format, body, opts = {})
      data, _status_code, _headers = search_keywords_format_post_with_http_info(format, body, opts)
      return data
    end
    ...
    # @option opts [Integer] :offset Determines the 0-based index of the first element of the collection to be returned
    # @option opts [Integer] :limit Configures the maximum number of items from the collection to be returned in the given API call
    # @return [Array<(KeywordSearchResponse, Fixnum, Hash)>] KeywordSearchResponse data, response status code and response headers
    def search_keywords_format_post_with_http_info(format, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: SearchApi.search_keywords_format_post ..."
      end
      # verify the required parameter 'format' is set
      if @api_client.config.client_side_validation && format.nil?
        fail ArgumentError, "Missing the required parameter 'format' when calling SearchApi.search_keywords_format_post"
      end
      # verify enum value
      if @api_client.config.client_side_validation && !['json'].include?(format)
        fail ArgumentError, "invalid value for 'format', must be one of json"
      ...
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling SearchApi.search_keywords_format_post"
      end
      # resource path
      local_var_path = "/search/keywords.{format}".sub('{' + 'format' + '}', format.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'KeywordSearchResponse')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SearchApi#search_keywords_format_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def search_officers_format_post(format, body, opts = {})
      data, _status_code, _headers = search_officers_format_post_with_http_info(format, body, opts)
      return data
    end
    ...
    # @option opts [Integer] :offset Determines the 0-based index of the first element of the collection to be returned
    # @option opts [Integer] :limit Configures the maximum number of items from the collection to be returned in the given API call
    # @return [Array<(OfficerSearchResponse, Fixnum, Hash)>] OfficerSearchResponse data, response status code and response headers
    def search_officers_format_post_with_http_info(format, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: SearchApi.search_officers_format_post ..."
      end
      # verify the required parameter 'format' is set
      if @api_client.config.client_side_validation && format.nil?
        fail ArgumentError, "Missing the required parameter 'format' when calling SearchApi.search_officers_format_post"
      end
      # verify enum value
      if @api_client.config.client_side_validation && !['json'].include?(format)
        fail ArgumentError, "invalid value for 'format', must be one of json"
      ...
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling SearchApi.search_officers_format_post"
      end
      # resource path
      local_var_path = "/search/officers.{format}".sub('{' + 'format' + '}', format.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'OfficerSearchResponse')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SearchApi#search_officers_format_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def search_regions_format_post(format, body, opts = {})
      data, _status_code, _headers = search_regions_format_post_with_http_info(format, body, opts)
      return data
    end
    ...
    # @option opts [Integer] :offset Determines the 0-based index of the first element of the collection to be returned
    # @option opts [Integer] :limit Configures the maximum number of items from the collection to be returned in the given API call
    # @return [Array<(RegionSearchResponse, Fixnum, Hash)>] RegionSearchResponse data, response status code and response headers
    def search_regions_format_post_with_http_info(format, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: SearchApi.search_regions_format_post ..."
      end
      # verify the required parameter 'format' is set
      if @api_client.config.client_side_validation && format.nil?
        fail ArgumentError, "Missing the required parameter 'format' when calling SearchApi.search_regions_format_post"
      end
      # verify enum value
      if @api_client.config.client_side_validation && !['json'].include?(format)
        fail ArgumentError, "invalid value for 'format', must be one of json"
      ...
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling SearchApi.search_regions_format_post"
      end
      # resource path
      local_var_path = "/search/regions.{format}".sub('{' + 'format' + '}', format.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'RegionSearchResponse')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SearchApi#search_regions_format_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
